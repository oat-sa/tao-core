...
class SimpleLockTest extends TestCase
{
     ...
     */
    public function testConstructExecption(): void
    {
    ...
    public function testConstruct()
    {
        ...
        return new SimpleLock($resource->reveal(), $owner->reveal(), 'epoch');
    }
     ...
     * @author Lionel Lecaque, lionel@taotesting.com
     */
    public function testGetOwnerId($lock): void
    {
        $this->assertSame('#ownerUri', $lock->getOwnerId());
    }
     ...
     * @author Lionel Lecaque, lionel@taotesting.com
     */
    public function testGetCreationTime($lock): void
    {
        $this->assertSame('epoch', $lock->getCreationTime());
    }
}
