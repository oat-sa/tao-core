...
class AdaptersTestCase extends TestCase
{
    ...
    public function testCsvFileParsing(): void
    {
        ...
        $this->assertSame($expectedMapping, $csvFile->getColumnMapping(), 'The column mapping should be ' . var_export($expectedMapping, true) . '.');
        $this->assertSame($csvFile->count(), 16, 'The CSV file contains ' . $csvFile->count() . ' rows instead of 16.');
        $this->assertSame($csvFile->getColumnCount(), 7, 'The CSV file contains ' . $csvFile->getColumnCount() . ' columns instead of 7.');
        ...
        $this->assertSame($csvFile->getRow(0), $expectedRow);
        ...
        $expectedRow = ['TAO Matteo Mellis',
            ...
            'mmellis',
            'http://www.tao.lu/Ontologies/TAO.rdf#LangEN', ];
        $this->assertSame($csvFile->getRow(15), $expectedRow);
    }

    public function testCSVFileParsingWithMultipleFieldValues(): void
    {
