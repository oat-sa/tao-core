...
class UriHelperTestCase extends TestCase
{
    ...
    public function testUriDomain(): void
    {
        $uri = 'http://www.google.fr';
        $domain = tao_helpers_Uri::getDomain($uri);
        $this->assertSame($domain, 'www.google.fr');
        ...
        $domain = tao_helpers_Uri::getDomain($uri);
        $this->assertSame($domain, 'sub.domain.filetransfer.ulc.ag.be');
        ...
        $domain = tao_helpers_Uri::getDomain($uri);
        $this->assertSame($domain, 'mytaoplatform');
    }
    ...
    public function testUriPath(): void
    {
        ...
        $uri = 'http://www.google.fr/translate';
        $path = tao_helpers_Uri::getPath($uri);
        $this->assertSame($path, '/translate');
        ...
        $path = tao_helpers_Uri::getPath($uri);
        $this->assertSame($path, '/translate/funky');
    ...
    public function testIsValidAsCookieDomain(): void
    {
