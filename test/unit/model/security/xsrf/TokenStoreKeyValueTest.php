...
class TokenStoreKeyValueTest extends TestCase
{
    ...
    public function testGetTokens($tokensAsJson, $expected)
    {
        ...
        /** @var \common_persistence_KeyValuePersistence|\PHPUnit_Framework_MockObject_MockObject $persistence */
        ...
        /** @var \common_persistence_Manager|\PHPUnit_Framework_MockObject_MockObject $persistenceManager */
        ...
        /** @var \common_user_User|\PHPUnit_Framework_MockObject_MockObject $sessionService */
        ...
        /** @var SessionService|\PHPUnit_Framework_MockObject_MockObject $sessionService */
