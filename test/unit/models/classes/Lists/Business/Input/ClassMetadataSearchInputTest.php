...
class ClassMetadataSearchInputTest extends TestCase
{
    public function testSearchRequestAccessor(): void
    {
        $searchRequest = $this->createMock(ClassMetadataSearchRequest::class);

        $sut = new ClassMetadataSearchInput($searchRequest);
