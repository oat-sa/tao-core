...
class ArrayHelperTest extends TestCase
{
     ...
     */
    public function testArrayUnique($testArray, $expectedArray): void
    {
     ...
     */
    public function testContainsOnlyValue($value, array $container, $strict, $exceptAtIndex, $expectedValue): void
    {
     ...
     */
    public function testArraysContainOnlyValue(array $containers, $value, $exceptNContainers, array $exceptAtIndex, $expectedInvalidContainers, $expectedValidContainers, $expected): void
    {
        $invalidContainers = [];
        $validContainers = [];
        ...
        $this->assertSame($expectedInvalidContainers, $invalidContainers);
        $this->assertSame($expectedValidContainers, $validContainers);
    }
     ...
     */
    public function testMinArrayCountValues($values, array $arrays, $expected, $returnAll = false): void
    {
     ...
     */
    public function testCountConsistentColumns(array $matrix, array $ignoreValues, $expected, $emptyIsConsistent = false): void
    {
