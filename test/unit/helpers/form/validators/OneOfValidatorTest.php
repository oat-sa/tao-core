...
use tao_helpers_form_validators_OneOf;
use tao_helpers_Uri;
...
class OneOfValidatorTest extends TestCase
{
    ...
    public function testWrongConfiguration(): void
    {
        ...
        $this->expectExceptionMessage('No reference provided for OneOf validator');
        $this->createSubject();
    }
    ...
    public function evaluationValues()
    {
        return [
            ...
            [['reference' => [self::STRING_REFERENCE]], 'a', 'b', false],
            [['reference' => [self::STRING_REFERENCE]], '', '', false],
            [
                ['reference' => [$this->createElement('a', tao_helpers_Uri::encode(self::OBJECT_REFERENCE))]],
                'a',
                '',
                false
            ],
    ...
    private function createSubject(array $options = [], $value1 = '', $value2 = ''): tao_helpers_form_validators_OneOf
    {
        $subject = new tao_helpers_form_validators_OneOf($options);
