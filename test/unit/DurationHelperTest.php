...
class DurationHelperTest extends TestCase
{
     ...
     */
    public function testTimetoDuration($time, $expected): void
    {
     ...
     * @param string $interval the parameter of intervalToTime
     * @param string $expected the expected result
     */
    public function testIntervalToTime($interval, $expected): void
    {
     ...
     * @param string $expected the expected result
     */
    public function testDurationToTime($duration, $expected): void
    {
