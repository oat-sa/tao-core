...
namespace oat\tao\test\import;

use oat\tao\test\TaoPhpUnitTestRunner;
use oat\tao\model\import\ImportersService;
use oat\tao\test\import\samples\FakeImporter;
use oat\oatbox\service\ServiceManager;

/**
 * Class ImportersServiceTest
 *
 * @package oat\tao\test\import
...
class ImportersServiceTest extends TaoPhpUnitTestRunner
{
    ...
    public function testGetImporter()
    {
        ...
        $this->assertInstanceOf('\oat\tao\test\import\samples\FakeImporter', $importersService->getImporter('testImporter'));
    }
