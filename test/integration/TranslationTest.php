...
class TranslationTest extends GenerisPhpUnitTestRunner
{
     ...
     */
    public function testTranslationModel(): void
    {
        ...
        $this->assertSame('en-US', $tu2->getSourceLanguage());
        $this->assertSame('en-YA', $tu3->getTargetLanguage());

        $tf = new tao_helpers_translation_TranslationFile();
        $tf->setSourceLanguage('en-US');
        $tf->setTargetLanguage('en-YA');
        $this->assertSame($tf->getSourceLanguage(), 'en-US');
        $this->assertSame($tf->getTargetLanguage(), 'en-YA');
        ...
        $this->assertSame('May the force be with you.', $tu1->getSource());
        $this->assertSame('Hate the dark side smells.', $tu2->getTarget());

        $tu3->setSource('Lando Calrician is a great pilot.');
        $tu3->setTarget('A great pilot Lando Calrician is.');
        $this->assertSame('Lando Calrician is a great pilot.', $tu3->getSource());
        $this->assertSame('A great pilot Lando Calrician is.', $tu3->getTarget());
        ...
        $tus = $tf->getTranslationUnits();
        $tu4 = $tus[3];
        $this->assertSame('en-YA', $tu4->getTargetLanguage());
        ...
        $tus = $tf->getTranslationUnits();
        $tu3 = $tus[2];
        $this->assertSame(4, count($tus));
        $this->assertSame('Lando Calrician is a great pilot.', $tu3->getSource());
        $this->assertSame('Han Solo is a great pilot.', $tu3->getTarget());
        ...
        $this->assertSame($tf->getAnnotations(), ['sourceLanguage' => tao_helpers_translation_Utils::getDefaultLanguage(),
        ...
        $this->assertSame($tu->getAnnotations(), ['sourceLanguage' => tao_helpers_translation_Utils::getDefaultLanguage(),
            'targetLanguage' => tao_helpers_translation_Utils::getDefaultLanguage(),
            'context' => 'Unit Testing',
            'author' => 'Jane Doe', ]);
        ...
        // Test utils.
        $this->assertSame(tao_helpers_translation_Utils::getDefaultLanguage(), 'en-US');
    }

    public function testPOTranslationReading(): void
    {
        ...
        $this->assertSame(count($tus), 4);
        $this->assertSame('First Try', $tus[0]->getSource());
        $this->assertSame('', $tus[0]->getTarget());
        $this->assertSame('Thïs téxt cöntàin$ wéîRd chárâctêrS beçÁuse öf I18N', $tus[1]->getSource());
        $this->assertSame('', $tus[1]->getTarget());
        $this->assertSame('This translation will be a very long text', $tus[2]->getSource());
        $this->assertSame('', $tus[2]->getTarget());
        $this->assertSame('And this one will contain escaping characters', $tus[3]->getSource());
        $this->assertSame('', $tus[3]->getTarget());
        ...
        $this->assertSame(4, count($tus));
        $this->assertSame('The blackboard of Lena is full of "Shakespeare" quotes.', $tus[0]->getSource());
        $this->assertSame('L\'ardoise de Léna est pleine de citations de "Shakespeare".', $tus[0]->getTarget());
        $this->assertSame('Thïs téxt cöntàin$ wéîRd chárâctêrS beçÁuse öf I18N', $tus[1]->getSource());
        $this->assertSame('Ce téxtê cÖntîEn$ de drÔlés dE çÄrÂctÈres @ cAµ$£ dé l\'I18N', $tus[1]->getTarget());
        $this->assertSame('This translation will be a very long text', $tus[2]->getSource());
        $this->assertSame('C\'est en effet un texte très très long car j\'aime parler. Grâce à ce test, je vais pouvoir vérifier si les msgstr multilignes sont correctement interpretés par ', $tus[2]->getTarget());
        $this->assertSame('And this one will contain escaping characters', $tus[3]->getSource());
        ...
        $this->assertSame(tao_helpers_translation_Utils::getDefaultLanguage(), $tf->getSourceLanguage());
        $this->assertSame('de-DE', $tf->getTargetLanguage());

        $this->assertSame(count($tus), 4);
        $this->assertSame('label', $tus[0]->getContext());
        $this->assertSame('comment', $tus[1]->getContext());
        $this->assertSame('', $tus[3]->getContext());
    }

    public function testPOTranslationSorting(): void
    {
        ...
        $this->assertSame(' This begins with a white space', $sortedTus[0]->getSource());
        $this->assertSame('kings are great', $sortedTus[8]->getSource());
        $this->assertSame('öhïs téxt cöntàin$ wéîRd chárâctêrS beçÁuse öf I18N', $sortedTus[10]->getSource());

        $sortedTus = $tf->sortBySource(tao_helpers_translation_TranslationFile::SORT_ASC_I);
        $this->assertSame('12 is also a number', $sortedTus[3]->getSource());
        $this->assertSame('kings are great', $sortedTus[6]->getSource());
        $this->assertSame('Zapata', $sortedTus[8]->getSource());

        $sortedTus = $tf->sortBySource(tao_helpers_translation_TranslationFile::SORT_DESC);
        $this->assertSame('Koalas are great', $sortedTus[4]->getSource());
        $this->assertSame('12 is also a number', $sortedTus[7]->getSource());
        $this->assertSame('- List1', $sortedTus[9]->getSource());

        $sortedTus = $tf->sortBySource(tao_helpers_translation_TranslationFile::SORT_DESC_I);
        $this->assertSame('Zapata', $sortedTus[2]->getSource());
        $this->assertSame('Ahloa', $sortedTus[5]->getSource());
        $this->assertSame(' This begins with a white space', $sortedTus[10]->getSource());
    }

    public function testPOTranslationWriting(): void
    {
        // -- First test
    ...
    public function testJavaScriptTranslationWriting(): void
    {
    ...
    public function testPHPTranslationWriting(): void
    {
    ...
    public function testManifestExtraction(): void
    {
        ...
        $this->assertSame(5, count($tus));
        $this->assertSame('Users', $tus[0]->getSource());
        $this->assertSame('Manage users', $tus[1]->getSource());
        $this->assertSame('Add a user', $tus[2]->getSource());
        $this->assertSame('Edit a user', $tus[3]->getSource());
    }

    public function testMultipleManfiestExtraction(): void
    {
        ...
        $this->assertSame(26, count($tus));
        $this->assertSame('Search', $tus[6]->getSource());
        $this->assertSame('Delete', $tus[9]->getSource());
        $this->assertSame('Items', $tus[17]->getSource());
        $this->assertSame('Preview', $tus[24]->getSource());
    }

    public function testSourceExtraction(): void
    {
        ...
        $extractor->extract();
        $tus = $extractor->getTranslationUnits();
        $this->assertSame(count($tus), 60);
        $this->assertSame('Import', $tus[1]->getSource());
        $this->assertSame(' Please select the input data format to import ', $tus[2]->getSource());
        $this->assertSame('Please upload a CSV file formated as "defined" %min by %max the options above.', $tus[5]->getSource());
        $this->assertSame("Please upload \t an RDF file.\n\n", $tus[8]->getsource());
    }

    public function testRDFTranslationExtraction(): void
    {
        $paths = [dirname(__FILE__) . self::FAKE_RDF_LANG_DESC];
        $rdfExtractor = new tao_helpers_translation_RDFExtractor($paths);

        $rdfExtractor->setTranslatableProperties(['http://www.w3.org/2000/01/rdf-schema#label',
        ...
        $this->assertSame('http://www.tao.lu/Ontologies/TAO.rdf#LangDE', $tus[1]->getSubject());
        $this->assertSame('http://www.w3.org/2000/01/rdf-schema#label', $tus[1]->getPredicate());
        $this->assertSame('Allemand', $tus[1]->getSource());
        $this->assertSame('Allemand', $tus[1]->getTarget());
        $this->assertSame('en-US', $tus[1]->getSourceLanguage());
        $this->assertSame('FR', $tus[1]->getTargetLanguage());
        $this->assertSame('http://www.tao.lu/Ontologies/TAO.rdf#LangDE', $tus[2]->getSubject());
        $this->assertSame('http://www.w3.org/2000/01/rdf-schema#label', $tus[2]->getPredicate());
        $this->assertSame('Deutsch', $tus[2]->getSource());
        $this->assertSame('Deutsch', $tus[2]->getTarget());
        $this->assertSame('en-US', $tus[2]->getSourceLanguage());
        $this->assertSame('DE', $tus[2]->getTargetLanguage());
        $this->assertSame('http://www.tao.lu/Ontologies/TAO.rdf#LangDE', $tus[5]->getSubject());
        $this->assertSame('http://www.w3.org/2000/01/rdf-schema#comment', $tus[5]->getPredicate());
        $this->assertSame('The German language.', $tus[5]->getSource());
        $this->assertSame('The German language.', $tus[5]->getTarget());
        $this->assertSame('en-US', $tus[5]->getSourceLanguage());
        $this->assertSame('EN', $tus[5]->getTargetLanguage());
    }

    public function testRDFTranslationReading(): void
    {
        ...
        $this->assertSame($tus[0]->getTarget(), 'Object TAO', 'Unexpected target for RDFTranslationUnit.');
        $this->assertSame($tus[0]->getSubject(), 'http://www.tao.lu/Ontologies/TAO.rdf#TAOObject', 'Unexpected subject for RDFTranslationUnit.');
        $this->assertSame($tus[0]->getPredicate(), 'http://www.w3.org/2000/01/rdf-schema#label', 'Unexpected predicate for RDFTranslationUnit.');

        $this->assertSame($tus[1]->getTarget(), 'Related to e-testing any resource', 'Unexpected target for RDFTranslationUnit.');
        $this->assertSame($tus[1]->getSubject(), 'http://www.tao.lu/Ontologies/TAO.rdf#TAOObject', 'Unexpected subject for RDFTranslationUnit.');
        $this->assertSame($tus[1]->getPredicate(), 'http://www.w3.org/2000/01/rdf-schema#comment', 'Unexpected predicate for RDFTranslationUnit.');
    }

    public function testRDFTranslationWriting(): void
    {
    ...
    public function testRDFUtils(): void
    {
     ...
     */
    public function testRDFAnnotations(): void
    {
        try {
            ...
            $this->assertSame($annotations, ['predicate' => 'http://www.tao.lu/Ontologies/tao.rdf#aFragment']);
            ...
            $this->assertSame($tf->getAnnotations(), ['sourceLanguage' => 'EN',
                'targetLanguage' => 'es', ]);
            $tus = $tf->getTranslationUnits();
            $this->assertSame($tus[0]->getSourceLanguage(), 'EN');
            $this->assertSame($tus[0]->getTargetLanguage(), 'es');
            $this->assertSame($tus[0]->getSource(), 'TAO Object');
            $this->assertSame($tus[0]->getTarget(), 'TAO objeto');
            $this->assertSame($tus[0]->getAnnotation('sourceLanguage'), ['name' => 'sourceLanguage', 'value' => 'EN']);
            $this->assertSame($tus[0]->getAnnotation('targetLanguage'), ['name' => 'targetLanguage', 'value' => 'es']);
            $this->assertSame($tus[10]->getTarget(), 'Función de usuario de flujo de trabajo: el papel asignado por defecto a todos los usuarios backend, no eliminable');
    ...
    public function testPOAnnotationsReading(): void
    {
        $string = "# This is a comment.\n";
        $string .= '#, flag1 composed-flag flag2';
        $annotations = tao_helpers_translation_POUtils::unserializeAnnotations($string);
        $this->assertSame($annotations, [tao_helpers_translation_POTranslationUnit::TRANSLATOR_COMMENTS => 'This is a comment.',
        ...
        $annotations = tao_helpers_translation_POUtils::unserializeAnnotations($string);
        $this->assertSame($annotations, [tao_helpers_translation_POTranslationUnit::TRANSLATOR_COMMENTS => "The first line of my comment continues...\nAt the second line.",
        ...
        $annotations = tao_helpers_translation_POUtils::unserializeAnnotations($string);
        $this->assertSame($annotations, [tao_helpers_translation_POTranslationUnit::TRANSLATOR_COMMENTS => "هذا تعليق\nمع خطوط متعددة في الداخل.",
        ...
        $string .= '#, flag-read';
        $annotations = tao_helpers_translation_POUtils::unserializeAnnotations($string);
        $this->assertSame($annotations, [tao_helpers_translation_POTranslationUnit::FLAGS => 'flag-read']);
        ...
        $tf = $reader->getTranslationFile();
        $tus = $tf->getTranslationUnits();
        $this->assertSame(count($tus), 6);
        $this->assertSame($tus[0]->getAnnotations(), [tao_helpers_translation_POTranslationUnit::TRANSLATOR_COMMENTS => 'This is a comment',
            'sourceLanguage' => tao_helpers_translation_Utils::getDefaultLanguage(),
            'targetLanguage' => tao_helpers_translation_Utils::getDefaultLanguage(), ]);
        $this->assertSame($tus[1]->getAnnotations(), [tao_helpers_translation_POTranslationUnit::TRANSLATOR_COMMENTS => 'This is another comment',
            tao_helpers_translation_POTranslationUnit::FLAGS => 'flag1 composed-flag flag2 tao-public',
            'sourceLanguage' => tao_helpers_translation_Utils::getDefaultLanguage(),
            'targetLanguage' => tao_helpers_translation_Utils::getDefaultLanguage(), ]);
        $this->assertSame($tus[2]->getAnnotations(), [tao_helpers_translation_POTranslationUnit::TRANSLATOR_COMMENTS => "This is a multiline...\ncomment.",
            'sourceLanguage' => tao_helpers_translation_Utils::getDefaultLanguage(),
            'targetLanguage' => tao_helpers_translation_Utils::getDefaultLanguage(), ]);
        $this->assertSame($tus[3]->getAnnotations(), ['sourceLanguage' => tao_helpers_translation_Utils::getDefaultLanguage(),
            'targetLanguage' => tao_helpers_translation_Utils::getDefaultLanguage(), ]);

        // Test flag related interface on POTranslationUnit & POTranslationFile.
        $this->assertTrue($tus[5]->hasFlag('flag4'));
        $this->assertSame($tus[5]->getFlags(), ['flag4']);
        $tus[5]->addFlag('new-flag');
        $this->assertTrue($tus[5]->hasFlag('new-flag'));
        $this->assertSame($tus[5]->getFlags(), ['flag4', 'new-flag']);
        $tus[5]->addFlag('new-flag');
        $this->assertSame($tus[5]->getFlags(), ['flag4', 'new-flag']);
        $tus[5]->addFlag('flag5');
        $this->assertSame(
        ...
        $this->assertSame($tus[5]->getFlags(), ['flag4', 'flag5']);

        $flagTus = $tf->getByFlag('composed-flag');
        $this->assertSame(count($flagTus), 2);
        $this->assertSame($flagTus[0]->getSource(), 'Thïs téxt cöntàin$ wéîRd chárâctêrS beçÁuse öf I18N');
        $this->assertSame($flagTus[1]->getSource(), 'This one contains the same flag as the second one');

        $flagTus = $tf->getByFlags(['composed-flag', 'flag2']);
        $this->assertSame(count($flagTus), 2);
        $this->assertSame($flagTus[0]->getSource(), 'Thïs téxt cöntàin$ wéîRd chárâctêrS beçÁuse öf I18N');
        $this->assertSame($flagTus[1]->getSource(), 'This one contains the same flag as the second one');
        ...
        $this->assertSame($tf1->count(), 6);
        $this->assertSame($tf2->count(), 6);

        $tus1 = $tf1->getTranslationUnits();
        $tus2 = $tf2->getTranslationUnits();

        $this->assertSame($tus1[0]->getAnnotations(), $tus2[0]->getAnnotations());
        $this->assertSame($tus1[1]->getAnnotations(), $tus2[1]->getAnnotations());
        $this->assertSame($tus1[2]->getAnnotations(), $tus2[2]->getAnnotations());
        $this->assertSame($tus1[3]->getAnnotations(), $tus2[3]->getAnnotations());
        $this->assertSame($tus1[4]->getAnnotations(), $tus2[4]->getAnnotations());
        $this->assertSame($tus1[5]->getAnnotations(), $tus2[5]->getAnnotations());

        unlink($path);
    }

    public function testPOAnnotationsWriting(): void
    {
        // Test flag utilities.
        $comment = '';
        $this->assertSame(tao_helpers_translation_POUtils::addFlag($comment, 'tao-public'), 'tao-public');

        $comment = 'no-error test-flag';
        $this->assertSame(tao_helpers_translation_POUtils::addFlag($comment, 'tao-public'), 'no-error test-flag tao-public');
        ...
        $this->assertSame(tao_helpers_translation_POUtils::serializeAnnotations($annotations), $comment);
    ...
    public function testParsingSource(): void
    {
        ...
        $this->assertSame([], $method->invokeArgs($translator, ['_(\'Maximum choices reached\'),']));
