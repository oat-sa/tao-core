...
class ActionTest extends GenerisPhpUnitTestRunner
{
     ...
     */
    public function testGetClassNameByUrl(): void
    {
     ...
     */
    public function testFailingGetClassNameByUrl(): void
    {
     ...
     */
    public function testGetClassName($extension, $shortName, $expectedClassName): void
    {
