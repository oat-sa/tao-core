...
class ValidatorTest extends TaoPhpUnitTestRunner
{
    ...
    public function exec(tao_helpers_form_Validator $pValidator, $pValid, $pInvalid = [], $pHint = ''): void
    {
    ...
    public function validValues(tao_helpers_form_Validator $pValidator, $pValues, $pHint = ''): void
    {
    ...
    public function invalidValues(tao_helpers_form_Validator $pValidator, $pValues, $pHint = ''): void
    {
        $desc = empty($pHint) ? get_class($pValidator) : $pHint;
        foreach ($pValues as $val) {
            $nfo = $val;
     ...
     */
    public function testNotEmpty($value, $expected): void
    {
        $validator = tao_helpers_form_FormFactory::getValidator('NotEmpty');
        $this->assertSame($expected, $validator->evaluate($value));
    }
     ...
     */
    public function testPasswordPositive(): void
    {
     ...
     */
    public function testPasswordNegativeNoReference(): void
    {
        $validator = tao_helpers_form_FormFactory::getValidator('Password');
     ...
     * @expectedExceptionMessage Please set the reference of the second password element
     */
    public function testPasswordNegativeInvalidReference(): void
    {
     ...
     */
    public function testRegex($value, $format, $expected): void
    {
     ...
     */
    public function testRegexMisconfig(): void
    {
     ...
     */
    public function testUrl($value, $allowParams, $expected): void
    {
        $options = [];
     ...
     */
    public function testUniqueNegativePropertyNotSet(): void
    {
        $resourceMock = $this->getMockBuilder('core_kernel_classes_Class')->disableOriginalConstructor()->getMock();
        $resourceMock->method('getParentClasses')->willReturn([new kernel_class_Stub()]);
    ...
    protected function buildValidPassword()
    {
        ...
        return str_pad($validPassword, $config['length'], 'c');
    }
    ...
    protected function buildInvalidPassword()
    {
        ...
        return substr($invalidPassword, 0, $config['length'] - 1);
    }
}
