...
class OntologyUserMapperTest extends GenerisPhpUnitTestRunner
{
     ...
     * @throws \Exception
     */
    public function testMapUserWithSuccess($schema, $data, $expected): void
    {
     ...
     * @throws \Exception
     */
    public function testMapMandatoryShouldFail($schema, $data, $expected): void
    {
     ...
     * @throws \Exception
     */
    public function testMapMandatoryNotEmptyShouldFail($schema, $data, $expected): void
    {
        $mapper = $this->getMapper();
        $mapper->setOption(OntologyUserMapper::OPTION_SCHEMA, $schema);
