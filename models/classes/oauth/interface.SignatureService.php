 ...
 */
interface tao_models_classes_oauth_SignatureService
{
     ...
     * @author Joel Bout, <joel@taotesting.com>
     */
    public function sign(common_http_Request $request);
     ...
     */
    protected function validate(common_http_Request $request);
}