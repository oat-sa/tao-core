...
/**
 * A class that represents a frontend plugin module.
 *
 * @author Bertrand Chevrier <bertrand@taotesting.com>
 * @author Jean-Sébastien Conan <jean-sebastien@taotesting.com>
 */
class PluginModule implements JsonSerializable
{
    ...
    /**
     * @var string|int|null $position to sort plugins together
     */
    private $position;
     ...
     * @param array $data
     * @return PluginModule the new instance
