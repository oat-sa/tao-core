...
abstract class AbstractQueueBroker implements QueueBrokerInterface, PhpSerializable, ServiceLocatorAwareInterface
{
     ...
     */
    abstract protected function doPop(): void;
     ...
     */
    abstract protected function doDelete($id, array $logContext = []): void;
     ...
     */
    protected function pushPreFetchedMessage(TaskInterface $task): void
    {
