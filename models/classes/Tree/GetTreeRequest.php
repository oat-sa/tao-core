...
class GetTreeRequest
{
    ...
    public static function create(Request $request)
    {
        ...
        } elseif ($request->hasParameter('openParentNodes') && is_array($openParentNodesParameter)) {
     ...
     * @param array $filtersOptions
     */
    public function setFiltersOptions($filtersOptions): void
    {
        $this->filtersOptions = $filtersOptions;
    }
}
