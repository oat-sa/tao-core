...
class RequiredActionService extends ConfigurableService implements RequiredActionServiceInterface
{
     ...
     */
    public function attachAction(RequiredActionInterface $action): void
    {
     ...
     */
    public function detachAction($name): void
    {
        $actions = $this->getRequiredActions();
     ...
     * @param Event $event
     */
    public static function checkRequiredActions(Event $event = null): void
    {
