...
abstract class tao_models_classes_GenerisService extends tao_models_classes_Service
{
	...
	const GENERIS_RESOURCE = 'http://www.tao.lu/Ontologies/generis.rdf#generis_Ressource';
	const INSTANCE_BOOLEAN_TRUE ='http://www.tao.lu/Ontologies/generis.rdf#True';
	const INSTANCE_BOOLEAN_FALSE = 'http://www.tao.lu/Ontologies/generis.rdf#False';
	/**
     * constructor
     *
     * @access protected
