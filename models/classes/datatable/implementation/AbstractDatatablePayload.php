...
abstract class AbstractDatatablePayload implements DatatablePayloadInterface, ServiceLocatorAwareInterface
{
     ...
     */
    protected function doFiltration(QueryBuilderInterface $queryBuilder): void
    {
     ...
     * @param QueryBuilderInterface $queryBuilder
     */
    protected function doPagination(QueryBuilderInterface $queryBuilder): void
    {
        $rows = $this->getRows();
        $page = $this->getPage();
     ...
     * @param QueryBuilderInterface $queryBuilder
     */
    protected function doSorting(QueryBuilderInterface $queryBuilder): void
    {
