...
trait HttpFlowTrait
{
     ...
     */
    public function redirect($url, $statusCode = 302): void
    {
     ...
     */
    public function forwardUrl($url): void
    {
        $uri = new Uri($url);
        $query = $uri->getQuery();
        $queryParams = [];
     ...
     */
    public function forward($action, $controller = null, $extension = null, $params = []): void
    {
