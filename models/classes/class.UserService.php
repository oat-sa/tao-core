...
class tao_models_classes_UserService extends ConfigurableService implements core_kernel_users_UsersManagement
{
     ...
     * @param core_kernel_classes_Class $class A specific class to use to instantiate the new user. If not specified, the class returned by the getUserClass method is used.
     ...
     * @param  Can $roles be either a single Resource or an array of Resource that are instances of Role.
     * @return boolean
     */
     ...
     * @throws core_kernel_users_Exception If an error occurs.
     */
    public function attachRole(core_kernel_classes_Resource $user, core_kernel_classes_Resource $role): void
    {
     ...
     * @throws core_kernel_users_Exception If an error occurs.
     */
    public function unnatachRole(core_kernel_classes_Resource $user, core_kernel_classes_Resource $role): void
    {
        try {
            $this->checkCurrentUserAccess($role);
     ...
     */
    public function attachProperties(core_kernel_classes_Resource $user, array $properties): void
    {
    ...
    public function getPermittedRoles(core_kernel_classes_Resource $user, array $roles, $encoded = true)
    {
        ...
        if (count($exclude)) {
            $roles = array_filter($roles, function ($k) use ($exclude) {
                return ! in_array($k, $exclude, true);
     ...
     * @throws common_exception_Error
     */
    public function checkCurrentUserAccess($roles): void
    {
