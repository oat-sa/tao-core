...
interface TaoOntology
{
    ...
    const PROPERTY_ORIENTATION_LTR = 'http://www.tao.lu/Ontologies/TAO.rdf#OrientationLeftToRight';
	const PROPERTY_ORIENTATION_RTL = 'http://www.tao.lu/Ontologies/TAO.rdf#OrientationRightToLeft';
    ...
    /** @deprecated use TaoOntology::PROPERTY_ORIENTATION_LTR */
    const PROPERTY_INSTANCE_ORIENTATION_LTR = 'http://www.tao.lu/Ontologies/TAO.rdf#OrientationLeftToRight';
    /** @deprecated use TaoOntology::PROPERTY_ORIENTATION_RTL */
