...
/**
 * Exception to be thrown when a library cannot be found.
 *
 * @author Lionel Lecaque <lionel@taotesting.com>
 * 
 */

class ClientLibNotFoundException extends \common_Exception
{
    private $id;
    ...
    /**
     * Create a new ClientLibNotFoundException exception object.
     * 
