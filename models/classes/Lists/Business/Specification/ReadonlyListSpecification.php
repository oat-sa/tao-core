...
class ReadonlyListSpecification implements ClassSpecificationInterface
{
    public function isSatisfiedBy(core_kernel_classes_Class $class): bool
    {
        ...
        return $propertyType !== null && CollectionType::readonly()->equals(CollectionType::fromValue($propertyType->getUri()));
    }
}
