...
class RdsNotification extends AbstractRdsNotification
{
    ...
    public function createNotificationTable(Schema $schema)
    {
        ...
        $table->addColumn(RdsNotification::NOTIF_FIELD_ID, 'integer', ['autoincrement' => true, 'notnull' => true]);
        $table->addColumn(RdsNotification::NOTIF_FIELD_RECIPIENT, 'string', ['length' => 255, 'notnull' => true]);
        $table->addColumn(RdsNotification::NOTIF_FIELD_STATUS, 'integer', ['length' => 255, 'notnull' => false, 'default' => 0]);
        ...
        $table->addColumn(RdsNotification::NOTIF_FIELD_SENDER, 'string', ['length' => 255, 'notnull' => false, 'default' => null]);
        $table->addColumn(RdsNotification::NOTIF_FIELD_SENDER_NANE, 'string', ['length' => 255, 'notnull' => false, 'default' => null]);
