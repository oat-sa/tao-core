...
class NewSqlNotification extends AbstractRdsNotification
{
    ...
    public function createNotificationTable(Schema $schema)
    {
        ...
        $table->addColumn(RdsNotification::NOTIF_FIELD_ID, 'string', ['length' => 36, 'notnull' => true]);
        $table->addColumn(RdsNotification::NOTIF_FIELD_RECIPIENT, 'string', ['length' => 255, 'notnull' => true]);
        $table->addColumn(RdsNotification::NOTIF_FIELD_STATUS, 'integer', ['length' => 255]);
        $table->addColumn(RdsNotification::NOTIF_FIELD_TITLE, 'string', ['length' => 255]);
        $table->addColumn(RdsNotification::NOTIF_FIELD_MESSAGE, 'text', []);
        $table->addColumn(RdsNotification::NOTIF_FIELD_SENDER, 'string', ['length' => 255]);
        $table->addColumn(RdsNotification::NOTIF_FIELD_SENDER_NANE, 'string', ['length' => 255]);
