...
class EntryPointService extends ConfigurableService
{
     ...
     * @param Entrypoint $e
     */
    public function overrideEntryPoint($id, Entrypoint $e): void
    {
     ...
     * @param string $target
     */
    public function addEntryPoint(Entrypoint $e, $target = null): void
    {
        $entryPoints = $this->getOption(self::OPTION_ENTRYPOINTS);
     ...
     * @throws \common_exception_InconsistentData
     */
    public function removeEntryPoint($entryId): void
    {
        $entryPoints = $this->getOption(self::OPTION_ENTRYPOINTS);
        if (! isset($entryPoints[$entryId])) {
            throw new \common_exception_InconsistentData('Unknown entrypoint ' . $entryId);
     ...
     * @deprecated
     */
    public function registerEntryPoint(Entrypoint $e): void
    {
