...
{
	const CLASS_CALL_OF_SERVICES = 'http://www.tao.lu/middleware/wfEngine.rdf#ClassCallOfServices';
	...
	const CLASS_ACTUAL_PARAMETER = 'http://www.tao.lu/middleware/wfEngine.rdf#ClassActualParameters';
	...
	const CLASS_SERVICES_DEFINITION = 'http://www.tao.lu/middleware/wfEngine.rdf#ClassServiceDefinitions';
	...
	const CLASS_SUPPORT_SERVICES = 'http://www.tao.lu/middleware/wfEngine.rdf#ClassSupportServices';
	const PROPERTY_SUPPORT_SERVICES_URL = 'http://www.tao.lu/middleware/wfEngine.rdf#PropertySupportServicesUrl';
	const CLASS_WEBSERVICES = 'http://www.tao.lu/middleware/wfEngine.rdf#ClassWebServices';
	const CLASS_FORMAL_PARAMETER = 'http://www.tao.lu/middleware/wfEngine.rdf#ClassFormalParameters';
