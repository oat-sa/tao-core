...
class AclProxy implements AccessControl
{
     ...
     */
    public static function setImplementation(FuncAccessControl $implementation): void
    {
     ...
     */
    public static function applyRule(AccessRule $rule): void
    {
     ...
     */
    public static function revokeRule(AccessRule $rule): void
    {
