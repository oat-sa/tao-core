...
class Section extends MenuElement implements PhpSerializable
{
     ...
     * @param extension $structureExtensionId of structures.xml
     * @return static
     */
    public static function fromSimpleXMLElement(\SimpleXMLElement $node, $structureExtensionId)
    {
        ...
        if ($url === '#' || empty($url)) {
            ...
            [$extension, $controller, $action] = $parts;
        }
    ...
    public function removeAction(iAction $action): void
    {
     ...
     */
    private function migrateDataFromLegacyFormat(): void
    {
