...
abstract class tao_actions_SinglePageModule extends \tao_actions_CommonModule
{
     ...
     * @param string $route
     */
    protected function setClientRoute($route): void
    {
     ...
     */
    protected function composeView($scope = '', $data = [], $template = '', $extension = ''): void
    {
        if (! is_array($data)) {
            $data = [];
        }
     ...
     * @param string [$extension] - Defines the extension that should contain the template
     */
    protected function setPage($scope = '', $template = '', $extension = ''): void
    {
