...
class tao_actions_File extends tao_actions_CommonModule
{
    ...
    public function getPropertyFileInfo()
    {
        ...
        if ($this->hasRequestParameter('uri') && $this->hasRequestParameter('propertyUri')) {
            ...
            if ($fileResource !== null && $fileResource instanceof core_kernel_classes_Resource) {
     ...
     */
    public function accessFile(): void
    {
        [$extension, $module, $action, $code, $filePath] = explode('/', tao_helpers_Request::getRelativeUrl(), 5);
        [$key, $subPath] = explode(' ', base64_decode($code, true), 2);
