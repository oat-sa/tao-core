...
class tao_actions_PropertiesAuthoring extends tao_actions_CommonModule
{
     ...
     */
    protected function saveSimpleProperty($propertyValues): void
    {
     ...
     * @param array $propertyValues
     */
    protected function saveAdvProperty($propertyValues): void
    {
    ...
    protected function savePropertyIndex($indexValues): void
    {
        $values = [];
        ...
        if ($existingIndex !== null && ! $existingIndex->equals($indexProperty)) {
     ...
     * @param array $values
     */
    protected function bindProperties(core_kernel_classes_Resource $resource, $values): void
    {
