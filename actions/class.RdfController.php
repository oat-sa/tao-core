...
abstract class tao_actions_RdfController extends tao_actions_CommonModule
{
     ...
     */
    public function getOntologyData(): void
    {
     ...
     */
    public function editClassLabel(): void
    {
     ...
     * @requiresRight id WRITE
     */
    public function translateInstance(): void
    {
        $instance = $this->getCurrentInstance();
        ...
        if ($this->hasRequestParameter('target_lang')) {
            ...
            if (in_array($targetLang, $availableLanguages, true)) {
     ...
     * @throws tao_models_classes_MissingRequestParameterException
     */
    public function getTranslatedData(): void
    {
        if (! $this->isXmlHttpRequest()) {
            throw new common_exception_BadRequest('wrong request mode');
        }
    ...
    protected function getClassService()
    {
        if ($this->service === null) {
            throw new common_exception_Error('No service defined for ' . static::class);
        }
        return $this->service;
    }
     ...
     * @throws SecurityException
     */
    protected function validateInstanceRoot($uri): void
    {
    ...
    protected function validateInstancesRoot($uris): void
    {
        foreach ($uris as $uri) {
            $this->validateInstanceRoot($uri);
        }
    ...
    protected function getCurrentClass()
    {
        ...
        if ($classUri === null || empty($classUri)) {
            $class = null;
     ...
     */
    protected function validateMoveRequest(): void
    {
    ...
    protected function moveAllInstances(array $ids)
    {
        ...
        if (in_array($rootClass->getUri(), $ids, true)) {
     ...
     */
    protected function returnJsonError($message, $httpStatusCode = 406): void
    {
        $response = [
            'success' => false,
     ...
     *
     * @return array updated list of statuses
     */
