...
class tao_actions_RESTExceptionHandler extends common_exception_ExceptionHandler{
	...
	case "common_exception_NotAcceptable":{header("HTTP/1.0 406 Not Acceptable" );break;}
	case "common_exception_Unauthorized":{header("HTTP/1.0 401 Unauthorized" );break;}
	case "common_exception_NotFound":{header("HTTP/1.0 404 Not Found" );break;}
	case "common_exception_MethodNotAllowed":{header("HTTP/1.0 405 Not Found" );break;}
	case "common_exception_NotAcceptable":{header("HTTP/1.0 406 Not Acceptable" );break;}
	case "common_exception_TimeOut":{header("HTTP/1.0 408 Request Timeout" );break;}
	case "common_exception_Conflict":{header("HTTP/1.0 409 Conflict" );break;}
	case "common_exception_UnsupportedMediaType":{header("HTTP/1.0 415 Unsupported Media Type" );break;}
