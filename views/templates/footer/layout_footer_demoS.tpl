		<div id="footer">
			<div class="ui-state-highlight ui-corner-all releasestatus">
				...
				<strong>DEMO Version : <?= __('All data are removed regularly!') ?></strong>
				<br/><a href="http://forge.tao.lu/projects/tao" target="_blank"><?= __('Please report bugs, ideas, comments, any feedback on the TAO Forge') ?></a>
			</div>
