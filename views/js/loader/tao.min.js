...
"complete"===document.readyState&&startController()})};window.require([configUrl],function(){var bundles=[];bundle&&bundles.push(bundle),window.bundles&&window.bundles.length&&(bundles=(bundles=bundles.concat(window.bundles)).filter(function(item,index){return bundles.indexOf(item)===index})),bundles.length?require(bundles,loadController):loadController()})}(),define("loader/bootstrap",function(){}),function(){"use strict";function lib$es6$promise$utils$$isFunction(x){return"function"==typeof x}var lib$es6$promise$asap$$vertxNext,lib$es6$promise$asap$$customSchedulerFn,lib$es6$promise$utils$$isArray=Array.isArray?Array.isArray:function(x){
return"[object Array]"===Object.prototype.toString.call(x)},lib$es6$promise$asap$$len=0,lib$es6$promise$asap$$asap=function(callback,arg){lib$es6$promise$asap$$queue[lib$es6$promise$asap$$len]=callback,lib$es6$promise$asap$$queue[lib$es6$promise$asap$$len+1]=arg,2===(lib$es6$promise$asap$$len+=2)&&(lib$es6$promise$asap$$customSchedulerFn?lib$es6$promise$asap$$customSchedulerFn(lib$es6$promise$asap$$flush):lib$es6$promise$asap$$scheduleFlush())};var lib$es6$promise$asap$$browserWindow="undefined"!=typeof window?window:void 0,lib$es6$promise$asap$$browserGlobal=lib$es6$promise$asap$$browserWindow||{},
lib$es6$promise$asap$$BrowserMutationObserver=lib$es6$promise$asap$$browserGlobal.MutationObserver||lib$es6$promise$asap$$browserGlobal.WebKitMutationObserver,lib$es6$promise$asap$$isNode="undefined"!=typeof process&&"[object process]"==={}.toString.call(process),lib$es6$promise$asap$$isWorker="undefined"!=typeof Uint8ClampedArray&&"undefined"!=typeof importScripts&&"undefined"!=typeof MessageChannel;function lib$es6$promise$asap$$useSetTimeout(){return function(){setTimeout(lib$es6$promise$asap$$flush,1)}}var lib$es6$promise$asap$$scheduleFlush,channel,iterations,observer,node,nextTick,version,lib$es6$promise$asap$$queue=new Array(1e3)
;function lib$es6$promise$asap$$flush(){for(var i=0;i<lib$es6$promise$asap$$len;i+=2){(0,lib$es6$promise$asap$$queue[i])(lib$es6$promise$asap$$queue[i+1]),lib$es6$promise$asap$$queue[i]=void 0,lib$es6$promise$asap$$queue[i+1]=void 0}lib$es6$promise$asap$$len=0}function lib$es6$promise$$internal$$noop(){}lib$es6$promise$asap$$scheduleFlush=lib$es6$promise$asap$$isNode?(nextTick=process.nextTick,version=process.versions.node.match(/^(?:(\d+)\.)?(?:(\d+)\.)?(\*|\d+)$/),Array.isArray(version)&&"0"===version[1]&&"10"===version[2]&&(nextTick=setImmediate),function(){nextTick(lib$es6$promise$asap$$flush)}):lib$es6$promise$asap$$BrowserMutationObserver?(iterations=0
,observer=new lib$es6$promise$asap$$BrowserMutationObserver(lib$es6$promise$asap$$flush),node=document.createTextNode(""),observer.observe(node,{characterData:!0}),function(){node.data=iterations=++iterations%2}):lib$es6$promise$asap$$isWorker?((channel=new MessageChannel).port1.onmessage=lib$es6$promise$asap$$flush,function(){channel.port2.postMessage(0)}):void 0===lib$es6$promise$asap$$browserWindow&&"function"==typeof require?function(){try{var vertx=require("vertx");return lib$es6$promise$asap$$vertxNext=vertx.runOnLoop||vertx.runOnContext,function(){lib$es6$promise$asap$$vertxNext(lib$es6$promise$asap$$flush)}}catch(e){
return lib$es6$promise$asap$$useSetTimeout()}}():lib$es6$promise$asap$$useSetTimeout();var lib$es6$promise$$internal$$PENDING=void 0,lib$es6$promise$$internal$$FULFILLED=1,lib$es6$promise$$internal$$REJECTED=2,lib$es6$promise$$internal$$GET_THEN_ERROR=new lib$es6$promise$$internal$$ErrorObject;function lib$es6$promise$$internal$$handleMaybeThenable(promise,maybeThenable){if(maybeThenable.constructor===promise.constructor)!function(promise,thenable){thenable._state===lib$es6$promise$$internal$$FULFILLED?lib$es6$promise$$internal$$fulfill(promise,thenable._result):thenable._state===lib$es6$promise$$internal$$REJECTED?lib$es6$promise$$internal$$reject(promise,
thenable._result):lib$es6$promise$$internal$$subscribe(thenable,void 0,function(value){lib$es6$promise$$internal$$resolve(promise,value)},function(reason){lib$es6$promise$$internal$$reject(promise,reason)})}(promise,maybeThenable);else{var then=function(promise){try{return promise.then}catch(error){return lib$es6$promise$$internal$$GET_THEN_ERROR.error=error,lib$es6$promise$$internal$$GET_THEN_ERROR}}(maybeThenable);then===lib$es6$promise$$internal$$GET_THEN_ERROR?lib$es6$promise$$internal$$reject(promise,lib$es6$promise$$internal$$GET_THEN_ERROR.error):void 0===then?lib$es6$promise$$internal$$fulfill(promise,maybeThenable):lib$es6$promise$utils$$isFunction(
then)?function(promise,thenable,then){lib$es6$promise$asap$$asap(function(promise){var sealed=!1,error=function(then,value,fulfillmentHandler,rejectionHandler){try{then.call(value,fulfillmentHandler,rejectionHandler)}catch(e){return e}}(then,thenable,function(value){sealed||(sealed=!0,thenable!==value?lib$es6$promise$$internal$$resolve(promise,value):lib$es6$promise$$internal$$fulfill(promise,value))},function(reason){sealed||(sealed=!0,lib$es6$promise$$internal$$reject(promise,reason))},promise._label);!sealed&&error&&(sealed=!0,lib$es6$promise$$internal$$reject(promise,error))},promise)}(promise,maybeThenable,then):lib$es6$promise$$internal$$fulfill(
promise,maybeThenable)}}function lib$es6$promise$$internal$$resolve(promise,value){var x;promise===value?lib$es6$promise$$internal$$reject(promise,new TypeError("You cannot resolve a promise with itself")):"function"==typeof(x=value)||"object"==typeof x&&null!==x?lib$es6$promise$$internal$$handleMaybeThenable(promise,value):lib$es6$promise$$internal$$fulfill(promise,value)}function lib$es6$promise$$internal$$publishRejection(promise){promise._onerror&&promise._onerror(promise._result),lib$es6$promise$$internal$$publish(promise)}function lib$es6$promise$$internal$$fulfill(promise,value){promise._state===lib$es6$promise$$internal$$PENDING&&(
promise._result=value,promise._state=lib$es6$promise$$internal$$FULFILLED,0!==promise._subscribers.length&&lib$es6$promise$asap$$asap(lib$es6$promise$$internal$$publish,promise))}function lib$es6$promise$$internal$$reject(promise,reason){promise._state===lib$es6$promise$$internal$$PENDING&&(promise._state=lib$es6$promise$$internal$$REJECTED,promise._result=reason,lib$es6$promise$asap$$asap(lib$es6$promise$$internal$$publishRejection,promise))}function lib$es6$promise$$internal$$subscribe(parent,child,onFulfillment,onRejection){var subscribers=parent._subscribers,length=subscribers.length;parent._onerror=null,subscribers[length]=child,
subscribers[length+lib$es6$promise$$internal$$FULFILLED]=onFulfillment,subscribers[length+lib$es6$promise$$internal$$REJECTED]=onRejection,0===length&&parent._state&&lib$es6$promise$asap$$asap(lib$es6$promise$$internal$$publish,parent)}function lib$es6$promise$$internal$$publish(promise){var subscribers=promise._subscribers,settled=promise._state;if(0!==subscribers.length){for(var child,callback,detail=promise._result,i=0;i<subscribers.length;i+=3)child=subscribers[i],callback=subscribers[i+settled],child?lib$es6$promise$$internal$$invokeCallback(settled,child,callback,detail):callback(detail);promise._subscribers.length=0}}
function lib$es6$promise$$internal$$ErrorObject(){this.error=null}var lib$es6$promise$$internal$$TRY_CATCH_ERROR=new lib$es6$promise$$internal$$ErrorObject;function lib$es6$promise$$internal$$invokeCallback(settled,promise,callback,detail){var value,error,succeeded,failed,hasCallback=lib$es6$promise$utils$$isFunction(callback);if(hasCallback){if((value=function(callback,detail){try{return callback(detail)}catch(e){return lib$es6$promise$$internal$$TRY_CATCH_ERROR.error=e,lib$es6$promise$$internal$$TRY_CATCH_ERROR}}(callback,detail))===lib$es6$promise$$internal$$TRY_CATCH_ERROR?(failed=!0,error=value.error,value=null):succeeded=!0,promise===value
)return void lib$es6$promise$$internal$$reject(promise,new TypeError("A promises callback cannot return that same promise."))}else value=detail,succeeded=!0;promise._state!==lib$es6$promise$$internal$$PENDING||(hasCallback&&succeeded?lib$es6$promise$$internal$$resolve(promise,value):failed?lib$es6$promise$$internal$$reject(promise,error):settled===lib$es6$promise$$internal$$FULFILLED?lib$es6$promise$$internal$$fulfill(promise,value):settled===lib$es6$promise$$internal$$REJECTED&&lib$es6$promise$$internal$$reject(promise,value))}function lib$es6$promise$enumerator$$Enumerator(Constructor,input){this._instanceConstructor=Constructor,
this.promise=new Constructor(lib$es6$promise$$internal$$noop),this._validateInput(input)?(this._input=input,this.length=input.length,this._remaining=input.length,this._init(),0===this.length?lib$es6$promise$$internal$$fulfill(this.promise,this._result):(this.length=this.length||0,this._enumerate(),0===this._remaining&&lib$es6$promise$$internal$$fulfill(this.promise,this._result))):lib$es6$promise$$internal$$reject(this.promise,this._validationError())}lib$es6$promise$enumerator$$Enumerator.prototype._validateInput=function(input){return lib$es6$promise$utils$$isArray(input)},lib$es6$promise$enumerator$$Enumerator.prototype._validationError=function(){
return new Error("Array Methods must be provided an Array")},lib$es6$promise$enumerator$$Enumerator.prototype._init=function(){this._result=new Array(this.length)};var lib$es6$promise$enumerator$$default=lib$es6$promise$enumerator$$Enumerator;lib$es6$promise$enumerator$$Enumerator.prototype._enumerate=function(){for(var length=this.length,promise=this.promise,input=this._input,i=0;promise._state===lib$es6$promise$$internal$$PENDING&&i<length;i++)this._eachEntry(input[i],i)},lib$es6$promise$enumerator$$Enumerator.prototype._eachEntry=function(entry,i){var x,c=this._instanceConstructor;"object"==typeof(x=entry
)&&null!==x?entry.constructor===c&&entry._state!==lib$es6$promise$$internal$$PENDING?(entry._onerror=null,this._settledAt(entry._state,i,entry._result)):this._willSettleAt(c.resolve(entry),i):(this._remaining--,this._result[i]=entry)},lib$es6$promise$enumerator$$Enumerator.prototype._settledAt=function(state,i,value){var promise=this.promise;promise._state===lib$es6$promise$$internal$$PENDING&&(this._remaining--,state===lib$es6$promise$$internal$$REJECTED?lib$es6$promise$$internal$$reject(promise,value):this._result[i]=value),0===this._remaining&&lib$es6$promise$$internal$$fulfill(promise,this._result)},
...
this),define("lib/uuid",[],function(){var CHARS="0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz".split("");return function(len,radix){var i,r,chars=CHARS,uuid=[];if(radix=radix||chars.length,len)for(i=0;i<len;i++)uuid[i]=chars[0|Math.random()*radix];else for(uuid[8]=uuid[13]=uuid[18]=uuid[23]="-",uuid[14]="4",i=0;i<36;i++)uuid[i]||(r=0|16*Math.random(),uuid[i]=chars[19===i?3&r|8:r]);return uuid.join("")}}),define("i18n",["lodash","json!i18ntr/messages.json","context","core/format"],function(_,i18nTr,context,format){"use strict";var translations=i18nTr.translations;return function(message){
var localized=translations[message]?translations[message]:message;return 1<arguments.length&&(message=localized,localized=format.apply(null,arguments)),localized}}),define("tpl!ui/component/tpl/component",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){return this.compilerInfo=[4,">= 1.0.0"],helpers=this.merge(helpers,Handlebars.helpers),data=data||{},'<div class="component"></div>'})}),define("tpl!ui/feedback/feedback",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){this.compilerInfo=[4,">= 1.0.0"],helpers=this.merge(helpers,Handlebars.helpers),data=data||{}
...
link.href=url,document.getElementsByTagName("head")[0].appendChild(link)},_url:function(action,controller,extension,params){var url;if("string"!=typeof action||"string"!=typeof controller||"string"!=typeof extension)throw new TypeError("All parts are required to build an URL");return url=context.root_url+extension+"/"+controller+"/"+action,_.isString(params)?url+="?"+params:_.isPlainObject(params)&&(url+="?"+$.param(params)),url}}}),define("tpl!ui/deleter/undo",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){this.compilerInfo=[4,">= 1.0.0"],helpers=this.merge(helpers,Handlebars.helpers),data=data||{}
;var helper,options,buffer="",escapeExpression=this.escapeExpression,helperMissing=helpers.helperMissing;return buffer+='<div class="undobox feedback-info">\n    <span class="icon-info"></span>\n        ',buffer+=escapeExpression((helper=helpers.undoMessage)?helper.call(depth0,{hash:{},data:data}):"function"==typeof(helper=depth0&&depth0.undoMessage)?helper.call(depth0,{hash:{},data:data}):helper)+'\n        <a class="undo" href="#">'+escapeExpression((options={hash:{},data:data},(helper=helpers.__||depth0&&depth0.__)?helper.call(depth0,"Undo",options):helperMissing.call(depth0,"__","Undo",options)))+'</a>\n    <span title="'+escapeExpression((options={
hash:{},data:data},(helper=helpers.__||depth0&&depth0.__)?helper.call(depth0,"Remove Message",options):helperMissing.call(depth0,"__","Remove Message",options)))+'" class="icon-close" data-close=":parent .undobox"></span>\n</div>\n'})}),define("lib/gamp/gamp",[],function(){"use strict";function gamp(){for(var val,digits,point,i=arguments.length-1,factor=-1/0;0<=i;)factor=Math.max(factor,(val=arguments[i--],digits=void 0,digits=String(val),(point=digits.indexOf("."))<0?1:Math.pow(10,digits.length-point-1)));return Math.abs(factor)}return gamp.normalize=function(val,factor){return Math.round(factor*Number(val))},gamp.round=function(val,digits){return Number(
Number(val).toPrecision(void 0===digits?16:digits))},gamp.add=function(a,b){var factor=gamp(a,b);return gamp.round((gamp.normalize(a,factor)+gamp.normalize(b,factor))/factor)},gamp.sub=function(a,b){var factor=gamp(a,b);return gamp.round((gamp.normalize(a,factor)-gamp.normalize(b,factor))/factor)},gamp.mul=function(a,b){var factor=gamp(a,b);return gamp.round(gamp.normalize(a,factor)*gamp.normalize(b,factor)/(factor*factor),15)},gamp.div=function(a,b){var factor=gamp(a,b);return gamp.round(gamp.normalize(a,factor)/gamp.normalize(b,factor))},gamp.pow=function(a,b){var factor=gamp(a),ta=gamp.normalize(a,factor),ib=Math.floor(b),fb=b-ib,res=ib?Math.pow(ta,ib
)/Math.pow(factor,ib):1;return fb&&(res=gamp.div(gamp.mul(res,Math.pow(ta,fb)),Math.pow(factor,fb))),gamp.round(res,15)},gamp}),function(root,factory){"function"==typeof define&&define.amd?define("lib/polyfill/svg4everybody/svg4everybody",[],function(){return root.svg4everybody=factory()}):"object"==typeof exports?module.exports=factory():root.svg4everybody=factory()}(this,function(){function embed(svg,target){if(target){var fragment=document.createDocumentFragment(),viewBox=!svg.getAttribute("viewBox")&&target.getAttribute("viewBox");viewBox&&svg.setAttribute("viewBox",viewBox);for(var clone=target.cloneNode(!0);clone.childNodes.length;
)fragment.appendChild(clone.firstChild);var group=document.createElementNS("http://www.w3.org/2000/svg","g");group.setAttribute("class","use"),group.appendChild(fragment),svg.appendChild(group)}}function loadreadystatechange(xhr){xhr.onreadystatechange=function(){if(4===xhr.readyState){var cachedDocument=xhr._cachedDocument;cachedDocument||((cachedDocument=xhr._cachedDocument=document.implementation.createHTMLDocument("")).body.innerHTML=xhr.responseText,xhr._cachedTarget={}),xhr._embeds.splice(0).map(function(item){var target=xhr._cachedTarget[item.id];target||(target=xhr._cachedTarget[item.id]=cachedDocument.getElementById(item.id)),embed(item.svg,target)}
)}},xhr.onreadystatechange()}return function(rawopts){var polyfill,opts=Object(rawopts);polyfill="polyfill"in opts?opts.polyfill:/\bTrident\/[567]\b|\bMSIE (?:9|10)\.0\b/.test(navigator.userAgent)||(navigator.userAgent.match(/\bEdge\/12\.(\d+)\b/)||[])[1]<10547||(navigator.userAgent.match(/\bAppleWebKit\/(\d+)\b/)||[])[1]<537;var requests={},requestAnimationFrame=window.requestAnimationFrame||setTimeout,uses=document.getElementsByTagName("use");polyfill&&function oninterval(){for(var index=0;index<uses.length;){var use=uses[index],svg=use.parentNode;if(svg&&/svg/i.test(svg.nodeName)){var src=use.getAttribute("xlink:href");if(polyfill&&(
!opts.validate||opts.validate(src,svg,use))){svg.removeChild(use);var srcSplit=src.split("#"),url=srcSplit.shift(),id=srcSplit.join("#");if(url.length){var xhr=requests[url];xhr||((xhr=requests[url]=new XMLHttpRequest).open("GET",url),xhr.send(),xhr._embeds=[]),xhr._embeds.push({svg:svg,id:id}),loadreadystatechange(xhr)}else embed(svg,document.getElementById(id))}}else++index}requestAnimationFrame(oninterval,67)}()}}),define("ui",["ui/toggler","ui/disabler","ui/adder","ui/deleter","ui/incrementer","ui/inplacer","ui/btngrouper","ui/durationer","ui/selecter","ui/modal","ui/tooltip","ui/form","ui/validator","ui/groupvalidator"],function(toggler,disabler,adder,
deleter,incrementer,inplacer,btngrouper,durationer,selecter,modal,tooltip,form){"use strict";return{startEventComponents:function($container){adder($container),btngrouper($container),deleter($container),disabler($container),toggler($container),inplacer($container),modal($container),form($container),this.startDomComponent($container)},startDomComponent:function($container){incrementer($container),durationer($container),selecter($container),(/\bTrident\/[567]\b|\bMSIE (?:9|10)\.0\b/.test(navigator.userAgent)||(navigator.userAgent.match(/\bEdge\/12\.(\d+)\b/)||[])[1]<10547||(navigator.userAgent.match(/\bAppleWebKit\/(\d+)\b/)||[])[1]<537)&&require([
"lib/polyfill/svg4everybody/svg4everybody"],function(svg4everybody){svg4everybody()}),tooltip($container)}}}),define("controller/backoffice",["jquery","lodash","i18n","context","helpers","core/router","ui","core/history","ui/feedback","layout/logout-event"],function($,_,__,context,helpers,router,ui,history,feedback,logoutEvent){"use strict";return{start:function(){var $doc=$(document),$container=$("body > .content-wrap");history.fixBrokenBrowsers(),$doc.ajaxComplete(function(event,request,settings){var urls,forward;_.contains(settings.dataTypes,"html")&&(urls=[settings.url],(forward=request.getResponseHeader("X-Tao-Forward"))&&urls.push(forward),
router.dispatch(urls,function(){ui.startDomComponent($container)}))}),router.dispatchUrl(helpers._url(context.action,context.module,context.extension)),$doc.ajaxError(function(event,request,settings){var ajaxResponse,errorMessage=__("Unknown Error");if(404!==request.status||"HEAD"!==settings.type){if(404===request.status||500===request.status)try{errorMessage=null!==(ajaxResponse=$.parseJSON(request.responseText))&&void 0!==ajaxResponse.success&&void 0!==ajaxResponse.type&&void 0!==ajaxResponse.message&&void 0!==ajaxResponse.data?request.status+": "+ajaxResponse.message:request.status+": "+request.responseText}catch(err){
errorMessage=request.status+": "+request.responseText}403===request.status?logoutEvent():feedback().error(errorMessage)}}),ui.startEventComponents($container)}}}),define("controller/entry",["jquery","lodash","i18n","ui/feedback"],function($,_,__,feedback){"use strict";return{start:function(){var errorMessage=$("#entry-point-box").data("errormessage");errorMessage&&feedback().error(errorMessage)}}}),define("lock",["jquery","helpers"],function($,helpers){function Lock(resourceUri){this.uri=resourceUri}return Lock.prototype.release=function(cb,err){var releaseUrl=helpers._url("release","Lock","tao"),options={data:{uri:this.uri},type:"POST",dataType:"json"}
;$.ajax(releaseUrl,options).success(cb).fail(err)},Lock}),define("layout/generisRouter",["jquery","lodash","core/eventifier","util/url"],function($,_,eventifier,urlUtil){"use strict";var topState,generisRouter=eventifier({pushSectionState:function(baseUrl,sectionId,restoreWith){var stateUrl,parsedUrl=urlUtil.parse(baseUrl),currentQuery=_.mapValues(parsedUrl.query,function(value,key){return"uri"===key?decodeURIComponent(value):value}),newQuery=_.clone(currentQuery),baseUrlHasSection=currentQuery.section,newState={sectionId:sectionId,restoreWith:restoreWith||"activate",nodeUri:currentQuery.uri};baseUrlHasSection?sectionId!==currentQuery.section&&(
newQuery.section=sectionId,delete newQuery.uri,delete newState.nodeUri):newQuery.section=sectionId,sectionId&&!_.isEqual(currentQuery,newQuery)&&(stateUrl=urlUtil.build(parsedUrl.path,newQuery),baseUrlHasSection?(window.history.pushState(newState,null,stateUrl),this.trigger("pushsectionstate",stateUrl)):(window.history.replaceState(newState,null,stateUrl),this.trigger("replacesectionstate",stateUrl)),topState=newState)},pushNodeState:function(baseUrl,nodeUri){var stateUrl,parsedUrl=urlUtil.parse(baseUrl),currentQuery=_.mapValues(parsedUrl.query,function(value,key){return"uri"===key?decodeURIComponent(value):value}),newQuery=_.clone(currentQuery),
...
context,url,generisRouter){"use strict";return{scope:$(".section-container"),sections:{},selected:null,init:function($scope,options){var $openersContainer,self=this,restore=!0,parsedUrl=url.parse(location.href),defaultSection=parsedUrl.query.section,defaultUri=decodeURIComponent(parsedUrl.query.uri);if(this.options=options||{},this.scope=$scope||this.scope||$(".section-container"),$openersContainer=$(".tab-container",this.scope),this.selected=null,$("li",$openersContainer).each(function(index){var $sectionOpener=$(this),$link=$sectionOpener.children("a"),id=$link.attr("href").replace("#panel-",""),$panel=$("#panel-"+id),
isActive=defaultSection?defaultSection===id:0===index;$panel.removeClass("hidden"),self.sections[id]={id:id,url:$link.data("url"),name:$link.text(),panel:$panel,opener:$sectionOpener,type:$panel.find(".section-trees").children().length?"tree":"content",active:isActive,activated:!1,disabled:$sectionOpener.hasClass("disabled"),defaultUri:isActive&&defaultUri?defaultUri:""}}),0===_(this.sections).where({active:!0}).size())for(var id in this.sections){restore=!(this.sections[id].active=!0);break}if(this._bindOpener($openersContainer),this.scope.trigger("init.section"),generisRouter.off(".sectionManager").on("sectionactivate.sectionManager",function(sectionId){
self.get(sectionId)._activate()}).on("sectionshow.sectionManager",function(sectionId){self.get(sectionId)._show()}),!1===this.options.history||!restore||!generisRouter.hasRestorableState())return this.activate();generisRouter.restoreState()},_bindOpener:function($openersContainer){var self=this;return $openersContainer.off("click.section","li").on("click.section","li",function(e){e.preventDefault();var id=$(this).children("a").attr("href").replace("#panel-","");self.sections[id].disabled||self.get(id).activate()}),$("li:not(.hidden)",$openersContainer).length<2?$openersContainer.hide():$openersContainer.show(),this},activate:function(){
return this.selected||this.current(),!1!==this.options.history&&generisRouter.pushSectionState(location.href,this.selected.id,"activate"),this._activate()},_activate:function(){return this._show(),!1===this.selected.activated&&(this.selected.activated=!0,this.scope.trigger("activate.section",[this.selected])),this},show:function(){return this.selected||this.current(),!1!==this.options.history&&generisRouter.pushSectionState(location.href,this.selected.id,"show"),this._show()},_show:function(){var self=this,active=_(this.sections).where({active:!0}).first();return this.selected&&this.selected.id!==active.id?(_.forEach(this.sections,function(section){
section.active=!1}),this.sections[this.selected.id].active=!0):this.current(),_.where(this.sections,{active:!1}).forEach(function(section){section.opener.removeClass("active"),section.panel.hide(),self.scope.trigger("hide.section",[section])}),_.where(this.sections,{active:!0}).forEach(function(section){section.opener.addClass("active"),section.panel.show(),self.scope.trigger("show.section",[section])}),this},refresh:function(){return this.sections={},this.init()},enable:function(){return this.selected||this.current(),!0===this.selected.disabled&&(this.selected.disabled=!1,this.selected.opener.removeClass("disabled"),this.scope.trigger("enable.section",[
this.selected])),this},disable:function(){return this.selected||this.current(),!1===this.selected.disabled&&(this.selected.disabled=!0,this.selected.opener.addClass("disabled"),this.scope.trigger("disable.section",[this.selected])),this},current:function(){return this.selected=_(this.sections).where({active:!0}).first(),this},create:function(data){var $sectionOpener,$sectionPanel,section,$openersContainer=this.scope.find(".tab-container");if(!_.isObject(data))throw new TypeError("The create() method requires an object with section data as parameter.");if(!_.isString(data.id)||!_.isString(data.url)||!_.isString(data.name))throw new TypeError(
"The create() method requires data with id, url and name to create a new section.");return void 0===data.visible&&(data.visible=!0),this.get(data.id),(section=this.selected&&this.selected.id===data.id?this.selected:void 0)||($sectionPanel=$('<div id="panel-'+data.id+'" class="clear"></div>'),!0===data.contentBlock&&$sectionPanel.append('<section class="content-container"><ul class="plain action-bar content-action-bar horizontal-action-bar"></ul><div class="content-block"></div></section>'),$sectionOpener=$('<li class="small '+(data.visible?"":"hidden")+'"><a title="'+data.name+'" data-url="'+data.url+'" href="#panel-'+data.id+'">'+data.name+"</a></li>"),
$openersContainer.append($sectionOpener),this.scope.append($sectionPanel),section={id:data.id,url:data.url,name:data.name,panel:$sectionPanel,opener:$sectionOpener,type:"content",active:!1},this.sections[data.id]=section),section.url=section.url===data.url||void 0===data.url?section.url:data.url,this.selected=section,data.content?!0===data.contentBlock?this.updateContentBlock(data.content):section.panel.html(data.content):!0===data.contentBlock?this.loadContentBlock():this.load(),this._bindOpener($openersContainer),this},get:function(value){var section;if(!_.isString(value))throw new TypeError(
"The get() method requires a string parameter, the section id or url.");return(section=this.sections[value]||this.sections[value.replace("panel-","")]||_(this.sections).where({url:value}).first()||_(this.sections).where({url:context.root_url+value}).first())?this.selected=section:this.current(),this},load:function(url,data,loaded){var self=this;return this.selected||this.current(),url=url||this.selected.url,"tree"===this.selected.type?this.selected.panel.addClass("content-panel"):this.selected.panel.removeClass("content-panel"),this.selected.panel.empty().load(url,data,function(response){self.scope.trigger("load.section",[self.selected,response]),
_.isFunction(loaded)&&loaded()}),this},loadContentBlock:function(url,data,loaded){var $contentblock;return this.selected||this.current(),url=url||this.selected.url,"tree"===this.selected.type?this.selected.panel.addClass("content-panel"):this.selected.panel.removeClass("content-panel"),($contentblock=$(".content-block",this.selected.panel)).length?($contentblock.empty().load(url,data,loaded),this):this.load(url,data,loaded)},updateContentBlock:function(html){var $contentblock=$(".content-block",this.selected.panel);return $contentblock.length?$contentblock.empty().html(html):this.selected.panel.empty().html(html),this},on:function(eventName,cb){var self=this
;return this.scope.on(eventName+".section",function(e){cb.apply(self,Array.prototype.slice.call(arguments,1))}),this},off:function(eventName){return this.scope.off(eventName+".section"),this}}}),define("controller/Lock/locked",["jquery","i18n","helpers","lock","layout/section","ui/feedback"],function($,__,helpers,Lock,sectionApi,feedback){"use strict";return{start:function(){$(".forcerelease").click(function(e){e.preventDefault(),$.ajax({url:helpers._url("forceRelease","Lock","tao"),type:"POST",data:{uri:$(this).data("id")},dataType:"json",success:function(response){response.success?(feedback().success(__("The lock has been released")),$(".tree").trigger(
"refresh.taotree")):feedback().error(__("Unable to release the lock"))},error:function(){feedback().error(__("Unable to release the lock"))}})})}}}),define("layout/version-warning",["jquery","jquery.cookie"],function($){"use strict";var versionWarning=$(".version-warning");function hideWarning(slide){var callback=function(){document.documentElement.className+=" no-version-warning",versionWarning.trigger("hiding.versionwarning")};slide?versionWarning.slideUp("slow",function(){versionWarning.slideUp("slow",callback)}):(versionWarning.hide(),callback())}return{init:function(){$.cookie("versionWarning")?hideWarning(!1):versionWarning.find(".close-trigger").on(
"click",function(){$.cookie("versionWarning",!0,{path:"/"}),hideWarning(!0)})}}}),define("controller/login",["jquery","lodash","i18n","module","ui/feedback","layout/loading-bar","layout/version-warning"],function($,_,__,module,feedback,loadingBar,versionWarning){"use strict";return{start:function(){var $fields,messages=module.config().message||{},$context=$(".entry-point-container"),$loginForm=$context.find("#loginForm"),$fakeForm=$context.find(".fakeForm"),$loginBtn=$context.find("[name=connect]");function submitForm(){$fakeForm.find(":input").each(function(){var $field=$(this);$loginForm.find('input[name="'+$field.attr("name")+'"]').val($field.val())}),
loadingBar.start(),$loginForm.submit()}versionWarning.init(),!messages.error&&$context.find(".form-error").length&&(messages.error=__("All fields are required")),$fields=$context.find(":input"),_.forEach(messages,function(message,level){message&&(feedback().message(level,message).open(),$fields.addClass(level))}),$fakeForm.find('input[type="submit"], button[type="submit"]').off("click").on("click",function(e){e.preventDefault(),submitForm()}),$fakeForm.on("keypress",function(e){13===e.which&&(e.preventDefault(),submitForm())}),$loginBtn.removeAttr("disabled").removeClass("disabled"),loadingBar.stop()}}}),define("form/post-render-props",["jquery","i18n",
"ui/feedback"],function($,__,feedback){function _toggleModeBtn(newMode){var $modeToggle=$(".property-mode");"disabled"===newMode?$modeToggle.addClass("disabled"):$modeToggle.removeClass("disabled")}function _upgradeButtons($container,type){"radio"!==type&&"checkbox"!==type&&(type="radio");var selector=".form_checklst",notSelector="";"radio"===type&&(selector=".form_radlst",notSelector=".form_checklst, "),$container.find(selector).not(notSelector+".property-"+type+"-list").each(function(){var $radioList=$(this);$radioList.addClass("property-"+type+"-list"),$radioList.parent().addClass("property-"+type+"-list-box"),$radioList.each(function(){var $block=$(this)
,$inputs=$block.find("input");$inputs.length<=2&&$block.find("br").remove(),$inputs.each(function(){var $input=$(this),$label=$block.find('label[for="'+this.id+'"]'),$icon=$("<span>",{class:"icon-"+type});$label.prepend($icon),$label.prepend($input)})})})}function getPropertyContainer(){var $propertyContainer=$(".content-block .property-container");return $propertyContainer.length||($propertyContainer=$("<div>",{class:"property-container"}),$(".content-block .form-group").first().before($propertyContainer)),$propertyContainer}function _hideProperties($container){$(".property",$container).each(function(){for(var $currentTarget=$(this);!_.isEqual(
$currentTarget.parent()[0],$container[0]);)$currentTarget=$currentTarget.parent();$currentTarget.hide()}),_toggleModeBtn("disabled")}function _showProperties($container){$(".property",$container).each(function(){for(var $currentTarget=$(this);!_.isEqual($currentTarget.parent()[0],$container[0]);)$currentTarget=$currentTarget.parent();$currentTarget.show()});var elt=$('[class*="property-type"]',$container).parent("div").next("div");new RegExp(["list","tree"].join("$|").concat("$")).test($('[class*="property-type"]',$container).val())?"none"===elt.css("display")&&(elt.show(),elt.find("select").removeAttr("disabled")):"none"!==elt.css("display")&&(elt.css(
"display","none"),elt.find("select").prop("disabled","disabled")),_toggleModeBtn("enabled")}function _hideIndexes($container){$(".index",$container).each(function(){for(var $currentTarget=$(this);!_.isEqual($currentTarget.parent()[0],$container[0]);)$currentTarget=$currentTarget.parent();$currentTarget.hide()}),$(".index-remover",$container).each(function(){$(this).parent().hide()})}function _showIndexes($container){$(".index",$container).each(function(){for(var $currentTarget=$(this);!_.isEqual($currentTarget.parent()[0],$container[0]);)$currentTarget=$currentTarget.parent();$currentTarget.show()}),$(".index-remover",$container).each(function(){$(this
).parent().show()})}return{init:function($properties){var $container=$(".content-block .xhtml_form:first form");$container.length&&(function($container){var $copyField,isInstanceForm=document.getElementById("tao.forms.instance"),$idField=$container.find("#id"),$label=$("<span>",{class:"form_desc",text:__("Resource Identifier")}),$button=$("<span>",{class:"icon-clipboard clipboard-command",title:__("Copy to clipboard")}).on("click",function(){var success;try{$copyField.select(),success=document.execCommand("copy"),$copyField.blur(),success?feedback().success(__("Resource Identifier has been copied to the clipboard")):feedback().error(__(
"Resource Identifier could not be copied to the clipboard"))}catch(err){feedback().error(__("Your browser does not support copying to the clipboard"))}}),$fieldBox=$("<span>",{class:"uri-container"});$(".uri-container").length||isInstanceForm&&$idField.length&&($copyField=$idField.clone().attr({readonly:!0,type:"text"}),$idField.remove(),$fieldBox.append([$copyField,$button]),$container.find("div").first().after($("<div>").append([$label,$fieldBox])),$fieldBox.height($copyField.outerHeight()),$copyField.addClass("final"))}($container),$properties&&$properties.length||($properties=$container.children('div[id*="property_"]').not(".property-block")),
$properties.length&&(function($properties){var $propertyContainer=getPropertyContainer(),hasAlreadyProperties=!!$propertyContainer.find(".property-block").length;$properties.each(function(){var $property=$(this);if(void 0!==$property.attr){var type=function(){var $propertyMode=$(".property-mode");switch($property.attr("id").replace(/_?property_[\d]+/,"")){case"ro":return"readonly-property";case"parent":return"parent-property";default:var $editIcon=$property.find(".icon-edit"),$editContainer=$property.children("div:first"),$indexIcon=$property.find(".icon-find");return $editContainer.addClass("property-edit-container"),_hideProperties($editContainer),
_hideIndexes($editContainer),$propertyMode.hasClass("property-mode-simple")?$indexIcon.hide():$propertyMode.hasClass("property-mode-advanced")&&$indexIcon.show(),$editIcon.on("click",function(){$editContainer.parent().hasClass("property-edit-container-open")?$($(".property",$editContainer)[0]).is(":visible")?$editContainer.slideToggle(function(){$editContainer.parent().toggleClass("property-edit-container-open"),_hideProperties($editContainer)}):(_hideIndexes($editContainer),_showProperties($editContainer)):(_hideIndexes($editContainer),_showProperties($editContainer),$editContainer.slideToggle(function(){$editContainer.parent().toggleClass(
"property-edit-container-open")}))}),$indexIcon.on("click",function(){$(".property-mode").hasClass("property-mode-advanced")&&($editContainer.parent().hasClass("property-edit-container-open")?$($(".index",$editContainer)[0]).is(":visible")?$editContainer.slideToggle(function(){$editContainer.parent().toggleClass("property-edit-container-open"),_hideIndexes($editContainer)}):(_hideProperties($editContainer),_showIndexes($editContainer)):(_hideProperties($editContainer),_showIndexes($editContainer),$editContainer.slideToggle(function(){$editContainer.parent().toggleClass("property-edit-container-open")})))}),"regular-property"}}();$property.addClass(
hasAlreadyProperties?"property-block "+type:"property-block-first property-block "+type),$propertyContainer.append($property),hasAlreadyProperties=!0}})}($properties),_upgradeButtons($container,"radio"),_upgradeButtons($container,"checkbox"),_toggleModeBtn("disabled"),function($container){var $editContainer,$error=$container.find(".error");$error.length&&($editContainer=$error.closest(".property-edit-container")).length&&(_hideIndexes($editContainer),_showProperties($editContainer),$editContainer.slideToggle(function(){$editContainer.parent().toggleClass("property-edit-container-open")}))}($container)))},getPropertyContainer:getPropertyContainer}}),define(
"form/property",["jquery","lodash","form/post-render-props"],function($,_,postRenderProps){return{add:function(classUri,url){var $existingProperties=$(".property-block"),index=$existingProperties.length;$existingProperties.each(function(){index=Math.max(parseInt(this.id.replace(/[\D]+/,"")),index)}),index++,$.ajax({url:url,type:"POST",data:{index:index,id:classUri},dataType:"html",success:function(response){var $response=$(response),property=$response.first();1<$response.length&&$response.last().appendTo(property);postRenderProps.init(property)}})},remove:function(uri,classUri,url,successCallback){$.ajax({url:url,type:"POST",data:{uri:uri,classUri:classUri},
dataType:"html",success:function(){_.isFunction(successCallback)&&successCallback()}})}}}),define("jwysiwyg",["jquery"],function($){var Wysiwyg=function(element,options){this.init(element,options)},innerDocument=function(elts){var element=$(elts).get(0);if("iframe"!==element.nodeName.toLowerCase())return element;if(element.contentDocument)return element.contentDocument;if(element.contentWindow)return element.contentWindow.document;throw"Unexpected error in innerDocument"},documentSelection=function(){var element=this.get(0);return element.contentWindow.document.selection?element.contentWindow.document.selection.createRange(
).text:element.contentWindow.getSelection().toString()};$.fn.wysiwyg=function(options){if(0<arguments.length&&options.constructor==String){var action=options.toString(),params=[];if("enabled"==action)return null!==this.data("wysiwyg");for(var i=1;i<arguments.length;i++)params[i-1]=arguments[i];var retValue=null;return this.each(function(){$.data(this,"wysiwyg").designMode(),retValue=Wysiwyg[action].apply(this,params)}),retValue}if(this.data("wysiwyg"))return this;var controls={};for(var control in options&&options.controls&&(controls=options.controls,delete options.controls),(options=$.extend({},$.fn.wysiwyg.defaults,options)).controls=$.extend(!0,
options.controls,$.fn.wysiwyg.controls),controls)control in options.controls?$.extend(options.controls[control],controls[control]):options.controls[control]=controls[control];return this.each(function(){new Wysiwyg(this,options)})},$.fn.wysiwyg.defaults={html:'<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">STYLE_SHEET</head><body>INITIAL_CONTENT</body></html>',
...
formImageHtml:'<form class="wysiwyg"><fieldset><legend>Insert Image</legend><label>Image URL: <input type="text" name="url" value="http://" /></label><label>Image Description: <input type="text" name="description" value="" /></label><input type="submit" class="button" value="Insert Image" /> <input type="reset" value="Cancel" /></fieldset></form>',formWidth:440,formHeight:270,tableFiller:"Lorem ipsum",css:{},debug:!1,autoSave:!0,rmUnwantedBr:!0,brIE:!0,iFrameClass:null,messages:{nonSelection:"select the text you wish to link"},events:{},controls:{},resizeOptions:!1},$.fn.wysiwyg.controls={bold:{visible:!0,tags:["b","strong"],css:{fontWeight:"bold"},
tooltip:"Bold"},italic:{visible:!0,tags:["i","em"],css:{fontStyle:"italic"},tooltip:"Italic"},strikeThrough:{visible:!0,tags:["s","strike"],css:{textDecoration:"line-through"},tooltip:"Strike-through"},underline:{visible:!0,tags:["u"],css:{textDecoration:"underline"},tooltip:"Underline"},justifyLeft:{visible:!0,groupIndex:1,css:{textAlign:"left"},tooltip:"Justify Left"},justifyCenter:{visible:!0,tags:["center"],css:{textAlign:"center"},tooltip:"Justify Center"},justifyRight:{visible:!0,css:{textAlign:"right"},tooltip:"Justify Right"},justifyFull:{visible:!0,css:{textAlign:"justify"},tooltip:"Justify Full"},indent:{groupIndex:2,visible:!0,tooltip:"Indent"},
outdent:{visible:!0,tooltip:"Outdent"},subscript:{groupIndex:3,visible:!0,tags:["sub"],tooltip:"Subscript"},superscript:{visible:!0,tags:["sup"],tooltip:"Superscript"},undo:{groupIndex:4,visible:!0,tooltip:"Undo"},redo:{visible:!0,tooltip:"Redo"},insertOrderedList:{groupIndex:5,visible:!0,tags:["ol"],tooltip:"Insert Ordered List"},insertUnorderedList:{visible:!0,tags:["ul"],tooltip:"Insert Unordered List"},insertHorizontalRule:{visible:!0,tags:["hr"],tooltip:"Insert Horizontal Rule"},createLink:{groupIndex:6,visible:!0,exec:function(){var selection=documentSelection.call($(this.editor));if(selection&&0<selection.length)if($.browser.msie)this.focus(),
this.editorDoc.execCommand("createLink",!0,null);else{var szURL=prompt("URL","http://");szURL&&0<szURL.length&&(this.editorDoc.execCommand("unlink",!1,null),this.editorDoc.execCommand("createLink",!1,szURL))}else this.options.messages.nonSelection&&alert(this.options.messages.nonSelection)},tags:["a"],tooltip:"Create link"},insertImage:{visible:!0,exec:function(){var self=this;if($.fn.dialog){var dialog=$($.fn.wysiwyg.defaults.formImageHtml).appendTo("body");dialog.dialog({modal:!0,width:$.fn.wysiwyg.defaults.formWidth,height:$.fn.wysiwyg.defaults.formHeight,open:function(ev,ui){$.fn.fmbind&&$('input[name="url"]').fmbind({type:"image"},function(elt,value){$(
elt).val(value)}),$("input:submit",$(this)).click(function(e){e.preventDefault();var img="<img src='"+$('input[name="url"]',dialog).val()+"' alt='"+$('input[name="description"]',dialog).val()+"' />";self.insertHtml(img),self.saveContent(),$(dialog).dialog("close")}),$("input:reset",$(this)).click(function(e){e.preventDefault(),$(dialog).dialog("close")})},close:function(ev,ui){$(this).dialog("destroy")}})}else if($.browser.msie)this.focus(),this.editorDoc.execCommand("insertImage",!0,null);else{var szURL=prompt("URL","http://");szURL&&0<szURL.length&&this.editorDoc.execCommand("insertImage",!1,szURL)}},tags:["img"],tooltip:"Insert image"},insertTable:{
visible:!0,exec:function(){var self=this;if($.fn.modal)$.modal($.fn.wysiwyg.defaults.formTableHtml,{onShow:function(dialog){$("input:submit",dialog.data).click(function(e){e.preventDefault();var rowCount=$('input[name="rowCount"]',dialog.data).val(),colCount=$('input[name="colCount"]',dialog.data).val();self.insertTable(colCount,rowCount,$.fn.wysiwyg.defaults.tableFiller),$.modal.close()}),$("input:reset",dialog.data).click(function(e){e.preventDefault(),$.modal.close()})},maxWidth:$.fn.wysiwyg.defaults.formWidth,maxHeight:$.fn.wysiwyg.defaults.formHeight,overlayClose:!0});else if($.fn.dialog){var dialog=$($.fn.wysiwyg.defaults.formTableHtml).appendTo("body"
);dialog.dialog({modal:!0,width:$.fn.wysiwyg.defaults.formWidth,height:$.fn.wysiwyg.defaults.formHeight,open:function(event,ui){$("input:submit",$(this)).click(function(e){e.preventDefault();var rowCount=$('input[name="rowCount"]',dialog).val(),colCount=$('input[name="colCount"]',dialog).val();self.insertTable(colCount,rowCount,$.fn.wysiwyg.defaults.tableFiller),$(dialog).dialog("close")}),$("input:reset",$(this)).click(function(e){e.preventDefault(),$(dialog).dialog("close")})},close:function(event,ui){$(this).dialog("destroy")}})}else{var colCount=prompt("Count of columns","3"),rowCount=prompt("Count of rows","3");this.insertTable(colCount,rowCount,
$.fn.wysiwyg.defaults.tableFiller)}},tags:["table"],tooltip:"Insert table"},h1:{visible:!0,groupIndex:7,className:"h1",command:$.browser.msie||$.browser.safari?"FormatBlock":"heading",arguments:$.browser.msie||$.browser.safari?"<h1>":"h1",tags:["h1"],tooltip:"Header 1"},h2:{visible:!0,className:"h2",command:$.browser.msie||$.browser.safari?"FormatBlock":"heading",arguments:$.browser.msie||$.browser.safari?"<h2>":"h2",tags:["h2"],tooltip:"Header 2"},h3:{visible:!0,className:"h3",command:$.browser.msie||$.browser.safari?"FormatBlock":"heading",arguments:$.browser.msie||$.browser.safari?"<h3>":"h3",tags:["h3"],tooltip:"Header 3"},cut:{groupIndex:8,visible:!1,
tooltip:"Cut"},copy:{visible:!1,tooltip:"Copy"},paste:{visible:!1,tooltip:"Paste"},increaseFontSize:{groupIndex:9,visible:!1,tags:["big"],tooltip:"Increase font size"},decreaseFontSize:{visible:!1,tags:["small"],tooltip:"Decrease font size"},removeFormat:{visible:!0,exec:function(){$.browser.msie&&this.focus(),this.editorDoc.execCommand("formatBlock",!1,"<P>"),this.editorDoc.execCommand("removeFormat",!1,null),this.editorDoc.execCommand("unlink",!1,null)},tooltip:"Remove formatting"},html:{groupIndex:10,visible:!1,exec:function(){if(this.viewHTML)this.setContent($(this.original).val()),$(this.original).hide(),$(this.editor).parent().css("height","95%"),$(
this.editor).show(),this.options.events.unsetHTMLview&&this.options.events.unsetHTMLview(this.editorDoc);else{var $ed=$(this.editor);this.saveContent(),$(this.original).css({width:$(this.element).outerWidth()-6,height:$(this.element).height()-$(this.panel).height()-6,resize:"none"}).show(),$ed.hide(),$(this.editor).parent().css("height","auto"),this.options.events.setHTMLview&&this.options.events.setHTMLview(this.editorDoc)}this.viewHTML=!this.viewHTML},tooltip:"View source code"},rtl:{visible:!1,exec:function(){var selection=$(this.editor).documentSelection();selection=0<$("<div />").append(selection).children().length?$(selection).attr("dir","rtl"):$(
"<div />").attr("dir","rtl").append(selection),this.editorDoc.execCommand("inserthtml",!1,$("<div />").append(selection).html())},tooltip:"Right to Left"},ltr:{visible:!1,exec:function(){var selection=$(this.editor).documentSelection();selection=0<$("<div />").append(selection).children().length?$(selection).attr("dir","ltr"):$("<div />").attr("dir","ltr").append(selection),this.editorDoc.execCommand("inserthtml",!1,$("<div />").append(selection).html())},tooltip:"Left to Right"}},$.extend(Wysiwyg,{insertImage:function(szURL,attributes){var self=$.data(this,"wysiwyg");if(self.constructor==Wysiwyg&&szURL&&0<szURL.length)if($.browser.msie&&self.focus(),
attributes){self.editorDoc.execCommand("insertImage",!1,"#jwysiwyg#");var img=self.getElementByAttributeValue("img","src","#jwysiwyg#");if(img)for(var attribute in img.src=szURL,attributes)img.setAttribute(attribute,attributes[attribute])}else self.editorDoc.execCommand("insertImage",!1,szURL);return this},createLink:function(szURL){var self=$.data(this,"wysiwyg");if(self.constructor==Wysiwyg&&szURL&&0<szURL.length){var selection=documentSelection.call($(self.editor));selection&&0<selection.length?($.browser.msie&&self.focus(),self.editorDoc.execCommand("unlink",!1,null),self.editorDoc.execCommand("createLink",!1,szURL)
):self.options.messages.nonSelection&&alert(self.options.messages.nonSelection)}return this},insertHtml:function(szHTML){return $.data(this,"wysiwyg").insertHtml(szHTML),this},insertTable:function(colCount,rowCount,filler){return $.data(this,"wysiwyg").insertTable(colCount,rowCount,filler),this},getContent:function(){return $.data(this,"wysiwyg").getContent()},saveContent:function(){$.data(this,"wysiwyg").saveContent()},setContent:function(newContent){var self=$.data(this,"wysiwyg");return self.setContent(newContent),self.saveContent(),this},clear:function(){var self=$.data(this,"wysiwyg");return self.setContent(""),self.saveContent(),this},
removeFormat:function(){return $.data(this,"wysiwyg").removeFormat(),this},save:function(){return $.data(this,"wysiwyg").saveContent(),this},document:function(){var self=$.data(this,"wysiwyg");return $(self.editorDoc)},destroy:function(){return $.data(this,"wysiwyg").destroy(),this},undo:function(){$.data(this,"wysiwyg").editorDoc.execCommand("undo",!1,null)}});var addHoverClass=function(){$(this).addClass("wysiwyg-button-hover")},removeHoverClass=function(){$(this).removeClass("wysiwyg-button-hover")};$.extend(Wysiwyg.prototype,{original:null,options:{},element:null,editor:null,removeFormat:function(){return $.browser.msie&&this.focus(),
this.editorDoc.execCommand("removeFormat",!1,null),this.editorDoc.execCommand("unlink",!1,null),this},destroy:function(){return $(this.element).closest("form").unbind("submit",this.autoSaveFunction).unbind("reset",this.resetFunction),$(this.element).remove(),$.removeData(this.original,"wysiwyg"),$(this.original).show(),this},focus:function(){return this.editor.get(0).contentWindow.focus(),this},init:function(element,options){var self=this;this.editor=element,this.options=options||{},$.data(element,"wysiwyg",this);var newX=element.width||element.clientWidth||0,newY=element.height||element.clientHeight||0;"textarea"==element.nodeName.toLowerCase()&&(
this.original=element,0===newX&&element.cols&&(newX=8*element.cols+21,element.cols=1),0===newY&&element.rows&&(newY=16*element.rows+16,element.rows=1),this.editor=$("https:"==location.protocol?'<iframe src="javascript:false;"></iframe>':"<iframe></iframe>").attr("frameborder","0"),options.iFrameClass?this.editor.addClass(options.iFrameClass):(this.editor.css({minHeight:(newY-6).toString()+"px",width:(newX-8).toString()+"px"}),$.browser.msie&&this.editor.css("height",newY.toString()+"px")),this.editor.attr("tabindex",$(element).attr("tabindex")));var panel=this.panel=$('<ul role="menu" class="panel"></ul>');this.appendControls(),this.element=$("<div></div>"
).addClass("wysiwyg").append(panel).append($("<div>\x3c!-- --\x3e</div>").css({clear:"both"})).append(this.editor),options.iFrameClass||this.element.css({width:0<newX?newX.toString()+"px":"100%"}),$(element).hide().before(this.element),this.viewHTML=!1,this.initialHeight=newY-8,this.initialContent=$(element).val(),this.initFrame(),this.autoSaveFunction=function(){self.saveContent()},this.resetFunction=function(){self.setContent(self.initialContent),self.saveContent()},this.options.resizeOptions&&$.fn.resizable&&this.element.resizable($.extend(!0,{alsoResize:this.editor},this.options.resizeOptions));var $form=$(element).closest("form")
;this.options.autoSave&&$form.submit(self.autoSaveFunction),$form.bind("reset",self.resetFunction)},initFrame:function(){var self=this,style="";if(this.options.css)if(this.options.css.constructor==String)style='<link rel="stylesheet" type="text/css" media="screen" href="'+this.options.css+'" />';else if("array"==typeof this.options.css||"object"==typeof this.options.css)for(var cssArray=$.makeArray(this.options.css),len=cssArray.length,i=0;i<len;i++)isNaN(i)||(style+='<link rel="stylesheet" type="text/css" media="screen" href="'+cssArray[i]+'" />');try{this.editorDoc=innerDocument(this.editor)}catch(e){$.error(e.name+" : "+e.message)}if(
this.editorDoc_designMode=!1,this.designMode(),this.editorDoc.open(),this.editorDoc.write(this.options.html.replace(/INITIAL_CONTENT/,function(){return self.initialContent}).replace(/STYLE_SHEET/,function(){return style})),this.editorDoc.close(),$.browser.msie&&window.setTimeout(function(){$(self.editorDoc.body).css("border","none")},0),$(this.editorDoc).click(function(event){self.checkTargets(event.target?event.target:event.srcElement)}),$(this.original).focus(function(){$(this).filter(":visible")||self.focus()}),$.browser.msie?this.options.brIE&&$(this.editorDoc).keydown(function(event){if(13!=event.keyCode)return!0;var rng=self.getRange()
;return rng.pasteHTML("<br />"),rng.collapse(!1),rng.select(),!1}):$(this.editorDoc).keydown(function(event){if(event.ctrlKey)switch(event.keyCode){case 66:return this.execCommand("Bold",!1,!1),!1;case 73:return this.execCommand("Italic",!1,!1),!1;case 85:return this.execCommand("Underline",!1,!1),!1}return!0}),this.options.autoSave){var handler=function(){self.saveContent()};$(this.editorDoc).keydown(handler).keyup(handler).mousedown(handler).bind($.support.noCloneEvent?"input":"paste",handler)}if(this.options.css&&window.setTimeout(function(){self.options.css.constructor==String||$(self.editorDoc).find("body").css(self.options.css)},0),
0===this.initialContent.length&&this.setContent(""),$.each(this.options.events,function(key,handler){$(self.editorDoc).bind(key,handler)}),$(this.editorDoc.body).addClass("wysiwyg"),this.options.events&&this.options.events.save){handler=this.options.events.save;$(self.editorDoc).bind("keyup",handler),$(self.editorDoc).bind("change",handler),$.support.noCloneEvent?$(self.editorDoc).bind("input",handler):($(self.editorDoc).bind("paste",handler),$(self.editorDoc).bind("cut",handler))}this.editorDoc&&self.options.events&&self.options.events.frameReady&&$(this.editorDoc).ready(function(){self.options.events.frameReady(self)})},designMode:function(){var runner,
attempts=3,self=this,doc=this.editorDoc;(runner=function(){if(innerDocument(self.editor)===doc){try{doc.designMode="on"}catch(e){}0<--attempts&&$.browser.mozilla&&setTimeout(runner,100)}else self.initFrame()})(),this.editorDoc_designMode=!0},getSelection:function(){return window.getSelection?window.getSelection():document.selection},getRange:function(){var selection=this.getSelection();return selection?0<selection.rangeCount?selection.getRangeAt(0):selection.createRange?selection.createRange():null:null},getContent:function(){var returnValue=$(innerDocument(this.editor)).find("body").html();return this.options.events&&this.options.events.afterGetContent&&(
returnValue=this.options.events.afterGetContent(returnValue)),returnValue},setContent:function(newContent){return this.options.events&&this.options.events.beforeSetContent&&(newContent=this.options.events.beforeSetContent(newContent,this)),$(innerDocument(this.editor)).find("body").html(newContent),this.options.events&&this.options.events.afterSetContent&&this.options.events.afterSetContent.call(this),this},insertHtml:function(szHTML){if(szHTML&&0<szHTML.length)if($.browser.msie){this.focus(),this.editorDoc.execCommand("insertImage",!1,"#jwysiwyg#");var img=this.getElementByAttributeValue("img","src","#jwysiwyg#");img&&$(img).replaceWith(szHTML)
}else this.editorDoc.execCommand("insertHTML",!1,szHTML);return this},insertTable:function(colCount,rowCount,filler){if(!isNaN(rowCount)&&!isNaN(colCount)&&null!==rowCount&&null!==colCount){colCount=parseInt(colCount,10),null===filler&&(filler="&nbsp;"),filler="<td>"+filler+"</td>";for(var html=['<table border="1" style="width: 100%;"><tbody>'],i=rowCount=parseInt(rowCount,10);0<i;i--){html.push("<tr>");for(var j=colCount;0<j;j--)html.push(filler);html.push("</tr>")}return html.push("</tbody></table>"),this.insertHtml(html.join(""))}},saveContent:function(){if(this.original){var content=this.getContent();this.options.rmUnwantedBr&&(
content="<br/>"==content.substr(-4)?content.substr(0,content.length-4):content),this.options.events&&this.options.events.beforeSaveContent&&(content=this.options.events.beforeSaveContent(content)),$(this.original).val(content),this.options.events&&this.options.events.save&&this.options.events.save.call(this)}return this},withoutCss:function(){if($.browser.mozilla)try{this.editorDoc.execCommand("styleWithCSS",!1,!1)}catch(e){try{this.editorDoc.execCommand("useCSS",!1,!0)}catch(e2){}}return this},appendMenu:function(cmd,args,className,fn,tooltip){var self=this;return args=args||[],$('<li role="menuitem" UNSELECTABLE="on">'+(className||cmd)+"</li>").addClass(
className||cmd).attr("title",tooltip).hover(addHoverClass,removeHoverClass).click(function(){fn?fn.apply(self):(self.focus(),self.withoutCss(),$.browser.chrome&&"string"==typeof args&&args.match(/h[0-6]{1}/).length?self.editorDoc.execCommand("formatBlock",!1,"<"+args+">"):self.editorDoc.execCommand(cmd,!1,args)),self.options.autoSave&&self.saveContent(),this.blur()}).appendTo(this.panel)},appendMenuSeparator:function(){return $('<li role="separator" class="separator"></li>').appendTo(this.panel)},parseControls:function(){return this.options.parseControls?this.options.parseControls.call(this):this.options.controls},appendControls:function(){
var controls=this.parseControls(),currentGroupIndex=0,hasVisibleControls=!0;for(var name in controls){var control=controls[name];control.groupIndex&&currentGroupIndex!=control.groupIndex&&(currentGroupIndex=control.groupIndex,hasVisibleControls=!1),control.visible&&(hasVisibleControls||(this.appendMenuSeparator(),hasVisibleControls=!0),this.appendMenu(control.command||name,control.arguments||"",control.className||control.command||name||"empty",control.exec,control.tooltip||control.command||name||""))}},checkTargets:function(element){for(var name in this.options.controls){var control=this.options.controls[name],
className=control.className||control.command||name||"empty";if($("."+className,this.panel).removeClass("active"),control.tags){var elm=element;do{if(1!=elm.nodeType)break;-1!=$.inArray(elm.tagName.toLowerCase(),control.tags)&&$("."+className,this.panel).addClass("active")}while(elm=elm.parentNode)}if(control.css){var el=$(element);do{if(1!=el[0].nodeType)break;for(var cssProperty in control.css)el.css(cssProperty).toString().toLowerCase()==control.css[cssProperty]&&$("."+className,this.panel).addClass("active")}while(el=el.parent())}}},getElementByAttributeValue:function(tagName,attributeName,attributeValue){for(
var elements=this.editorDoc.getElementsByTagName(tagName),i=0;i<elements.length;i++){var value=elements[i].getAttribute(attributeName);if($.browser.msie&&(value=value.substr(value.length-attributeValue.length)),value==attributeValue)return elements[i]}return!1}})}),define("generis.tree",["jquery","i18n","class"],function($,__,Class){return Class.extend({init:function(selector,dataUrl,options,treeOptions){var self=this;this.STATE_BROWSING=0,this.STATE_FILTERING=1,this.selector=selector,this.options=options,this.dataUrl=dataUrl,this.metaClasses=[],this.lastOpened=null,this.state=this.STATE_BROWSING,this.paginate=void 0!==options.paginate?options.paginate:0,
this.serverParameters=void 0!==options.serverParameters?options.serverParameters:new Array,this.defaultServerParameters={hideInstances:!1|this.options.hideInstances,filter:$("#filter-content-"+options.actionId).val(),offset:0,limit:this.options.paginate},this.treeOptions={data:{type:"json",async:!0,opts:{method:"POST",url:this.dataUrl}},types:{default:{renameable:!1,deletable:!0,creatable:!0}},callback:{beforeopen:function(NODE,TREE_OBJ){self.lastOpened=NODE}}},$.extend(!0,this.treeOptions,treeOptions);var classes=$(selector).attr("class");"string"==typeof classes&&null!=classes.match("tree")||$(selector).tree(this.treeOptions)},createMeta:function(meta){
this.metaClasses[meta.id]={displayed:meta.displayed?meta.displayed:0,count:meta.count?meta.count:0,position:meta.position?meta.position:0}},extractMeta:function(DATA){var nodes=new Array,nodeId=null;if(DATA instanceof Array?(this.lastOpened&&this.state!=this.STATE_FILTERING?nodeId=this.lastOpened.id:(nodeId="DEFAULT_ROOT",this.createMeta({id:nodeId,count:0})),nodes=DATA):(nodeId=DATA.attributes.id,void 0!==DATA.children&&(nodes=DATA.children),this.createMeta({id:DATA.attributes.id,count:DATA.count})),nodes){for(var countClass=0,i=0;i<nodes.length;i++)"class"==nodes[i].type&&(this.extractMeta(nodes[i]),countClass++);var countInstances=nodes.length-countClass
;this.setMeta(nodeId,"position",countInstances),this.setMeta(nodeId,"displayed",countInstances),DATA instanceof Array||!DATA.state||"closed"==DATA.state?DATA instanceof Array&&this.getMeta(nodeId,"displayed")<this.getMeta(nodeId,"count")&&nodes.push(this.getPaginateActionNodes()):this.getMeta(nodeId,"displayed")<this.getMeta(nodeId,"count")&&nodes.push(this.getPaginateActionNodes())}},setServerParameter:function(key,value,reload){this.serverParameters[key]=value,void 0!==reload&&reload&&(this.isRefreshing=!0,this.getTree().refresh())},getTree:function(){return $.tree.reference(this.selector)},getMeta:function(classId,metaName,value){
return this.metaClasses[classId][metaName]},setMeta:function(classId,metaName,value){this.metaClasses[classId][metaName]=value},getPaginateActionNodes:function(){return returnValue=[{data:__("all"),attributes:{class:"paginate paginate-all"}},{data:this.paginate+__(" next"),attributes:{class:"paginate paginate-more"}}],returnValue},showPaginate:function(NODE,TREE_OBJ){for(var DATA=this.getPaginateActionNodes(),i=0;i<DATA.length;i++)TREE_OBJ.create(DATA[i],TREE_OBJ.get_node(NODE[0]))},hidePaginate:function(NODE,TREE_OBJ){$(NODE).find(".paginate").each(function(){$(this).remove()})},refreshPaginate:function(NODE,TREE_OBJ){var nodeId=$(NODE)[0].id
;this.hidePaginate(NODE,TREE_OBJ),this.getMeta(nodeId,"displayed")<this.getMeta(nodeId,"count")&&this.showPaginate(NODE,TREE_OBJ)},getClassUri:function(NODE){var parents=$(NODE).parents("li");return 0==parents.length?$(NODE).prop("id"):$(parents[0]).prop("id")},callGetSectionActions:function(NODE,TREE_OBJ){null!=NODE&&($(NODE).hasClass("node-class")?$(NODE).prop("id"):($(NODE).prop("id"),this.getClassUri(NODE)))}})}),define("jquery.tree",["jquery"],function($){function tree_component(){return{cntr:++tree_component.cntr,settings:$.extend({},$.tree.defaults),init:function(elem,conf){var _this=this;if(this.container=$(elem),0==this.container.size)return!1;if((
tree_component.inst[this.cntr]=this).container.attr("id")||this.container.attr("id","jstree_"+this.cntr),tree_component.inst[this.container.attr("id")]=tree_component.inst[this.cntr],tree_component.focused=this.cntr,this.settings=$.extend(!0,{},this.settings,conf),this.settings.languages&&this.settings.languages.length){this.current_lang=this.settings.languages[0];for(var st=!1,id="#"+this.container.attr("id"),ln=0;ln<this.settings.languages.length;ln++)!1!==(st=tree_component.add_css(id+" ."+this.settings.languages[ln]))&&(st.style.display=this.settings.languages[ln]==this.current_lang?"":"none")}else this.current_lang=!1;this.container.addClass("tree"),
!1!==this.settings.ui.theme_name&&(!1===this.settings.ui.theme_path&&$("script").each(function(){if(this.src.toString().match(/jquery\.tree.*?js$/))return _this.settings.ui.theme_path=this.src.toString().replace(/jquery\.tree.*?js$/,"")+"themes/"+_this.settings.ui.theme_name+"/style.css",!1}),""!=this.settings.ui.theme_path&&-1==$.inArray(this.settings.ui.theme_path,tree_component.themes)&&(tree_component.add_sheet({url:this.settings.ui.theme_path}),tree_component.themes.push(this.settings.ui.theme_path)),this.container.addClass("tree-"+this.settings.ui.theme_name));var type_icons="";for(var t in this.settings.types)this.settings.types.hasOwnProperty(t
)&&this.settings.types[t].icon&&(this.settings.types[t].icon.image||this.settings.types[t].icon.position)&&(type_icons+="default"==t?"#"+this.container.attr("id")+" li > a ins { ":"#"+this.container.attr("id")+" li[rel="+t+"] > a ins { ",this.settings.types[t].icon.image&&(type_icons+=" background-image:url("+this.settings.types[t].icon.image+"); "),this.settings.types[t].icon.position&&(type_icons+=" background-position:"+this.settings.types[t].icon.position+"; "),type_icons+="} ");""!=type_icons&&tree_component.add_sheet({str:type_icons}),this.settings.rules.multiple&&(this.selected_arr=[]),this.offset=!1,this.hovered=!1,(this.locked=!1
)===tree_component.drag_drop.marker&&(tree_component.drag_drop.marker=$("<div>").attr({id:"jstree-marker"}).hide().appendTo("body")),this.callback("oninit",[this]),this.refresh(),this.attach_events(),this.focus()},refresh:function(obj){if(this.locked)return this.error("LOCKED");var _this=this;if(obj&&!this.settings.data.async&&(obj=!1),this.is_partial_refresh=!!obj,this.opened=Array(),0!=this.settings.opened?($.each(this.settings.opened,function(i,item){0<this.replace(/^#/,"").length&&_this.opened.push("#"+this.replace(/^#/,""))}),this.settings.opened=!1):this.container.find("li.open").each(function(i){this.id&&_this.opened.push("#"+this.id)}),this.selected
)this.settings.selected=Array(),obj?$(obj).find("li:has(a.clicked)").each(function(){this.id&&_this.settings.selected.push("#"+this.id)}):this.selected_arr?$.each(this.selected_arr,function(){this.attr("id")&&_this.settings.selected.push("#"+this.attr("id"))}):this.selected.attr("id")&&this.settings.selected.push("#"+this.selected.attr("id"));else if(!1!==this.settings.selected){var tmp=Array();"object"==(typeof this.settings.selected).toLowerCase()?$.each(this.settings.selected,function(){0<this.replace(/^#/,"").length&&tmp.push("#"+this.replace(/^#/,""))}):0<this.settings.selected.replace(/^#/,"").length&&tmp.push("#"+this.settings.selected.replace(/^#/,""
)),this.settings.selected=tmp}if(obj&&this.settings.data.async)return this.opened=Array(),(obj=this.get_node(obj)).find("li.open").each(function(i){_this.opened.push("#"+this.id)}),obj.hasClass("open")&&obj.removeClass("open").addClass("closed"),obj.hasClass("leaf")&&obj.removeClass("leaf"),obj.children("ul:eq(0)").html(""),this.open_branch(obj,!0,function(){_this.reselect.apply(_this)});_this=this;var _datastore=new $.tree.datastores[this.settings.data.type];0==this.container.children("ul").size()&&this.container.html("<ul class='ltr' style='direction:ltr;'><li class='last'><a class='loading' href='#'><ins>&nbsp;</ins>"+(
this.settings.lang.loading||"Loading ...")+"</a></li></ul>"),_datastore.load(this.callback("beforedata",[!1,this]),this,this.settings.data.opts,function(data){data=_this.callback("ondata",[data,_this]),_datastore.parse(data,_this,_this.settings.data.opts,function(str){str=_this.callback("onparse",[str,_this]),_this.container.empty().append($("<ul class='ltr'>").html(str)),_this.container.find("li:last-child").addClass("last").end().find("li:has(ul)").not(".open").addClass("closed"),_this.container.find("li").not(".open").not(".closed").addClass("leaf"),_this.reselect()})})},reselect:function(is_callback){var _this=this;if(
is_callback?this.cl_count--:this.cl_count=0,this.opened&&this.opened.length){for(var opn=!1,j=0;this.opened&&j<this.opened.length;j++){if(this.settings.data.async){if((tmp=this.get_node(this.opened[j])).size()&&0<tmp.hasClass("closed")){opn=!0;var tmp=this.opened[j].toString().replace("/","\\/");delete this.opened[j],this.open_branch(tmp,!0,function(){_this.reselect.apply(_this,[!0])}),this.cl_count++}}else this.open_branch(this.opened[j],!0)}if(this.settings.data.async&&opn)return;if(0<this.cl_count)return;delete this.opened}0<this.cl_count||(this.container.css("direction","ltr").children("ul:eq(0)").addClass("ltr"),
0==this.settings.ui.dots&&this.container.children("ul:eq(0)").addClass("no_dots"),this.scrtop&&(this.container.scrollTop(_this.scrtop),delete this.scrtop),!1!==this.settings.selected&&($.each(this.settings.selected,function(i){_this.is_partial_refresh?_this.select_branch($(_this.settings.selected[i].toString().replace("/","\\/"),_this.container),!1!==_this.settings.rules.multiple):_this.select_branch($(_this.settings.selected[i].toString().replace("/","\\/"),_this.container),!1!==_this.settings.rules.multiple&&0<i)}),this.settings.selected=!1),this.callback("onload",[_this]))},get:function(obj,format,opts){return format||(format=this.settings.data.type),
opts||(opts=this.settings.data.opts),(new $.tree.datastores[format]).get(obj,this,opts)},attach_events:function(){var _this=this;this.container.bind("mousedown.jstree",function(event){if(tree_component.drag_drop.isdown)return tree_component.drag_drop.move_type=!1,event.preventDefault(),event.stopPropagation(),event.stopImmediatePropagation(),!1}).bind("mouseup.jstree",function(event){setTimeout(function(){_this.focus.apply(_this)},5)}).bind("click.jstree",function(event){return!0}),$("li",this.container.get(0)).live("click",function(event){return"LI"!=event.target.tagName||(_this.off_height(),event.pageY-$(event.target).offset().top>_this.li_height||(
_this.toggle_branch.apply(_this,[event.target]),event.stopPropagation(),!1))}),$("a",this.container.get(0)).live("click",function(event){return!(!event.which||3!=event.which)||(_this.locked?(event.preventDefault(),event.target.blur(),_this.error("LOCKED")):(_this.select_branch.apply(_this,[event.target,event.ctrlKey||"on"==_this.settings.rules.multiple]),_this.inp&&_this.inp.blur(),event.preventDefault(),event.target.blur(),!1))}).live("dblclick",function(event){if(_this.locked)return event.preventDefault(),event.stopPropagation(),event.target.blur(),_this.error("LOCKED");_this.callback("ondblclk",[_this.get_node(event.target).get(0),_this]),
event.preventDefault(),event.stopPropagation(),event.target.blur()}).live("contextmenu",function(event){return _this.locked?(event.target.blur(),_this.error("LOCKED")):_this.callback("onrgtclk",[_this.get_node(event.target).get(0),_this,event])}).live("mouseover",function(event){if(_this.locked)return event.preventDefault(),event.stopPropagation(),_this.error("LOCKED");!1===_this.hovered||"A"!=event.target.tagName&&"INS"!=event.target.tagName||(_this.hovered.children("a").removeClass("hover"),_this.hovered=!1),_this.callback("onhover",[_this.get_node(event.target).get(0),_this])}).live("mousedown",function(event){if(
"left"==_this.settings.rules.drag_button&&event.which&&1!=event.which)return!0;if("right"==_this.settings.rules.drag_button&&event.which&&3!=event.which)return!0;if(_this.focus.apply(_this),_this.locked)return _this.error("LOCKED");var obj=_this.get_node(event.target);if(0!=_this.settings.rules.multiple&&1<_this.selected_arr.length&&obj.children("a:eq(0)").hasClass("clicked")){var counter=0;for(var i in _this.selected_arr)_this.selected_arr.hasOwnProperty(i)&&_this.check("draggable",_this.selected_arr[i])&&(_this.selected_arr[i].addClass("dragged"),tree_component.drag_drop.origin_tree=_this,counter++);if(0<counter){_this.check("draggable",obj
)?tree_component.drag_drop.drag_node=obj:tree_component.drag_drop.drag_node=_this.container.find("li.dragged:eq(0)"),tree_component.drag_drop.isdown=!0,tree_component.drag_drop.drag_help=$("<div id='jstree-dragged' class='tree "+(""!=_this.settings.ui.theme_name?" tree-"+_this.settings.ui.theme_name:"")+"' />").append("<ul class='"+_this.container.children("ul:eq(0)").get(0).className+"' />");var tmp=tree_component.drag_drop.drag_node.clone();0<_this.settings.languages.length&&tmp.find("a").not("."+_this.current_lang).hide(),tree_component.drag_drop.drag_help.children("ul:eq(0)").append(tmp),tree_component.drag_drop.drag_help.find("li:eq(0)").removeClass(
...
tmp),tree_component.drag_drop.drag_help.find("li:eq(0)").removeClass("last").addClass("last"),tree_component.drag_drop.isdown=!0,tree_component.drag_drop.foreign=!1,tree_component.drag_drop.origin_tree=_this,obj.addClass("dragged"),tree_component.drag_drop.dragged=_this.container.find("li.dragged")}return tree_component.drag_drop.init_x=event.pageX,tree_component.drag_drop.init_y=event.pageY,obj.blur(),event.preventDefault(),event.stopPropagation(),!1})},focus:function(){if(this.locked)return!1;tree_component.focused!=this.cntr&&(tree_component.focused=this.cntr,this.callback("onfocus",[this]))},off_height:function(){if(!1===this.offset){this.container.css({
position:"relative"}),this.offset=this.container.offset();var tmp=0;(tmp=parseInt($.curCSS(this.container.get(0),"paddingTop",!0),10))&&(this.offset.top+=tmp),(tmp=parseInt($.curCSS(this.container.get(0),"borderTopWidth",!0),10))&&(this.offset.top+=tmp),this.container.css({position:""})}if(!this.li_height){tmp=this.container.find("ul li.closed, ul li.leaf").eq(0);this.li_height=tmp.height(),tmp.children("ul:eq(0)").size()&&(this.li_height-=tmp.children("ul:eq(0)").height()),this.li_height||(this.li_height=18)}},scroll_check:function(x,y){var _this=this,cnt=_this.container,off=_this.container.offset(),st=cnt.scrollTop(),sl=cnt.scrollLeft(),h_cor=cnt.get(0
).scrollWidth>cnt.width()?40:20;y-off.top<20&&cnt.scrollTop(Math.max(st-_this.settings.ui.scroll_spd,0)),cnt.height()-(y-off.top)<h_cor&&cnt.scrollTop(st+_this.settings.ui.scroll_spd),x-off.left<20&&cnt.scrollLeft(Math.max(sl-_this.settings.ui.scroll_spd,0)),cnt.width()-(x-off.left)<40&&cnt.scrollLeft(sl+_this.settings.ui.scroll_spd),cnt.scrollLeft()==sl&&cnt.scrollTop()==st||(tree_component.drag_drop.move_type=!1,tree_component.drag_drop.ref_node=!1,tree_component.drag_drop.marker.hide()),tree_component.drag_drop.scroll_time=setTimeout(function(){_this.scroll_check(x,y)},50)},scroll_into_view:function(obj){if(!(obj=obj?this.get_node(obj):this.selected)
)return!1;var off_t=obj.offset().top,beg_t=this.container.offset().top,end_t=beg_t+this.container.height(),h_cor=this.container.get(0).scrollWidth>this.container.width()?40:20;off_t+5<beg_t&&this.container.scrollTop(this.container.scrollTop()-(beg_t-off_t+5)),end_t<off_t+h_cor&&this.container.scrollTop(this.container.scrollTop()+(off_t+h_cor-end_t))},get_node:function(obj){return $(obj).closest("li")},get_type:function(obj){if(obj=obj?this.get_node(obj):this.selected)return obj.attr(this.settings.rules.type_attr)||"default"},set_type:function(str,obj){(obj=obj?this.get_node(obj):this.selected)&&str&&obj.attr(this.settings.rules.type_attr,str)},
get_text:function(obj,lang){if(!(obj=this.get_node(obj))||0==obj.size())return"";obj=this.settings.languages&&this.settings.languages.length?(lang=lang||this.current_lang,obj.children("a."+lang)):obj.children("a:visible");var val="";return obj.contents().each(function(){if(3==this.nodeType)return val=this.data,!1}),val},check:function(rule,obj){if(this.locked)return!1;var v=!1;if(-1===obj)void 0!==this.settings.rules[rule]&&(v=this.settings.rules[rule]);else{if(!(obj=obj?this.get_node(obj):this.selected))return;var t=this.get_type(obj)
;void 0!==this.settings.types[t]&&void 0!==this.settings.types[t][rule]?v=this.settings.types[t][rule]:void 0!==this.settings.types.default&&void 0!==this.settings.types.default[rule]&&(v=this.settings.types.default[rule])}return"function"==typeof v&&(v=v.call(null,obj,this)),v=this.callback("check",[rule,obj,v,this])},check_move:function(nod,ref_node,how){if(this.locked)return!1;if($(ref_node).closest("li.dragged").size())return!1;var tree1=nod.parents(".tree:eq(0)").get(0),tree2=ref_node.parents(".tree:eq(0)").get(0);if(tree1&&tree1!=tree2&&("none"==(m=$.tree.reference(tree2.id).settings.rules.multitree)||$.isArray(m)&&-1==$.inArray(tree1.id,m)))return!1
;var p="inside"!=how?this.parent(ref_node):this.get_node(ref_node);if(nod=this.get_node(nod),0==p)return!1;var r={max_depth:this.settings.rules.use_max_depth?this.check("max_depth",p):-1,max_children:this.settings.rules.use_max_children?this.check("max_children",p):-1,valid_children:this.check("valid_children",p)},nod_type="string"==typeof nod?nod:this.get_type(nod);if(void 0!==r.valid_children&&("none"==r.valid_children||"object"==typeof r.valid_children&&-1==$.inArray(nod_type,$.makeArray(r.valid_children))))return!1;if(this.settings.rules.use_max_children&&void 0!==r.max_children&&-1!=r.max_children){if(0==r.max_children)return!1;var c_count=1;if(
...
"li:eq(0)")),root||0!=ref_node.size()||(root=!0,ref_node=this.container),!root){if(!this.check("creatable",ref_node))return this.error("CREATE: CANNOT CREATE IN NODE");ref_node.hasClass("closed")&&this.open_branch(ref_node,!0)}var torename=!1;if((obj=obj?$.extend(!0,{},obj):{}).attributes||(obj.attributes={}),obj.attributes[this.settings.rules.type_attr]||(obj.attributes[this.settings.rules.type_attr]=this.get_type(tmp)||"default"),this.settings.languages.length){obj.data||(obj.data={},torename=!0);for(var i=0;i<this.settings.languages.length;i++)obj.data[this.settings.languages[i]]||(obj.data[this.settings.languages[i]]="string"!=(
typeof this.settings.lang.new_node).toLowerCase()&&this.settings.lang.new_node[i]?this.settings.lang.new_node[i]:this.settings.lang.new_node)}else obj.data||(obj.data=this.settings.lang.new_node,torename=!0);obj=this.callback("ondata",[obj,this]);var obj_s=$.tree.datastores.json().parse(obj,this);obj_s=this.callback("onparse",[obj_s,this]);var $li=$(obj_s);$li.children("ul").size()?$li.is(".open")||$li.addClass("closed"):$li.addClass("leaf"),$li.find("li:last-child").addClass("last").end().find("li:has(ul)").not(".open").addClass("closed"),$li.find("li").not(".open").not(".closed").addClass("leaf");var r={
...
position="top"==this.settings.rules.createat?0:ref_node.children("ul:eq(0)").children("li").size()),0==ref_node.children("ul").size()||1==root&&0==ref_node.children("ul").children("li").size())if(root)a=this.moved($li,this.container.children("ul:eq(0)"),"inside",!0);else var a=this.moved($li,ref_node.children("a:eq(0)"),"inside",!0);else if("before"==pos&&ref_node.children("ul:eq(0)").children("li:nth-child("+(position+1)+")").size())a=this.moved($li,ref_node.children("ul:eq(0)").children("li:nth-child("+(position+1)+")").children("a:eq(0)"),"before",!0);else if("after"==pos&&ref_node.children("ul:eq(0)").children("li:nth-child("+position+")").size()
)a=this.moved($li,ref_node.children("ul:eq(0)").children("li:nth-child("+position+")").children("a:eq(0)"),"after",!0);else if(ref_node.children("ul:eq(0)").children("li:nth-child("+(position+1)+")").size())a=this.moved($li,ref_node.children("ul:eq(0)").children("li:nth-child("+(position+1)+")").children("a:eq(0)"),"before",!0);else a=this.moved($li,ref_node.children("ul:eq(0)").children("li:last").children("a:eq(0)"),"after",!0);return!1===a?this.error("CREATE: ABORTED"):(torename&&(this.select_branch($li.children("a:eq(0)")),this.rename()),$li)},rename:function(obj,new_name){if(this.locked)return this.error("LOCKED");obj=obj?this.get_node(obj
):this.selected;var _this=this;if(!obj||!obj.size())return this.error("RENAME: NO NODE SELECTED");if(!this.check("renameable",obj))return this.error("RENAME: NODE NOT RENAMABLE");if(!this.callback("beforerename",[obj.get(0),_this.current_lang,_this]))return this.error("RENAME: STOPPED BY USER");obj.parents("li.closed").each(function(){_this.open_branch(this)}),obj=this.current_lang?obj.find("a."+this.current_lang):obj.find("a:first");var rb={};rb[this.container.attr("id")]=this.get_rollback();var icn=obj.children("ins").clone();if("string"==(typeof new_name).toLowerCase())obj.text(new_name).prepend(icn),_this.callback("onrename",[_this.get_node(obj).get(0),
_this,rb]);else{var last_value="";obj.contents().each(function(){if(3==this.nodeType)return last_value=this.data,!1}),_this.inp=$("<input type='text' autocomplete='off' />"),_this.inp.val(last_value.replace(/&amp;/g,"&").replace(/&gt;/g,">").replace(/&lt;/g,"<")).bind("mousedown",function(event){event.stopPropagation()}).bind("mouseup",function(event){event.stopPropagation()}).bind("click",function(event){event.stopPropagation()}).bind("keyup",function(event){var key=event.keyCode||event.which;if(27==key)return this.value=last_value,void this.blur();13!=key||this.blur()}),_this.inp.blur(function(event){""==this.value&&(this.value=last_value),obj.text(
this.value).prepend(icn),obj.get(0).style.display="",obj.prevAll("span").remove(),_this.inp=!1,_this.callback("onrename",[_this.get_node(obj).get(0),_this,rb])});var spn=$("<span />").addClass(obj.attr("class")).append(icn).append(_this.inp);obj.get(0).style.display="none",obj.parent().prepend(spn),_this.inp.get(0).focus(),_this.inp.get(0).select()}},remove:function(obj){if(this.locked)return this.error("LOCKED");var _this=this,rb={};if(rb[this.container.attr("id")]=this.get_rollback(),!obj||this.selected&&this.get_node(obj).get(0)==this.selected.get(0)){if(!this.selected)return this.error("DELETE: NO NODE SELECTED");if(!this.check("deletable",this.selected)
)return this.error("DELETE: NODE NOT DELETABLE");if(!this.callback("beforedelete",[this.selected.get(0),_this]))return this.error("DELETE: STOPPED BY USER");$parent=this.selected.parent();obj=this.selected;if(0==this.settings.rules.multiple||1==this.selected_arr.length)var stop=!0,tmp="select_previous"==this.settings.ui.selected_delete&&this.prev(this.selected);if(obj=obj.remove(),$parent.children("li:last").addClass("last"),0==$parent.children("li").size()&&($li=$parent.parents("li:eq(0)"),$li.removeClass("open").removeClass("closed").addClass("leaf").children("ul").remove()),!stop&&0!=this.settings.rules.multiple){_this=this;this.selected_arr=[],
this.container.find("a.clicked").filter(":first-child").parent().each(function(){_this.selected_arr.push($(this))}),0<this.selected_arr.length&&(this.selected=this.selected_arr[0],this.remove())}stop&&tmp&&this.select_branch(tmp),this.callback("ondelete",[obj.get(0),this,rb])}else if((obj=this.get_node(obj)).size()){if(!this.check("deletable",obj))return this.error("DELETE: NODE NOT DELETABLE");if(!this.callback("beforedelete",[obj.get(0),_this]))return this.error("DELETE: STOPPED BY USER");if($parent=obj.parent(),obj.find("a.clicked").size()){var reset_selected=!1;_this.selected_arr=[],this.container.find("a.clicked").filter(":first-child").parent().each(
function(){if(reset_selected||this!=_this.selected.get(0)||(reset_selected=!0),-1!=$(this).parents().index(obj))return!0;_this.selected_arr.push($(this))}),reset_selected&&(this.selected=this.selected_arr[0]||!1)}obj=obj.remove(),$parent.children("li:last").addClass("last"),0==$parent.children("li").size()&&($li=$parent.parents("li:eq(0)"),$li.removeClass("open").removeClass("closed").addClass("leaf").children("ul").remove()),this.callback("ondelete",[obj.get(0),this,rb])}},next:function(obj,strict){return!!(obj=this.get_node(obj)).size()&&(strict?0<obj.nextAll("li").size()&&obj.nextAll("li:eq(0)"):obj.hasClass("open")?obj.find("li:eq(0)"):0<obj.nextAll("li"
).size()?obj.nextAll("li:eq(0)"):obj.parents("li").next("li").eq(0))},prev:function(obj,strict){if(!(obj=this.get_node(obj)).size())return!1;if(strict)return 0<obj.prevAll("li").size()&&obj.prevAll("li:eq(0)");if(obj.prev("li").size()){for(obj=obj.prev("li").eq(0);obj.hasClass("open");)obj=obj.children("ul:eq(0)").children("li:last");return obj}return!!obj.parents("li:eq(0)").size()&&obj.parents("li:eq(0)")},parent:function(obj){return!!(obj=this.get_node(obj)).size()&&(obj.parents("li:eq(0)").size()?obj.parents("li:eq(0)"):-1)},children:function(obj){return-1===obj?this.container.children("ul:eq(0)").children("li"):!!(obj=this.get_node(obj)).size(
)&&obj.children("ul:eq(0)").children("li")},toggle_dots:function(){this.settings.ui.dots?(this.settings.ui.dots=!1,this.container.children("ul:eq(0)").addClass("no_dots")):(this.settings.ui.dots=!0,this.container.children("ul:eq(0)").removeClass("no_dots"))},callback:function(cb,args){var p=!1,r=null;for(var i in this.settings.plugins)if("object"==typeof $.tree.plugins[i]&&((p=$.tree.plugins[i]).callbacks&&"function"==typeof p.callbacks[cb]&&(r=p.callbacks[cb].apply(this,args)),null!=r)){if("ondata"!=cb&&"onparse"!=cb)return r;args[0]=r}if("function"==typeof(p=this.settings.callback[cb]))return p.apply(null,args)},get_rollback:function(){var rb={}
;return rb.html=this.container.html(),rb.selected=!!this.selected&&this.selected.attr("id"),rb},moved:function(what,where,how,is_new,is_copy,rb){what=$(what);var $parent=$(what).parents("ul:eq(0)"),$where=$(where);($where.is("ins")&&($where=$where.parent()),rb)||((rb={})[this.container.attr("id")]=this.get_rollback(),is_new||((tmp=1<what.size()?what.eq(0).parents(".tree:eq(0)"):what.parents(".tree:eq(0)")).get(0)!=this.container.get(0)&&(tmp=tree_component.inst[tmp.attr("id")],rb[tmp.container.attr("id")]=tmp.get_rollback()),delete tmp));if("inside"==how&&this.settings.data.async){var _this=this;if(this.get_node($where).hasClass("closed")
)return this.open_branch(this.get_node($where),!0,function(){_this.moved.apply(_this,[what,where,how,is_new,is_copy,rb])});if(1==this.get_node($where).find("> ul > li > a.loading").size())return void setTimeout(function(){_this.moved.apply(_this,[what,where,how,is_new,is_copy])},200)}if(1<what.size()){_this=this;var tmp=this.moved(what.eq(0),where,how,!1,is_copy,rb);return what.each(function(i){0!=i&&tmp&&(tmp=_this.moved(this,tmp.children("a:eq(0)"),"after",!1,is_copy,rb))}),what}if(is_copy?(_what=what.clone(),_what.each(function(i){this.id=this.id+"_copy",$(this).find("li").each(function(){this.id=this.id+"_copy"}),$(this).removeClass("dragged").find(
...
var j in tmp.settings.languages)tmp.settings.languages.hasOwnProperty(j)&&this.settings.languages[i]==tmp.settings.languages[j]&&res.push("."+this.settings.languages[i]);if(0==res.length)return this.error("MOVE: NO COMMON LANGUAGES");_what.find("a").not(res.join(",")).remove()}_what.find("a.clicked").removeClass("clicked")}switch(what=_what,how){case"before":$where.parents("ul:eq(0)").children("li.last").removeClass("last"),$where.parent().before(what.removeClass("last")),$where.parents("ul:eq(0)").children("li:last").addClass("last");break;case"after":$where.parents("ul:eq(0)").children("li.last").removeClass("last"),$where.parent().after(what.removeClass(
"last")),$where.parents("ul:eq(0)").children("li:last").addClass("last");break;case"inside":var tmp_node;if($where.parent().children("ul:first").size())if("top"==this.settings.rules.createat)$where.parent().children("ul:first").prepend(what.removeClass("last")).children("li:last").addClass("last"),(tmp_node=$where.parent().children("ul:first").children("li:first")).size()&&(how="before",where=tmp_node);else(tmp_node=$where.parent().children("ul:first").children(".last")).size()&&(how="after",where=tmp_node),$where.parent().children("ul:first").children(".last").removeClass("last").end().append(what.removeClass("last")).children("li:last").addClass("last"
);else what.addClass("last"),$where.parent().removeClass("leaf").append("<ul/>"),$where.parent().hasClass("open")||$where.parent().addClass("closed"),$where.parent().children("ul:first").prepend(what);$where.parent().hasClass("closed")&&this.open_branch($where)}if(0==$parent.find("li").size()){var $li=$parent.parent();$li.removeClass("open").removeClass("closed").addClass("leaf"),$li.is(".tree")||$li.children("ul").remove(),$li.parents("ul:eq(0)").children("li.last").removeClass("last").end().children("li:last").addClass("last")}else $parent.children("li.last").removeClass("last"),$parent.children("li:last").addClass("last");return is_copy?this.callback(
"oncopy",[this.get_node(what).get(0),this.get_node(where).get(0),how,this,rb]):is_new?this.callback("oncreate",[this.get_node(what).get(0),$where.is("ul")?-1:this.get_node(where).get(0),how,this,rb]):this.callback("onmove",[this.get_node(what).get(0),this.get_node(where).get(0),how,this,rb]),what},error:function(code){return this.callback("error",[code,this]),!1},lock:function(state){this.locked=state,this.locked?this.container.children("ul:eq(0)").addClass("locked"):this.container.children("ul:eq(0)").removeClass("locked")},cut:function(obj){return this.locked?this.error("LOCKED"):(obj=obj?this.get_node(obj):this.container.find("a.clicked").filter(
":first-child").parent())&&obj.size()?(tree_component.cut_copy.copy_nodes=!1,void(tree_component.cut_copy.cut_nodes=obj)):this.error("CUT: NO NODE SELECTED")},copy:function(obj){return this.locked?this.error("LOCKED"):(obj=obj?this.get_node(obj):this.container.find("a.clicked").filter(":first-child").parent())&&obj.size()?(tree_component.cut_copy.copy_nodes=obj,void(tree_component.cut_copy.cut_nodes=!1)):this.error("COPY: NO NODE SELECTED")},paste:function(obj,position){if(this.locked)return this.error("LOCKED");var root=!1;if(obj=-1==obj?(root=!0,this.container):obj?this.get_node(obj):this.selected,!(root||obj&&obj.size()))return this.error(
"PASTE: NO NODE SELECTED");if(!tree_component.cut_copy.copy_nodes&&!tree_component.cut_copy.cut_nodes)return this.error("PASTE: NOTHING TO DO");var pos=position;if("before"==position?(position=obj.parent().children().index(obj),obj=obj.parents("li:eq(0)")):"after"==position?(position=obj.parent().children().index(obj)+1,obj=obj.parents("li:eq(0)")):"undefined"!=(typeof position).toLowerCase()&&"inside"!=position||(position="top"==this.settings.rules.createat?0:obj.children("ul:eq(0)").children("li").size()),root||0!=obj.size()||(root=!0,obj=this.container),tree_component.cut_copy.copy_nodes&&tree_component.cut_copy.copy_nodes.size()){var ok=!0;if(
!root&&!this.check_move(tree_component.cut_copy.copy_nodes,obj.children("a:eq(0)"),"inside"))return!1;if(0==obj.children("ul").size()||1==root&&0==obj.children("ul").children("li").size())if(root)this.moved(tree_component.cut_copy.copy_nodes,this.container.children("ul:eq(0)"),"inside",!1,!0);else this.moved(tree_component.cut_copy.copy_nodes,obj.children("a:eq(0)"),"inside",!1,!0);else if("before"==pos&&obj.children("ul:eq(0)").children("li:nth-child("+(position+1)+")").size())this.moved(tree_component.cut_copy.copy_nodes,obj.children("ul:eq(0)").children("li:nth-child("+(position+1)+")").children("a:eq(0)"),"before",!1,!0);else if(
"after"==pos&&obj.children("ul:eq(0)").children("li:nth-child("+position+")").size())this.moved(tree_component.cut_copy.copy_nodes,obj.children("ul:eq(0)").children("li:nth-child("+position+")").children("a:eq(0)"),"after",!1,!0);else if(obj.children("ul:eq(0)").children("li:nth-child("+(position+1)+")").size())this.moved(tree_component.cut_copy.copy_nodes,obj.children("ul:eq(0)").children("li:nth-child("+(position+1)+")").children("a:eq(0)"),"before",!1,!0);else this.moved(tree_component.cut_copy.copy_nodes,obj.children("ul:eq(0)").children("li:last").children("a:eq(0)"),"after",!1,!0);tree_component.cut_copy.copy_nodes=!1}if(
tree_component.cut_copy.cut_nodes&&tree_component.cut_copy.cut_nodes.size()){ok=!0;if(obj.parents().andSelf().each(function(){if(-1!=tree_component.cut_copy.cut_nodes.index(this))return ok=!1}),!ok)return this.error("Invalid paste");if(!root&&!this.check_move(tree_component.cut_copy.cut_nodes,obj.children("a:eq(0)"),"inside"))return!1;if(0==obj.children("ul").size()||1==root&&0==obj.children("ul").children("li").size())if(root)this.moved(tree_component.cut_copy.cut_nodes,this.container.children("ul:eq(0)"),"inside");else this.moved(tree_component.cut_copy.cut_nodes,obj.children("a:eq(0)"),"inside");else if("before"==pos&&obj.children("ul:eq(0)").children(
"li:nth-child("+(position+1)+")").size())this.moved(tree_component.cut_copy.cut_nodes,obj.children("ul:eq(0)").children("li:nth-child("+(position+1)+")").children("a:eq(0)"),"before");else if("after"==pos&&obj.children("ul:eq(0)").children("li:nth-child("+position+")").size())this.moved(tree_component.cut_copy.cut_nodes,obj.children("ul:eq(0)").children("li:nth-child("+position+")").children("a:eq(0)"),"after");else if(obj.children("ul:eq(0)").children("li:nth-child("+(position+1)+")").size())this.moved(tree_component.cut_copy.cut_nodes,obj.children("ul:eq(0)").children("li:nth-child("+(position+1)+")").children("a:eq(0)"),"before");else this.moved(
tree_component.cut_copy.cut_nodes,obj.children("ul:eq(0)").children("li:last").children("a:eq(0)"),"after");tree_component.cut_copy.cut_nodes=!1}},search:function(str,func){var _this=this;if((!str||this.srch&&str!=this.srch)&&(this.srch="",this.srch_opn=!1,this.container.find("a.search").removeClass("search")),this.srch=str)if(func||(func="contains"),this.settings.data.async)if(this.srch_opn)if(this.srch_opn.length){if(this.srch_opn&&this.srch_opn.length){for(var opn=!1,j=0;j<this.srch_opn.length;j++)if(0<this.get_node("#"+this.srch_opn[j]).size()){opn=!0;var tmp="#"+this.srch_opn[j];delete this.srch_opn[j],this.open_branch(tmp,!0,function(){
_this.search.apply(_this,[str,func])})}opn||(this.srch_opn=[],_this.search.apply(_this,[str,func]))}}else{this.srch_opn=!1;var selector="a";this.settings.languages.length&&(selector+="."+this.current_lang),this.callback("onsearch",[this.container.find(selector+":"+func+"('"+str+"')"),this])}else{var dd=$.extend({search:str},this.callback("beforedata",[!1,this]));$.ajax({type:this.settings.data.opts.method,url:this.settings.data.opts.url,data:dd,dataType:"text",success:function(data){_this.srch_opn=$.unique(data.split(",")),_this.search.apply(_this,[str,func])}})}else{selector="a";this.settings.languages.length&&(selector+="."+this.current_lang)
;var nn=this.container.find(selector+":"+func+"('"+str+"')");nn.parents("li.closed").each(function(){_this.open_branch(this,!0)}),this.callback("onsearch",[nn,this])}},add_sheet:tree_component.add_sheet,destroy:function(){if(this.callback("ondestroy",[this]),this.container.unbind(".jstree"),$("#"+this.container.attr("id")).die("click.jstree").die("dblclick.jstree").die("mouseover.jstree").die("mouseout.jstree").die("mousedown.jstree"),this.container.removeClass("tree ui-widget ui-widget-content tree-default tree-"+this.settings.ui.theme_name).children("ul").removeClass("no_dots ltr locked").find("li").removeClass("leaf").removeClass("open").removeClass(
"closed").removeClass("last").children("a").removeClass("clicked hover search"),this.cntr==tree_component.focused)for(var i in tree_component.inst)if(i!=this.cntr&&i!=this.container.attr("id")){tree_component.inst[i].focus();break}tree_component.inst[this.cntr]=!1,tree_component.inst[this.container.attr("id")]=!1,delete tree_component.inst[this.cntr],delete tree_component.inst[this.container.attr("id")],tree_component.cntr--}}}$.tree={datastores:{},plugins:{},defaults:{data:{async:!1,type:"html",opts:{method:"GET",url:!1}},selected:!1,opened:[],languages:[],ui:{dots:!0,animation:0,scroll_spd:4,theme_path:!1,theme_name:"default",
selected_parent_close:"select_parent",selected_delete:"select_previous"},types:{default:{clickable:!0,renameable:!0,deletable:!0,creatable:!0,draggable:!0,max_children:-1,max_depth:-1,valid_children:"all",icon:{image:!1,position:!1}}},rules:{multiple:!1,multitree:"none",type_attr:"rel",createat:"bottom",drag_copy:"ctrl",drag_button:"left",use_max_children:!0,use_max_depth:!0,max_children:-1,max_depth:-1,valid_children:"all"},lang:{new_node:"New folder",loading:"Loading ..."},callback:{beforechange:function(NODE,TREE_OBJ){return!0},beforeopen:function(NODE,TREE_OBJ){return!0},beforeclose:function(NODE,TREE_OBJ){return!0},beforemove:function(NODE,REF_NODE,TYPE
,TREE_OBJ){return!0},beforecreate:function(NODE,REF_NODE,TYPE,TREE_OBJ){return!0},beforerename:function(NODE,LANG,TREE_OBJ){return!0},beforedelete:function(NODE,TREE_OBJ){return!0},beforedata:function(NODE,TREE_OBJ){return{id:$(NODE).attr("id")||0}},ondata:function(DATA,TREE_OBJ){return DATA},onparse:function(STR,TREE_OBJ){return STR},onhover:function(NODE,TREE_OBJ){},onselect:function(NODE,TREE_OBJ){},ondeselect:function(NODE,TREE_OBJ){},onchange:function(NODE,TREE_OBJ){},onrename:function(NODE,TREE_OBJ,RB){},onmove:function(NODE,REF_NODE,TYPE,TREE_OBJ,RB){},oncopy:function(NODE,REF_NODE,TYPE,TREE_OBJ,RB){},oncreate:function(NODE,REF_NODE,TYPE,TREE_OBJ,RB
){},ondelete:function(NODE,TREE_OBJ,RB){},onopen:function(NODE,TREE_OBJ){},onopen_all:function(TREE_OBJ){},onclose_all:function(TREE_OBJ){},onclose:function(NODE,TREE_OBJ){},error:function(TEXT,TREE_OBJ){},ondblclk:function(NODE,TREE_OBJ){TREE_OBJ.toggle_branch.call(TREE_OBJ,NODE),TREE_OBJ.select_branch.call(TREE_OBJ,NODE)},onrgtclk:function(NODE,TREE_OBJ,EV){},onload:function(TREE_OBJ){},oninit:function(TREE_OBJ){},onfocus:function(TREE_OBJ){},ondestroy:function(TREE_OBJ){},onsearch:function(NODES,TREE_OBJ){NODES.addClass("search")},ondrop:function(NODE,REF_NODE,TYPE,TREE_OBJ){},check:function(RULE,NODE,VALUE,TREE_OBJ){return VALUE},check_move:function(NODE
,REF_NODE,TYPE,TREE_OBJ){return!0}},plugins:{}},create:function(){return new tree_component},focused:function(){return tree_component.inst[tree_component.focused]},reference:function(obj){var o=$(obj);return o.size()||(o=$("#"+obj)),o.size()?(o=o.is(".tree")?o.attr("id"):o.parents(".tree:eq(0)").attr("id"),tree_component.inst[o]||null):null},rollback:function(data){for(var i in data)if(data.hasOwnProperty(i)){var tmp=tree_component.inst[i],lock=!tmp.locked;lock&&tmp.lock(!0),tmp.inp=!1,tmp.container.html(data[i].html).find(".dragged").removeClass("dragged").end().find(".hover").removeClass("hover"),data[i].selected&&(tmp.selected=$("#"+data[i].selected),
tmp.selected_arr=[],tmp.container.find("a.clicked").each(function(){tmp.selected_arr.push(tmp.get_node(this))})),lock&&tmp.lock(!1),delete lock,delete tmp}},drop_mode:function(opts){opts=$.extend(opts,{show:!1,type:"default",str:"Foreign node"}),tree_component.drag_drop.foreign=!0,tree_component.drag_drop.isdown=!0,tree_component.drag_drop.moving=!0,tree_component.drag_drop.appended=!1,tree_component.drag_drop.f_type=opts.type,(tree_component.drag_drop.f_data=opts).show?(tree_component.drag_drop.drag_help=$("<div id='jstree-dragged' class='tree tree-default'><ul><li class='last dragged foreign'><a href='#'><ins>&nbsp;</ins>"+opts.str+"</a></li></ul></div>"),
tree_component.drag_drop.drag_node=tree_component.drag_drop.drag_help.find("li:eq(0)")):(tree_component.drag_drop.drag_help=!1,tree_component.drag_drop.drag_node=!1),!1!==$.tree.drag_start&&$.tree.drag_start.call(null,!1)},drag_start:!1,drag:!1,drag_end:!1},$.fn.tree=function(opts){return this.each(function(){var conf=$.extend({},opts);tree_component.inst&&tree_component.inst[$(this).attr("id")]&&tree_component.inst[$(this).attr("id")].destroy(),!1!==conf&&(new tree_component).init(this,conf)})},tree_component.cntr=0,tree_component.inst={},tree_component.themes=[],tree_component.drag_drop={isdown:!1,drag_node:!1,drag_help:!1,dragged:!1,init_x:!1,init_y:!1,
moving:!1,origin_tree:!1,marker:!1,move_type:!1,ref_node:!1,appended:!1,foreign:!1,droppable:[],open_time:!1,scroll_time:!1},tree_component.mouseup=function(event){var tmp=tree_component.drag_drop;if(tmp.open_time&&clearTimeout(tmp.open_time),tmp.scroll_time&&clearTimeout(tmp.scroll_time),tmp.moving&&!1!==$.tree.drag_end&&$.tree.drag_end.call(null,event,tmp),!1===tmp.foreign&&tmp.drag_node&&tmp.drag_node.size()){if(tmp.drag_help.remove(),tmp.move_type)(tree1=tree_component.inst[tmp.ref_node.parents(".tree:eq(0)").attr("id")])&&tree1.moved(tmp.dragged,tmp.ref_node,tmp.move_type,!1,
"on"==tmp.origin_tree.settings.rules.drag_copy||"ctrl"==tmp.origin_tree.settings.rules.drag_copy&&event.ctrlKey);tmp.move_type=!1,tmp.ref_node=!1}if(!1!==tmp.foreign){var tree1;if(tmp.drag_help&&tmp.drag_help.remove(),tmp.move_type)(tree1=tree_component.inst[tmp.ref_node.parents(".tree:eq(0)").attr("id")])&&tree1.callback("ondrop",[tmp.f_data,tree1.get_node(tmp.ref_node).get(0),tmp.move_type,tree1]);tmp.foreign=!1,tmp.move_type=!1,tmp.ref_node=!1}if(tree_component.drag_drop.marker&&tree_component.drag_drop.marker.hide(),tmp.dragged&&tmp.dragged.size()&&tmp.dragged.removeClass("dragged"),tmp.dragged=!1,tmp.drag_help=!1,tmp.drag_node=!1,tmp.f_type=!1,
tmp.f_data=!1,tmp.init_x=!1,tmp.init_y=!1,tmp.moving=!1,tmp.appended=!1,tmp.origin_tree=!1,tmp.isdown)return tmp.isdown=!1,event.preventDefault(),event.stopPropagation(),!1},tree_component.mousemove=function(event){var tmp=tree_component.drag_drop,is_start=!1;if(tmp.isdown){if(!tmp.moving&&Math.abs(tmp.init_x-event.pageX)<5&&Math.abs(tmp.init_y-event.pageY)<5)return event.preventDefault(),event.stopPropagation(),!1;if(tmp.moving||(is_start=tree_component.drag_drop.moving=!0),tmp.open_time&&clearTimeout(tmp.open_time),!1!==tmp.drag_help&&(tmp.appended||(!1!==tmp.foreign&&(tmp.origin_tree=$.tree.focused()),$("body").append(tmp.drag_help),
tmp.w=tmp.drag_help.width(),tmp.appended=!0),tmp.drag_help.css({left:event.pageX+5,top:event.pageY+15})),is_start&&!1!==$.tree.drag_start&&$.tree.drag_start.call(null,event,tmp),!1!==$.tree.drag&&$.tree.drag.call(null,event,tmp),"DIV"==event.target.tagName&&"jstree-marker"==event.target.id)return!1;var et=$(event.target);et.is("ins")&&(et=et.parent());var cnt=et.is(".tree")?et:et.parents(".tree:eq(0)");if(0==cnt.size()||!tree_component.inst[cnt.attr("id")])return tmp.scroll_time&&clearTimeout(tmp.scroll_time),!1!==tmp.drag_help&&tmp.drag_help.find("li:eq(0) ins").addClass("forbidden"),tmp.move_type=!1,tmp.ref_node=!1,tree_component.drag_drop.marker.hide(),!1
;var tree2=tree_component.inst[cnt.attr("id")];tree2.off_height(),tmp.scroll_time&&clearTimeout(tmp.scroll_time),tmp.scroll_time=setTimeout(function(){tree2.scroll_check(event.pageX,event.pageY)},50);var mov=!1;cnt.scrollTop();if("A"==event.target.tagName||"INS"==event.target.tagName){if(et.is("#jstree-dragged"))return!1;tree2.get_node(event.target).hasClass("closed")&&(tmp.open_time=setTimeout(function(){tree2.open_branch(et)},500));var goTo={x:(et_off=et.offset()).left-1,y:event.pageY-et_off.top},arr=[];arr=goTo.y<tree2.li_height/3+1?["before","inside","after"]:goTo.y>2*tree2.li_height/3-1?["after","inside","before"]:goTo.y<tree2.li_height/2?["inside",
"before","after"]:["inside","after","before"];var ok=!1,nn=0==tmp.foreign?tmp.origin_tree.container.find("li.dragged"):tmp.f_type;if($.each(arr,function(i,val){if(tree2.check_move(nn,et,val))return mov=val,!(ok=!0)}),ok){switch(mov){case"before":goTo.y=et_off.top-2,tree_component.drag_drop.marker.attr("class","marker");break;case"after":goTo.y=et_off.top-2+tree2.li_height,tree_component.drag_drop.marker.attr("class","marker");break;case"inside":goTo.x-=2,goTo.y=et_off.top-2+tree2.li_height/2,tree_component.drag_drop.marker.attr("class","marker_plus")}tmp.move_type=mov,tmp.ref_node=$(event.target),!1!==tmp.drag_help&&tmp.drag_help.find(".forbidden"
).removeClass("forbidden"),tree_component.drag_drop.marker.css({left:goTo.x,top:goTo.y}).show()}}if((et.is(".tree")||et.is("ul"))&&0==et.find("li:eq(0)").size()){var et_off=et.offset();tmp.move_type="inside",tmp.ref_node=cnt.children("ul:eq(0)"),!1!==tmp.drag_help&&tmp.drag_help.find(".forbidden").removeClass("forbidden"),tree_component.drag_drop.marker.attr("class","marker_plus"),tree_component.drag_drop.marker.css({left:et_off.left+10,top:et_off.top+15}).show()}else("A"!=event.target.tagName&&"INS"!=event.target.tagName||!ok)&&(!1!==tmp.drag_help&&tmp.drag_help.find("li:eq(0) ins").addClass("forbidden"),tmp.move_type=!1,tmp.ref_node=!1,
tree_component.drag_drop.marker.hide());return event.preventDefault(),event.stopPropagation(),!1}return!0},$(function(){$(document).bind("mousemove.jstree",tree_component.mousemove),$(document).bind("mouseup.jstree",tree_component.mouseup)}),tree_component.cut_copy={copy_nodes:!1,cut_nodes:!1},tree_component.css=!1,tree_component.get_css=function(rule_name,delete_flag){rule_name=rule_name.toLowerCase();var css_rules=tree_component.css.cssRules||tree_component.css.rules,j=0;do{if(css_rules.length&&j>css_rules.length+5)return!1;if(css_rules[j].selectorText&&css_rules[j].selectorText.toLowerCase()==rule_name)return 1==delete_flag?(
tree_component.css.removeRule&&document.styleSheets[i].removeRule(j),tree_component.css.deleteRule&&document.styleSheets[i].deleteRule(j),!0):css_rules[j]}while(css_rules[++j]);return!1},tree_component.add_css=function(rule_name){return!tree_component.get_css(rule_name)&&(tree_component.css.insertRule?tree_component.css.insertRule(rule_name+" { }",0):tree_component.css.addRule(rule_name,null,0),tree_component.get_css(rule_name))},tree_component.remove_css=function(rule_name){return tree_component.get_css(rule_name,!0)},tree_component.add_sheet=function(opts){if(opts.str){var tmp=document.createElement("style");return tmp.setAttribute("type","text/css"),
tmp.styleSheet?(document.getElementsByTagName("head")[0].appendChild(tmp),tmp.styleSheet.cssText=opts.str):(tmp.appendChild(document.createTextNode(opts.str)),document.getElementsByTagName("head")[0].appendChild(tmp)),tmp.sheet||tmp.styleSheet}if(opts.url){if(!document.createStyleSheet){var newSS=document.createElement("link");return newSS.rel="stylesheet",newSS.type="text/css",newSS.media="all",newSS.href=opts.url,document.getElementsByTagName("head")[0].appendChild(newSS),newSS.styleSheet}try{document.createStyleSheet(opts.url)}catch(e){}}},$.extend($.tree.datastores,{html:function(){return{get:function(obj,tree,opts){return obj&&$(obj).size()?$("<div>"
).append(tree.get_node(obj).clone()).html():tree.container.children("ul:eq(0)").html()},parse:function(data,tree,opts,callback){return callback&&callback.call(null,data),data},load:function(data,tree,opts,callback){opts.url?$.ajax({type:opts.method,url:opts.url,data:data,dataType:"html",success:function(d,textStatus){callback.call(null,d)},error:function(xhttp,textStatus,errorThrown){callback.call(null,!1),tree.error(errorThrown+" "+textStatus)}}):callback.call(null,opts.static||tree.container.children("ul:eq(0)").html())}}},json:function(){return{get:function(obj,tree,opts){var _this=this;if(obj=obj&&0!=$(obj).size()?$(obj):tree.container.children("ul"
).children("li"),opts||(opts={}),opts.outer_attrib||(opts.outer_attrib=["id","rel","class"]),opts.inner_attrib||(opts.inner_attrib=[]),1<obj.size()){var arr=[];return obj.each(function(){arr.push(_this.get(this,tree,opts))}),arr}if(0==obj.size())return[];var json={attributes:{},data:{}};for(var i in obj.hasClass("open")&&(json.data.state="open"),obj.hasClass("closed")&&(json.data.state="closed"),opts.outer_attrib){if(opts.outer_attrib.hasOwnProperty(i))void 0!==(val="class"==opts.outer_attrib[i]?obj.attr(opts.outer_attrib[i]).replace(/(^| )last( |$)/gi," ").replace(/(^| )(leaf|closed|open)( |$)/gi," "):obj.attr(opts.outer_attrib[i]))&&0<val.toString(
).replace(" ","").length&&(json.attributes[opts.outer_attrib[i]]=val),delete val}if(tree.settings.languages.length){for(var i in tree.settings.languages)if(tree.settings.languages.hasOwnProperty(i)){var a=obj.children("a."+tree.settings.languages[i]);if(opts.force||opts.inner_attrib.length||a.children("ins").get(0).style.backgroundImage.toString().length||a.children("ins").get(0).className.length){if(json.data[tree.settings.languages[i]]={},json.data[tree.settings.languages[i]].title=tree.get_text(obj,tree.settings.languages[i]),a.children("ins").get(0).style.className.length&&(json.data[tree.settings.languages[i]].icon=a.children("ins").get(0
).style.className),a.children("ins").get(0).style.backgroundImage.length&&(json.data[tree.settings.languages[i]].icon=a.children("ins").get(0).style.backgroundImage.replace("url(","").replace(")","")),opts.inner_attrib.length)for(var j in json.data[tree.settings.languages[i]].attributes={},opts.inner_attrib){if(opts.inner_attrib.hasOwnProperty(j))void 0!==(val=a.attr(opts.inner_attrib[j]))&&0<val.toString().replace(" ","").length&&(json.data[tree.settings.languages[i]].attributes[opts.inner_attrib[j]]=val),delete val}}else json.data[tree.settings.languages[i]]=tree.get_text(obj,tree.settings.languages[i])}}else{a=obj.children("a");if(
json.data.title=tree.get_text(obj),a.children("ins").size()&&a.children("ins").get(0).className.length&&(json.data.icon=a.children("ins").get(0).className),a.children("ins").size()&&a.children("ins").get(0).style.backgroundImage.length&&(json.data.icon=a.children("ins").get(0).style.backgroundImage.replace("url(","").replace(")","")),opts.inner_attrib.length)for(var j in json.data.attributes={},opts.inner_attrib){var val;if(opts.inner_attrib.hasOwnProperty(j))void 0!==(val=a.attr(opts.inner_attrib[j]))&&0<val.toString().replace(" ","").length&&(json.data.attributes[opts.inner_attrib[j]]=val),delete val}}return 0<obj.children("ul").size()&&(json.children=[],
obj.children("ul").children("li").each(function(){json.children.push(_this.get(this,tree,opts))})),json},parse:function(data,tree,opts,callback){if("[object Array]"===Object.prototype.toString.apply(data)){for(var str="",i=0;i<data.length;i++)"function"!=typeof data[i]&&(str+=this.parse(data[i],tree,opts));return callback&&callback.call(null,str),str}if(!data||!data.data)return callback&&callback.call(null,!1),"";str="";str+="<li ";var cls=!1;if(data.attributes)for(var i in data.attributes)data.attributes.hasOwnProperty(i)&&("class"==i?(str+=" class='"+data.attributes[i]+" ","closed"!=data.state&&"open"!=data.state||(str+=" "+data.state+" "),str+="' ",cls=!0
):str+=" "+i+"='"+data.attributes[i]+"' ");if(cls||"closed"!=data.state&&"open"!=data.state||(str+=" class='"+data.state+"' "),str+=">",tree.settings.languages.length)for(i=0;i<tree.settings.languages.length;i++){if((attr={href:"",style:""}).class=tree.settings.languages[i],data.data[tree.settings.languages[i]]&&"undefined"!=(typeof data.data[tree.settings.languages[i]].attributes).toLowerCase())for(var j in data.data[tree.settings.languages[i]].attributes)data.data[tree.settings.languages[i]].attributes.hasOwnProperty(j)&&(
"style"==j||"class"==j?attr[j]+=" "+data.data[tree.settings.languages[i]].attributes[j]:attr[j]=data.data[tree.settings.languages[i]].attributes[j]);for(var j in str+="<a",attr)attr.hasOwnProperty(j)&&(str+=" "+j+'="'+attr[j]+'" ');str+=">",data.data[tree.settings.languages[i]]&&data.data[tree.settings.languages[i]].icon?str+="<ins "+(-1==data.data[tree.settings.languages[i]].icon.indexOf("/")?" class='"+data.data[tree.settings.languages[i]].icon+"' ":" style='background-image:url(\""+data.data[tree.settings.languages[i]].icon+"\");' ")+">&nbsp;</ins>":str+="<ins>&nbsp;</ins>",str+=("undefined"!=(typeof data.data[tree.settings.languages[i]].title
).toLowerCase()?data.data[tree.settings.languages[i]].title:data.data[tree.settings.languages[i]])+"</a>"}else{var attr={href:"",style:"",class:""};if("undefined"!=(typeof data.data.attributes).toLowerCase())for(var i in data.data.attributes)data.data.attributes.hasOwnProperty(i)&&("style"==i||"class"==i?attr[i]+=" "+data.data.attributes[i]:attr[i]=data.data.attributes[i]);for(var i in str+="<a",attr)attr.hasOwnProperty(i)&&(str+=" "+i+'="'+attr[i]+'" ');str+=">",data.data.icon?str+="<ins "+(-1==data.data.icon.indexOf("/")?" class='"+data.data.icon+"' ":" style='background-image:url(\""+data.data.icon+"\");' ")+">&nbsp;</ins>":str+="<ins>&nbsp;</ins>",str+=(
"undefined"!=(typeof data.data.title).toLowerCase()?data.data.title:data.data)+"</a>"}if(data.children&&data.children.length){str+="<ul>";for(i=0;i<data.children.length;i++)str+=this.parse(data.children[i],tree,opts);str+="</ul>"}return str+="</li>",callback&&callback.call(null,str),str},load:function(data,tree,opts,callback){opts.static?callback.call(null,opts.static):$.ajax({type:opts.method,url:opts.url,data:data,dataType:"json",success:function(d,textStatus){callback.call(null,d)},error:function(xhttp,textStatus,errorThrown){callback.call(null,!1),tree.error(errorThrown+" "+textStatus)}})}}}})}),define("lib/jsTree/plugins/jquery.tree.contextmenu",[
"jquery","jquery.tree"],function($){$.extend($.tree.plugins,{contextmenu:{object:$("<ul id='jstree-contextmenu' class='tree-context' />"),data:{t:!1,a:!1,r:!1},defaults:{class_name:"hover",items:{create:{label:"Create",icon:"create",visible:function(NODE,TREE_OBJ){return 1!=NODE.length?0:TREE_OBJ.check("creatable",NODE)},action:function(NODE,TREE_OBJ){TREE_OBJ.create(!1,TREE_OBJ.get_node(NODE[0]))},separator_after:!0},rename:{label:"Rename",icon:"rename",visible:function(NODE,TREE_OBJ){return 1==NODE.length&&TREE_OBJ.check("renameable",NODE)},action:function(NODE,TREE_OBJ){TREE_OBJ.rename(NODE)}},remove:{label:"Delete",icon:"remove",visible:function(NODE,
TREE_OBJ){var ok=!0;return $.each(NODE,function(){return 0==TREE_OBJ.check("deletable",this)&&(ok=!1),!1}),ok},action:function(NODE,TREE_OBJ){$.each(NODE,function(){TREE_OBJ.remove(this)})}}}},show:function(obj,t){var opts=$.extend(!0,{},$.tree.plugins.contextmenu.defaults,t.settings.plugins.contextmenu);obj=$(obj),$.tree.plugins.contextmenu.object.empty();var str="";for(var i in opts.items)if(opts.items.hasOwnProperty(i)&&!1!==opts.items[i]){var r=1;"function"==typeof opts.items[i].visible&&(r=opts.items[i].visible.call(null,$.tree.plugins.contextmenu.data.a,t)),-1!=r&&(0,!0===opts.items[i].separator_before&&(
str+="<li class='separator'><span>&nbsp;</span></li>"),str+='<li><a href="#" rel="'+i+'" class="'+i+" "+(0==r?"disabled":"")+'">',opts.items[i].icon?str+="<ins "+(-1==opts.items[i].icon.indexOf("/")?" class='"+opts.items[i].icon+"' ":" style='background-image:url(\""+(0==r?opts.items[i].icon.replace(".png","_disabled.png"):opts.items[i].icon)+"\");' ")+">&nbsp;</ins>":str+="<ins>&nbsp;</ins>",str+="<span>"+opts.items[i].label+"</span></a></li>",!0===opts.items[i].separator_after&&(str+="<li class='separator'><span>&nbsp;</span></li>"))}var tmp=obj.children("a:visible").offset();$.tree.plugins.contextmenu.object.attr("class",
"tree-context tree-"+t.settings.ui.theme_name.toString()+"-context").html(str);var h=$.tree.plugins.contextmenu.object.height(),w=$.tree.plugins.contextmenu.object.width(),x=tmp.left,y=tmp.top+parseInt(obj.children("a:visible").height())+2,max_y=$(window).height()+$(window).scrollTop(),max_x=$(window).width()+$(window).scrollLeft();max_y<y+h&&(y=Math.max(max_y-h-2,0)),max_x<x+w&&(x=Math.max(max_x-w-2,0)),$.tree.plugins.contextmenu.object.css({left:x,top:y}).fadeIn("fast")},hide:function(){if($.tree.plugins.contextmenu.data.t){var opts=$.extend(!0,{},$.tree.plugins.contextmenu.defaults,$.tree.plugins.contextmenu.data.t.settings.plugins.contextmenu)
;$.tree.plugins.contextmenu.data.r&&$.tree.plugins.contextmenu.data.a&&$.tree.plugins.contextmenu.data.a.children("a, span").removeClass(opts.class_name),$.tree.plugins.contextmenu.data={a:!1,r:!1,t:!1},$.tree.plugins.contextmenu.object.fadeOut("fast")}},exec:function(cmd){if(0!=$.tree.plugins.contextmenu.data.t){var opts=$.extend(!0,{},$.tree.plugins.contextmenu.defaults,$.tree.plugins.contextmenu.data.t.settings.plugins.contextmenu);try{opts.items[cmd].action.apply(null,[$.tree.plugins.contextmenu.data.a,$.tree.plugins.contextmenu.data.t])}catch(e){}}},callbacks:{oninit:function(){if(!$.tree.plugins.contextmenu.css){
$.tree.plugins.contextmenu.css=this.add_sheet({
...
$.tree.plugins.contextmenu.hide()},ondestroy:function(){$.tree.plugins.contextmenu.hide()}}}}),$(function(){$.tree.plugins.contextmenu.object.hide().appendTo("body"),$("a",$.tree.plugins.contextmenu.object[0]).live("click",function(event){return $(this).hasClass("disabled")||($.tree.plugins.contextmenu.exec.apply(null,[$(this).attr("rel")]),$.tree.plugins.contextmenu.hide()),event.stopPropagation(),event.preventDefault(),!1}),$(document).bind("mousedown",function(event){0==$(event.target).parents("#jstree-contextmenu").size()&&$.tree.plugins.contextmenu.hide()})})}),define("generis.tree.browser",["jquery","i18n","generis.tree","helpers","context",
"jquery.tree","lib/jsTree/plugins/jquery.tree.contextmenu"],function($,__,GenerisTreeClass,helpers,context){return console.warn("Hello I am the GenerisTreeBrowserClass  and I am deprecated. I am there from a long but now I am tired, I need to retire. Please talk to my son layout/tree."),GenerisTreeClass.extend({init:function(selector,dataUrl,options){var instance=this;this.defaultOptions={formContainer:"#form-container"},options||(options=this.defaultOptions),this.filter="*",options.instanceName||(options.instanceName="instance");var treeOptions={types:{default:{draggable:function(NODE){return!(!$(NODE).hasClass("node-instance"
)||!instance.options.moveInstanceAction)}}},ui:{theme_name:"custom",theme_path:context.taobase_www+"js/lib/jsTree/themes/css/style.css"},callback:{beforedata:function(NODE,TREE_OBJ){var returnValue=instance.defaultServerParameters;for(var key in NODE&&"*"==instance.filter?returnValue.classUri=$(NODE).prop("id"):void 0!==returnValue.classUri&&delete returnValue.classUri,instance.serverParameters)returnValue[key]=instance.serverParameters[key];return returnValue.selected=instance.options.selectNode,returnValue.filter=instance.filter,returnValue},onload:function(TREE_OBJ){instance.options.selectNode?(TREE_OBJ.select_branch($(
"li[id='"+instance.options.selectNode+"']")),instance.options.selectNode=!1):(TREE_OBJ.open_branch($("li.node-class:first")),$("li.node-class:first a:first").trigger("click"))},ondata:function(DATA,TREE_OBJ){if(DATA.children&&(DATA.state="open"),instance.extractMeta(DATA),instance.options.instanceClass){function addClassToNodes(nodes,clazz){$.each(nodes,function(i,node){node.attributes&&node.attributes.class&&/node\-instance/.test(node.attributes.class)&&(node.attributes.class=node.attributes.class+" "+clazz),node.children&&addClassToNodes(node.children,clazz)})}DATA.children?(addClassToNodes(DATA.children,instance.options.instanceClass),
instance.options.moveInstanceAction&&addClassToNodes(DATA.children,"node-draggable")):0<DATA.length&&(addClassToNodes(DATA,instance.options.instanceClass),instance.options.moveInstanceAction&&addClassToNodes(DATA,"node-draggable"))}return DATA},onselect:function(NODE,TREE_OBJ){var nodeId=$(NODE).prop("id"),parentNodeId=$(NODE).parent().parent().prop("id");if($("a.clicked").each(function(){$(this).parent("li").prop("id")!=nodeId&&$(this).removeClass("clicked")}),($("input:hidden[name='uri']").val()==nodeId||$("input:hidden[name='classUri']").val()==nodeId)&&nodeId==instance.options.selectNode)return!1;if($(NODE).hasClass("node-class"
)&&instance.options.editClassAction&&($(NODE).hasClass("closed")&&TREE_OBJ.open_branch(NODE),helpers._load(instance.options.formContainer,instance.options.editClassAction,instance.data(null,nodeId))),$(NODE).hasClass("node-instance")&&instance.options.editInstanceAction){var PNODE=TREE_OBJ.parent(NODE);helpers._load(instance.options.formContainer,instance.options.editInstanceAction,instance.data(nodeId,$(PNODE).prop("id")))}if($(NODE).hasClass("paginate-more")&&instance.paginateInstances($(NODE).parent().parent(),TREE_OBJ),$(NODE).hasClass("paginate-all")){var limit=instance.getMeta(parentNodeId,"count")-instance.getMeta(parentNodeId,"displayed")
;instance.paginateInstances($(NODE).parent().parent(),TREE_OBJ,{limit:limit})}return instance.callGetSectionActions(NODE,TREE_OBJ),!1},onmove:function(NODE,REF_NODE,TYPE,TREE_OBJ,RB){if(!instance.options.moveInstanceAction)return!1;if($(REF_NODE).hasClass("node-instance")&&"inside"==TYPE)return $.tree.rollback(RB),!1;"after"!=TYPE&&"before"!=TYPE||(REF_NODE=TREE_OBJ.parent(REF_NODE)),function moveNode(url,data){var NODE=data.NODE,RB=(data.REF_NODE,data.RB),TREE_OBJ=data.TREE_OBJ,confirmed=!0===data.confirmed;$.postJson(url,{uri:data.uri,destinationClassUri:data.destinationClassUri,confirmed:confirmed},function(response){if(null!=response)if(
"diff"==response.status){var message=__("Moving this element will replace the properties of the previous class by those of the destination class:");message+="\n";for(var i=0;i<response.data.length;i++)response.data[i].label&&(message+="- "+response.data[i].label+"\n");message+="Please confirm this operation.\n",confirm(message)?(data.confirmed=!0,moveNode(url,data)):$.tree.rollback(RB)}else 1==response.status?($("li a").removeClass("clicked"),TREE_OBJ.open_branch(NODE)):$.tree.rollback(RB);else $.tree.rollback(RB)})}(instance.options.moveInstanceAction,{uri:$(NODE).prop("id"),destinationClassUri:$(REF_NODE).prop("id"),NODE:NODE,REF_NODE:REF_NODE,RB:RB,
TREE_OBJ:TREE_OBJ}),instance.callGetSectionActions(NODE,TREE_OBJ)},oninit:function(TREE_OBJ){instance.callGetSectionActions(void 0,TREE_OBJ)}}};if(options.selectNode&&(treeOptions.selected=options.selectNode),$(selector).length){var tmpTree=$.tree.reference(selector);null!=tmpTree&&tmpTree.destroy(),tmpTree=null}this._super(selector,dataUrl,options,treeOptions),$("#open-action-"+options.actionId).click(function(){$.tree.reference(instance.selector).open_all()}),$("#close-action-"+options.actionId).click(function(){$.tree.reference(instance.selector).close_all()}),$("#filter-action-"+options.actionId).click(function(){instance.enableFilter()}),$(
"#filter-content-"+options.actionId).bind("keypress",function(e){13==e.keyCode&&0<this.value.length&&instance.enableFilter()})},data:function(uri,classUri){var data={},instanceKey=this.options.instanceKey?this.options.instanceKey:"uri",classKey=this.options.classKey?this.options.classKey:"classUri";return uri&&(data[instanceKey]=uri),this.state!=GenerisTreeClass.STATE_FILTERING&&classUri&&(data[classKey]=classUri),data},enableFilter:function(){this.state=this.STATE_FILTERING,this.filter=$.trim($("#filter-content-"+this.options.actionId).val());var instance=this;if("*"!=this.filter){var $cancelBtn=$("#filter-cancel-"+this.options.actionId)
;$cancelBtn.hasClass("ui-helper-hidden")&&$($cancelBtn).removeClass("ui-helper-hidden").on("click",{instance:this},function(){instance.disableFilter()}),$.tree.reference(this.selector).refresh()}else this.disableFilter()},disableFilter:function(){this.state=this.STATE_BROWSING;var $cancelBtn=$("#filter-cancel-"+this.options.actionId);this.filter="*",$("#filter-content-"+this.options.actionId).val(this.filter),$cancelBtn.addClass("ui-helper-hidden"),$.tree.reference(this.selector).refresh()},paginateInstances:function(NODE,TREE_OBJ,pOptions){var instance,nodeId=$(NODE).prop("id"),instancesLeft=this.getMeta(nodeId,"count")-this.getMeta(nodeId,"displayed"),
options={classUri:nodeId,subclasses:0,offset:this.getMeta(nodeId,"position"),limit:instancesLeft<this.paginate?instancesLeft:this.paginate};options=$.extend(options,pOptions),this.filter&&"*"!=this.filter&&(options.filter=this.filter),$.post(this.dataUrl,options,(instance=this,function(DATA){for(var i=0;i<DATA.length;i++)DATA[i].attributes.class=instance.options.instanceClass+" node-instance node-draggable",$("#"+DATA[i].attributes.id,$(TREE_OBJ.container)).length||TREE_OBJ.create(DATA[i],TREE_OBJ.get_node(NODE[0]));instance.setMeta(nodeId,"displayed",instance.getMeta(nodeId,"displayed")+DATA.length),instance.setMeta(nodeId,"position",instance.getMeta(nodeId
,"position")+DATA.length),instance.refreshPaginate(NODE,TREE_OBJ)}),"json")},selectTreeNode:function(id){return this.getTree().select_branch($("li[id='"+id+"']")),!1},getTreeOptions:function(uri){return!!uri&&{NODE:this.getTree().get_node($("li[id='"+uri+"']")),TREE_OBJ:this.getTree(),cssClass:this.options.instanceClass}},addClass:function(NODE,TREE_OBJ,options){$.ajax({url:options.url,type:"POST",data:{classUri:options.id,type:"class"},dataType:"json",success:function(response){response.uri&&TREE_OBJ.select_branch(TREE_OBJ.create({data:response.label,attributes:{id:response.uri,class:"node-class"}},TREE_OBJ.get_node(NODE[0])))}})},addInstance:function(NODE,
TREE_OBJ,options){var cssClass="node-instance node-draggable",instance=this;return options.cssClass&&(cssClass+=" "+options.cssClass),$.ajax({url:options.url,type:"POST",data:{classUri:options.id,type:"instance"},dataType:"json",success:function(response){if(response.uri){TREE_OBJ.select_branch(TREE_OBJ.create({data:response.label,attributes:{id:response.uri,class:cssClass}},TREE_OBJ.get_node(NODE[0])));var classId=$(NODE).prop("id");instance.setMeta(classId,"displayed",instance.getMeta(classId,"displayed")+1),instance.setMeta(classId,"count",instance.getMeta(classId,"count")+1),instance.refreshPaginate(NODE,instance.getTree())}}}),!0},removeNode:function(
NODE,TREE_OBJ,options){var instance=this;confirm(__("Please confirm deletion"))&&$.each(NODE,function(){var data=!1,selectedNode=this;if($(selectedNode).hasClass("node-class")&&(data={classUri:$(selectedNode).prop("id")}),$(selectedNode).hasClass("node-instance")){var PNODE=TREE_OBJ.parent(selectedNode);data={uri:$(selectedNode).prop("id"),classUri:$(PNODE).prop("id")}}data&&$.ajax({url:options.url,type:"POST",data:data,dataType:"json",success:function(response){if(response.deleted){var classId=$(NODE).parent().parent().prop("id");instance.setMeta(classId,"displayed",instance.getMeta(classId,"displayed")-1),instance.setMeta(classId,"count",instance.getMeta(
classId,"count")-1),instance.setMeta(classId,"position",instance.getMeta(classId,"position")-1),TREE_OBJ.remove(selectedNode)}}})})},cloneNode:function(NODE,TREE_OBJ,options){var instance=this,PNODE=TREE_OBJ.parent(NODE);$.ajax({url:options.url,type:"POST",data:{classUri:$(PNODE).prop("id"),uri:$(NODE).prop("id")},dataType:"json",success:function(response){if(response.uri){TREE_OBJ.select_branch(TREE_OBJ.create({data:response.label,attributes:{id:response.uri,class:$(NODE).prop("class")}},TREE_OBJ.get_node(PNODE)));var classId=$(PNODE).prop("id");instance.setMeta(classId,"displayed",instance.getMeta(classId,"displayed")+1),instance.setMeta(classId,"count",
instance.getMeta(classId,"count")+1),instance.refreshPaginate(PNODE,instance.getTree())}}})},renameNode:function(options){var TREE_OBJ=options.TREE_OBJ,NODE=options.NODE,data={uri:$(NODE).prop("id"),newName:TREE_OBJ.get_text(NODE)};options.classUri&&(data.classUri=options.classUri),$.ajax({url:options.url,type:"POST",data:data,dataType:"json",success:function(response){response.renamed||TREE_OBJ.rename(NODE,response.oldName)}})},moveInstance:function(myNODE,myTREE_OBJ){var instance=this;$("body").append($("<div id='tmp-moving' style='display:none;'><span class='ui-state-highlight' style='margin:15px;'>"+__("Select the element destination"
)+"</span><br /><div id='tmp-moving-tree'></div><div style='text-align:center;margin-top:30px;'> <a id='tmp-moving-closer' class='ui-state-default ui-corner-all' href='#'>"+__("Cancel")+"</a> </div> </div>"));var TMP_TREE={data:myTREE_OBJ.settings.data,types:{default:{clickable:function(NODE){return!!$(NODE).hasClass("node-class")},renameable:!1,deletable:!1,creatable:!1,draggable:!1}},ui:{theme_name:"custom",theme_path:context.taobase_www+"js/lib/jsTree/themes/css/style.css"},callback:{beforedata:function(NODE,TREE_OBJ){return NODE?{hideInstances:!0,subclasses:!0,classUri:$(NODE).prop("id")}:{hideInstances:!0,subclasses:!0}},onload:function(TREE_OBJ){
TREE_OBJ.open_branch($("li.node-class:first",$("#tmp-moving-tree")))},ondata:function(DATA,TREE_OBJ){return DATA},onselect:function(NODE,TREE_OBJ){var myREF_NODE=$(instance.selector).find('li[id="'+$(NODE).prop("id")+'"]');myTREE_OBJ.cut(myNODE),myTREE_OBJ.paste(myREF_NODE,"inside"),$("#tmp-moving").dialog("close")}}},position=$(helpers.getMainContainerSelector()).offset();$("#tmp-moving-tree").tree(TMP_TREE),$("#tmp-moving").dialog({width:350,height:400,position:[position.left,position.top],autoOpen:!1,title:__("Move to"),modal:!0}),$("#tmp-moving").bind("dialogclose",function(event,ui){$.tree.reference("#tmp-moving-tree").destroy(),$("#tmp-moving").dialog(
"destroy"),$("#tmp-moving").remove()}),$("#tmp-moving-closer").click(function(){$("#tmp-moving").dialog("close")}),$("#tmp-moving").dialog("open")}})}),define("uiForm",["module","jquery","lodash","i18n","helpers","context","form/property","form/post-render-props","util/encode","jwysiwyg"],function(module,$,_,__,helpers,context,property,postRenderProps,encode){"use strict";function getUrl(action){var conf=module.config();return context.root_url+conf.extension+"/"+conf.module+"/"+action}return{init:function(){var self=this;this.counter=0,this.initGenerisFormPattern=new RegExp(["add","edit","mode","PropertiesAuthoring"].join("|"),"i"),
this.initTranslationFormPattern=/translate/,$("body").ajaxComplete(function(event,request,settings){var testedUrl;"html"!==settings.dataType&&settings.dataType||(testedUrl=-1!==settings.url.indexOf("?")?settings.url.substr(0,settings.url.indexOf("?")):settings.url,self.initRendering(),self.initElements(),self.initGenerisFormPattern.test(testedUrl)&&self.initOntoForms(),self.initTranslationFormPattern.test(testedUrl)&&self.initTranslationForm())}),this.initRendering()},initRendering:function(){var $authoringBtnParent,self=this,$toolBar=$(".content-block .xhtml_form:first").find(".form-toolbar"),$authoringBtn=$(".authoringOpener"),$testAuthoringBtn=$(
".test-authoring"),$rdfImportForm=$(".rdfImport #import"),$rdfExportForm=$(".rdfExport #export");$(".form_desc ~.form_radlst").parent().addClass("bool-list"),$('.form_desc + input[type="hidden"]').prev().addClass("hidden-input-label"),$authoringBtn.length&&!$authoringBtn.hasClass("btn-info")&&($authoringBtnParent=$authoringBtn.parent(),$authoringBtn.prepend($("<span>",{class:"icon-edit"})),$authoringBtn.addClass("btn-info small"),$authoringBtn.appendTo($toolBar),$authoringBtnParent.remove()),$testAuthoringBtn.length&&$testAuthoringBtn.prependTo($toolBar),$rdfImportForm.length&&($("span.form_desc:empty",$rdfImportForm).hide(),$("span.form-elt-info",
$rdfImportForm).css({display:"block",width:"100%"}),$(".form-elt-container.file-uploader",$rdfImportForm).css({width:"65%",float:"right"})),$rdfExportForm.length&&($("div:first",$rdfExportForm).find('input[type="text"]').css("width","calc(65% - 23px)"),$("div:not(.form-toolbar):last span",$rdfExportForm).css("float","right").closest("div").find('[id*="ns_filter"]').addClass("btn-default small")),$("body").off("submit",".xhtml_form form").on("submit",".xhtml_form form",function(e){e.preventDefault();var $form=$(this),formData=self.getFormData($form);return self.submitForm($form,formData)}),$(".form-submitter").off("click").on("click",function(e){
e.preventDefault(),$(e.target).closest(".xhtml_form form").trigger("submit")}),postRenderProps.init()},getFormData:function($form){if($('[id="tao.forms.class"]').length){var formData={},clazz={};$("input.global",$form[0]).each(function(){var $global=$(this),name=$global.attr("name");-1<name.indexOf("class_")?(name=name.replace("class_",""),clazz[name]=$global.val()):formData[name]=$global.val()}),0!==clazz.length&&(formData.class=clazz);var properties=[];return $(".regular-property",$form[0]).each(function(){var property={},name="",isArray=!1,range=[];$('[id*="http_2_www_0_w3_0_org_1_2000_1_01_1_rdf-schema_3_range-TreeBox"]',this).find(".checked").each(
function(){range.push($(this).parent().attr("id"))}),0!==range.length&&(property["http_2_www_0_w3_0_org_1_2000_1_01_1_rdf-schema_3_range"]=range),$(":input.property",this).each(function(){var $property=$(this);name=$property.attr("name").replace(/(property_)?[^_]+_/,""),isArray=name.indexOf("[]")===name.length-2,"checkbox"===$property.attr("type")&&isArray?(name=name.substr(0,name.length-2),$property.is(":checked")&&(_.isArray(property[name])||(property[name]=[]),property[name].push($property.val()))):"radio"===$property.attr("type")?$property.is(":checked")&&(property[name]=$property.val()):property[name]=$property.val()});var indexes=[];$(":input.index",
this).each(function(){var i,found=!1,name="",$index=$(this);for(i in indexes)indexes[i]&&$index.attr("data-related-index")===indexes[i].uri&&(name=$index.attr("name").replace(/(index_)?[^_]+_/,""),"radio"===$index.attr("type")||"checkbox"===$index.attr("type")?$index.is(":checked")&&(indexes[i][name]=$index.val()):indexes[i][name]=$index.val(),found=!0);if(!found){var index={};index.uri=$index.attr("data-related-index"),name=$index.attr("name").replace(/(index_)?[^_]+_/,""),"radio"===$index.attr("type")?$index.is(":checked")&&(index[name]=$index.val()):index[name]=$index.val(),indexes.push(index)}}),property.indexes=indexes,properties.push(property)}),
formData.properties=properties,formData}},initElements:function(){$(".form-refresher").off("click").on("click",function(){var $form=$(this).parents("form");return $(":input[name='"+$form.attr("name")+"_sent']").remove(),$form.submit()});var $uriElm=$("#uri"),$classUriElm=$("#classUri");$(".form-translator").off("click").on("click",function(){return $uriElm.length&&$classUriElm.length&&helpers.getMainContainer().load(getUrl("translateInstance"),{uri:$uriElm.val(),classUri:$classUriElm.val()}),!1}),$(".html-area").each(function(){"none"!==$(this).css("display")&&$(this).wysiwyg({css:context.taobase_www+"css/layout.css"})}),$(".box-checker").off("click").on(
...
tabId="panel-"+module.config().module.toLowerCase()+"_authoring",$tabContainer=$("#tabs"),$panel=(($wantedPanel=$tabContainer.find("#"+tabId)).length||($wantedPanel=$("<div>",{id:tabId,class:"clear content-panel"}).hide(),$tabContainer.find(".content-panel").after($wantedPanel)),$wantedPanel);$.ajax({type:"GET",url:tabUrl,data:{uri:$("#uri").val(),classUri:$("#classUri").val()},dataType:"html",success:function(responseHtml){$tabContainer.find(".content-panel").not($panel).hide(),window.location.hash=tabId,(responseHtml=$(responseHtml)).find("#authoringBack").click(function(){var $myPanel=$(this).parents(".content-panel"),$otherPanel=$myPanel.prev()
;$myPanel.hide(),$otherPanel.show()}),$panel.html(responseHtml).show()}})}),$("input.editVersionedFile").each(function(){var infoUrl=context.root_url+"tao/File/getPropertyFileInfo",data={uri:$("#uri").val(),propertyUri:$(this).siblings("label.form_desc").prop("for")},$_this=$(this);$.ajax({type:"GET",url:infoUrl,data:data,dataType:"json",success:function(r){$_this.after("<span>"+r.name+"</span>")}})}).click(function(){var data={uri:$("#uri").val(),propertyUri:$(this).siblings("label.form_desc").prop("for")};return helpers.getMainContainer().load(getUrl("editVersionedFile"),data),!1}),$(".property-deleter").off("click").on("click",function(){if(confirm(__(
"Please confirm property deletion!"))){var $groupNode=$(this).closest(".form-group");property.remove($(this).data("uri"),$("#id").val(),helpers._url("removeClassProperty","PropertiesAuthoring","tao"),function(){$groupNode.remove()})}}),$(".property-adder").off("click").on("click",function(e){e.preventDefault(),property.add($("#id").val(),helpers._url("addClassProperty","PropertiesAuthoring","tao"))}),$(".index-adder").off("click").on("click",function(e){e.preventDefault();var $prependTo=$(this).closest("div"),$groupNode=$(this).closest(".form-group");if($groupNode.length){var max=0,$propertyindex=$(".property-uri",$groupNode),propertyindex=parseInt(
$propertyindex.attr("id").replace(/[\D]+/,""));$groupNode.find("[data-index]").each(function(){max<$(this).data("index")&&(max=$(this).data("index"))}),max+=1;var uri=$groupNode.find(".property-uri").val();$.ajax({type:"GET",url:helpers._url("addPropertyIndex","PropertiesAuthoring","tao"),data:{uri:uri,index:max,propertyIndex:propertyindex},dataType:"json",success:function(response){$prependTo.before(response.form)}})}}),$(".property-edit-container").off("click",".index-remover").on("click",".index-remover",function(e){e.preventDefault();var $groupNode=$(this).closest(".form-group"),uri=$groupNode.find(".property-uri").val(),$editContainer=$($groupNode[0]
).children(".property-edit-container");$.ajax({type:"POST",url:helpers._url("removePropertyIndex","PropertiesAuthoring","tao"),data:{uri:uri,indexProperty:$(this).attr("id")},dataType:"json",success:function(response){$('[id*="'+response.id+'"], [data-related-index="'+response.id+'"]').each(function(){for(var $currentTarget=$(this);!_.isEqual($currentTarget.parent()[0],$editContainer[0])&&void 0!==$currentTarget.parent()[0];)$currentTarget=$currentTarget.parent();$currentTarget.remove()})}})}),$(".property-mode").off("click").on("click",function(){var $btn=$(this),mode="simple";if(!$btn.hasClass("disabled")){$btn.hasClass("property-mode-advanced")&&(
mode="advanced");var url=$btn.parents("form").prop("action");return helpers.getMainContainer().load(url,{property_mode:mode,uri:$("#uri").val(),id:$("#id").val(),classUri:$("#classUri").val()}),!1}}),$(".property-template").each(function(){$(this).closest("div").hide()});var $propertyType=$(".property-type"),$propertyListValues=$(".property-listvalues");$propertyType.on("change",function(){var $this=$(this),$elt=$this.parent("div").next("div"),propertiesTypes=["list","tree"];new RegExp(propertiesTypes.join("$|").concat("$")).test($this.val())?"none"===$elt.css("display")&&($elt.show(),$elt.find("select").removeAttr("disabled")):"none"!==$elt.css("display"
)&&($elt.css("display","none"),$elt.find("select").prop("disabled","disabled"),$elt.find('select option[value=" "]').attr("selected",!0)),$.each(propertiesTypes,function(i,rangedPropertyName){if(new RegExp(rangedPropertyName+"$").test($this.val()))return $elt.find("select").html($elt.closest(".property-edit-container").find("."+rangedPropertyName+"-template").html()),!0})}).trigger("change"),$propertyListValues.off("change"),$propertyListValues.on("change",function(){var $this=$(this),elt=$this.parent("div");if("new"===$this.val()){var rangeId=$this.prop("id"),dialogId=rangeId.replace("_range","_dialog"),treeId=rangeId.replace("_range","_tree"),
closerId=rangeId.replace("_range","_closer");elt.append("<div id='"+dialogId+"' style='display:none;' > <span class='ui-state-highlight' style='margin:15px;'>"+__("Right click the tree to manage your lists")+"</span><br /><br /><div id='"+treeId+"' ></div> <div style='text-align:center;margin-top:30px;'> <a id='"+closerId+"' class='ui-state-default ui-corner-all' href='#'>"+__("Save")+"</a> </div> </div>");var $dialogElm=$("#"+dialogId);$dialogElm.dialog({width:350,height:400,autoOpen:!1,title:__("Manage data list")}),$dialogElm.bind("dialogclose",function(event,ui){$.tree.reference("#"+treeId).destroy(),$dialogElm.dialog("destroy"),$dialogElm.remove()}),$(
"#"+closerId).click(function(){$("#"+dialogId).dialog("close")}),$dialogElm.bind("dialogopen",function(event,ui){var url=context.root_url+"taoBackOffice/Lists/",dataUrl=url+"getListsData",renameUrl=url+"rename",createUrl=url+"create",removeListUrl=url+"removeList",removeListEltUrl=url+"removeListElement";$("#"+treeId).tree({data:{type:"json",async:!0,opts:{method:"POST",url:dataUrl}},types:{default:{renameable:!0,deletable:!0,creatable:!0,draggable:!1}},ui:{theme_name:"custom"},callback:{onrename:function(NODE,TREE_OBJ,RB){var options={url:renameUrl,NODE:NODE,TREE_OBJ:TREE_OBJ};if($(NODE).hasClass("node-instance")){var PNODE=TREE_OBJ.parent(NODE)
;options.classUri=$(PNODE).prop("id")}require(["require","jquery","generis.tree.browser"],function(req,$,GenerisTreeBrowserClass){GenerisTreeBrowserClass.prototype.renameNode(options)})},ondestroy:function(TREE_OBJ){var $rangeElm=$("#"+rangeId);$rangeElm.find("option").each(function(){var $option=$(this);""!==$option.val()&&"new"!==$option.val()&&$option.remove()}),$("#"+treeId+" .node-root .node-class").each(function(){$rangeElm.find("option[value='new']").before("<option value='"+$(this).prop("id")+"'>"+$(this).children("a:first").text()+"</option>")}),$rangeElm.parent("div").children("ul.form-elt-list").remove(),$rangeElm.val("")}},plugins:{contextmenu:{
items:{create:{label:__("Create"),icon:context.taobase_www+"img/add.png",visible:function(NODE,TREE_OBJ){return!$(NODE).hasClass("node-instance")&&TREE_OBJ.check("creatable",NODE)},action:function(NODE,TREE_OBJ){return $(NODE).hasClass("node-class")&&$.ajax({url:createUrl,type:"POST",data:{classUri:$(NODE).prop("id"),type:"instance"},dataType:"json",success:function(response){response.uri&&TREE_OBJ.select_branch(TREE_OBJ.create({data:response.label,attributes:{id:response.uri,class:"node-instance"}},TREE_OBJ.get_node(NODE[0])))}}),$(NODE).hasClass("node-root")&&$.ajax({url:createUrl,type:"POST",data:{classUri:"root",type:"class"},dataType:"json",
success:function(response){response.uri&&TREE_OBJ.select_branch(TREE_OBJ.create({data:response.label,attributes:{id:response.uri,class:"node-class"}},TREE_OBJ.get_node(NODE[0])))}}),!1}},rename:{label:__("Rename"),icon:context.taobase_www+"img/rename.png",visible:function(NODE,TREE_OBJ){return!$(NODE).hasClass("node-root")&&TREE_OBJ.check("renameable",NODE)}},remove:{label:__("Remove"),icon:context.taobase_www+"img/delete.png",visible:function(NODE,TREE_OBJ){return!$(NODE).hasClass("node-root")&&TREE_OBJ.check("deletable",NODE)},action:function(NODE,TREE_OBJ){var removeUrl;return $(NODE).hasClass("node-root")||($(NODE).hasClass("node-class")&&(
removeUrl=removeListUrl),$(NODE).hasClass("node-instance")&&(removeUrl=removeListEltUrl),$.ajax({url:removeUrl,type:"POST",data:{uri:$(NODE).prop("id")},dataType:"json",success:function(response){response.deleted&&TREE_OBJ.remove(NODE)}})),!1}}}}}})}),$dialogElm.dialog("open")}else{$(elt).parent("div").children("ul.form-elt-list").remove();var classUri=$this.val();""!==classUri&&" "!==classUri&&($this.parent("div").children("div.form-error").remove(),$.ajax({url:context.root_url+"taoBackOffice/Lists/getListElements",type:"POST",data:{listUri:classUri},dataType:"json",success:function(response){var property,html="<ul class='form-elt-list'>";for(
property in response)response.hasOwnProperty(property)&&(html+="<li>"+encode.html(response[property])+"</li>");html+="</ul>",$(elt).parent("div").append(html)}}))}}).trigger("change"),$propertyListValues.each(function(){var listField=$(this);if(0===listField.parent().find("img").length){var listControl=$("<img title='manage lists' class='manage-lists' style='cursor:pointer;' />");listControl.prop("src",context.taobase_www+"img/add.png"),listControl.click(function(){listField.val("new"),listField.change()}),listControl.insertAfter(listField)}}),$propertyListValues.each(function(){var elt=$(this).parent("div");elt.hasClass("form-elt-highlight"
)||"none"===elt.css("display")||elt.addClass("form-elt-highlight")})},initTranslationForm:function(){$("#translate_lang").change(function(){var trLang=$(this).val();""!==trLang&&($("#translation_form").find(":input").each(function(){/^http/.test($(this).prop("name"))&&$(this).val("")}),$.post(getUrl("getTranslatedData"),{uri:$("#uri").val(),classUri:$("#classUri").val(),lang:trLang},function(response){for(var index in response){var formElt=$(":input[name='"+index+"']");formElt.hasClass("html-area")?formElt.wysiwyg("setContent",response[index]):formElt.val(response[index])}},"json"))})},submitForm:function(myForm,serialize){try{if(
"multipart/form-data"===myForm.prop("enctype")&&myForm.find(".file-uploader").length)return!1;var $container=myForm.closest(".content-block");if(!$container||0===$container.length)return!0;serialize=void 0!==serialize?serialize:myForm.serializeArray(),$container.load(myForm.prop("action"),serialize)}catch(exp){return!1}return!1}}}),define("layout/actions/binder",["lodash"],function(_){"use strict";var bindings={};return{register:function(name,binding){bindings[name]=binding},exec:function(action,context){var name;if(action&&action.binding&&(name=action.binding,_.isFunction(bindings[name])))return bindings[name].call(action,context)}}}),define(
"layout/permissions",["lodash","uri"],function(_,uriUtil){"use strict";var permissionStore={},supportedRights=[];return{setSupportedRights:function(rights){_.isArray(rights)&&(supportedRights=_.filter(rights,_.isString))},getRights:function(){return supportedRights},isSupported:function(right){return _.contains(supportedRights,right)},addPermissions:function(uri,permissions){return _.isString(uri)&&_.isArray(permissions)&&(permissionStore[uri]=_.intersection(permissions,_.values(this.getRights()))),_.isUndefined(permissions)&&_.isPlainObject(uri)&&(permissions=uri,_.forEach(permissions,function(value,key){this.addPermissions(key,value)},this)),this},
getPermissions:function(uri){return permissionStore[uri]},hasPermission:function(uri,permission){return 0===supportedRights.length||void 0!==permissionStore[uri]&&_.contains(permissionStore[uri],permission)},clear:function(){return permissionStore={},this},isContextAllowed:function(requiredRights,resourceContext){var self=this;return!requiredRights||0===_.size(requiredRights)||0===supportedRights.length||!!_.isPlainObject(resourceContext)&&_.all(requiredRights,function(right,requiredParameter){var parameterValue;return!(void 0===resourceContext[requiredParameter]||!self.isSupported(right))&&(parameterValue=uriUtil.decode(resourceContext[requiredParameter]),
self.hasPermission(parameterValue,right))})},getResourceAccessMode:function(uri){var self=this,mode="allowed",rights=this.getRights(),count=_.reduce(rights,function(acc,right){return self.hasPermission(uri,right)&&acc++,acc},0);return 0<rights.length&&count!==rights.length&&(mode=0===count?"denied":"partial"),mode}}}),define("provider/resources",["lodash","i18n","util/url","core/promise","core/dataProvider/request","layout/permissions"],function(_,__,urlUtil,Promise,request,permissionsManager){"use strict";var defaultConfig={getClasses:{url:urlUtil.route("getAll","RestClass","tao")},getResources:{url:urlUtil.route("getAll","RestResource","tao")},
getClassProperties:{url:urlUtil.route("create","RestResource","tao")},copyTo:{}},computeNodeAccessMode=function computeNodeAccessMode(nodes){return _.map(nodes,function(node){return node.accessMode=permissionsManager.getResourceAccessMode(node.uri),_.isArray(node.children)&&(node.children=computeNodeAccessMode(node.children)),node})};return function(config){return config=_.defaults(config||{},defaultConfig),{getClasses:function(classUri){return request(config.getClasses.url,{classUri:classUri})},getResources:function(params,computePermissions){return request(config.getResources.url,params).then(function(results){var resources,currentRights
;return resources=results&&results.resources?results.resources:results,computePermissions&&results.permissions&&(currentRights=permissionsManager.getRights(),results.permissions.supportedRights&&results.permissions.supportedRights.length&&0===currentRights.length&&permissionsManager.setSupportedRights(results.permissions.supportedRights),results.permissions.data&&permissionsManager.addPermissions(results.permissions.data),resources.nodes?resources.nodes=computeNodeAccessMode(resources.nodes):resources=computeNodeAccessMode(resources)),resources})},getClassProperties:function(classUri){return request(config.getClassProperties.url,{classUri:classUri})},
copyTo:function(uri,destinationClassUri){return _.isEmpty(config.copyTo.url)?Promise.reject("Please define the action URL"):_.isEmpty(uri)?Promise.reject("The URI of the resource to copy must be defined"):_.isEmpty(destinationClassUri)?Promise.reject("The URI of the destination class must be defined"):request(config.copyTo.url,{uri:uri,destinationClassUri:destinationClassUri},"POST")}}}}),define("tpl!ui/class/tpl/selector",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){this.compilerInfo=[4,">= 1.0.0"],helpers=this.merge(helpers,Handlebars.helpers),data=data||{};var stack1,helper,buffer="",
...
stack1)+"</a>\n</li>\n"},data),data:data},((stack1=helper?helper.call(depth0,depth0&&depth0.type,"instance",options):helperMissing.call(depth0,"equal",depth0&&depth0.type,"instance",options))||0===stack1)&&(buffer+=stack1),buffer+="\n\n\n"})}),define("tpl!ui/resource/tpl/list",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){this.compilerInfo=[4,">= 1.0.0"],helpers=this.merge(helpers,Handlebars.helpers),data=data||{};var stack1,helper,options,buffer="",helperMissing=helpers.helperMissing,escapeExpression=this.escapeExpression;return buffer+='<div class="resource-list ',((stack1=helpers.if.call(depth0,
depth0&&depth0.multiple,{hash:{},inverse:this.noop,fn:this.program(1,function(depth0,data){return"multiple"},data),data:data}))||0===stack1)&&(buffer+=stack1),buffer+='">\n    <ul></ul>\n    <div class="more hidden">\n        <a href="#" class="btn-info small"><span class="icon-download"></span> '+escapeExpression((options={hash:{},data:data},(helper=helpers.__||depth0&&depth0.__)?helper.call(depth0,"Load more",options):helperMissing.call(depth0,"__","Load more",options)))+"</a>\n    </div>\n</div>\n\n"})}),define("tpl!ui/resource/tpl/listNode",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){
this.compilerInfo=[4,">= 1.0.0"],helpers=this.merge(helpers,Handlebars.helpers),data=data||{};var stack1,helper,buffer="",functionType="function",escapeExpression=this.escapeExpression;return buffer+='<li data-uri="',stack1=(helper=helpers.uri)?helper.call(depth0,{hash:{},data:data}):typeof(helper=depth0&&depth0.uri)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+'" ',((stack1=helpers.if.call(depth0,depth0&&depth0.selected,{hash:{},inverse:this.noop,fn:this.program(1,function(depth0,data){return'class="selected"'},data),data:data}))||0===stack1)&&(buffer+=stack1),buffer+=' class="',stack1=(helper=helpers.state
...
"tpl!ui/generis/validator/validator",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){return this.compilerInfo=[4,">= 1.0.0"],helpers=this.merge(helpers,Handlebars.helpers),data=data||{},'<div class="ui-generis-validator"></div>'})}),define("css!ui/generis/validator/validator",[],function(){}),define("tpl!ui/generis/widget/widget",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){this.compilerInfo=[4,">= 1.0.0"],data=data||{};var stack1,helper,buffer="",helperMissing=(helpers=this.merge(helpers,Handlebars.helpers)).helperMissing,
escapeExpression=this.escapeExpression;return buffer+='<label for="',stack1=(helper=helpers.uri)?helper.call(depth0,{hash:{},data:data}):"function"==typeof(helper=depth0&&depth0.uri)?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+'">\n    ',stack1=(helper=helpers.label)?helper.call(depth0,{hash:{},data:data}):"function"==typeof(helper=depth0&&depth0.label)?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+"\n    ",((stack1=helpers.if.call(depth0,depth0&&depth0.required,{hash:{},inverse:this.noop,fn:this.program(1,function(depth0,data){var helper,options,buffer=""
;return buffer+='\n    <abbr title="'+escapeExpression((options={hash:{},data:data},(helper=helpers.__||depth0&&depth0.__)?helper.call(depth0,"This field is required",options):helperMissing.call(depth0,"__","This field is required",options)))+'">*</abbr>\n    '},data),data:data}))||0===stack1)&&(buffer+=stack1),buffer+="\n</label>"})}),define("css!ui/generis/widget/widget",[],function(){}),define("tpl!ui/generis/widget/checkBox/checkBox",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){this.compilerInfo=[4,">= 1.0.0"],helpers=this.merge(helpers,Handlebars.helpers),partials=this.merge(partials,
Handlebars.partials),data=data||{};var stack1,buffer="",functionType="function",escapeExpression=this.escapeExpression,self=this,helperMissing=helpers.helperMissing;function program2(depth0,data){return'\n                        checked="true"\n                        '}return buffer+='<div class="ui-generis-widget check-box">\n    <div class="left">\n        ',((stack1=self.invokePartial(partials["ui-generis-widget-label"],"ui-generis-widget-label",depth0,helpers,partials,data))||0===stack1)&&(buffer+=stack1),buffer+='\n    </div>\n    <div class="right">\n        <div class="check-box-input">\n            ',((stack1=helpers.each.call(depth0,
depth0&&depth0.range,{hash:{},inverse:self.noop,fn:self.programWithDepth(1,function(depth0,data,depth1){var stack1,helper,options,buffer="";return buffer+='\n            <div class="option">\n                <label>\n                    <input\n                        type="checkbox"\n                        name="'+escapeExpression(typeof(stack1=depth0&&depth0.uri)===functionType?stack1.apply(depth0):stack1)+'"\n                        value="'+escapeExpression(typeof(stack1=depth0&&depth0.uri)===functionType?stack1.apply(depth0):stack1)+'"\n                        ',helper=helpers.includes||depth1&&depth1.includes,options={hash:{},inverse:self.noop,
fn:self.program(2,program2,data),data:data},((stack1=helper?helper.call(depth0,depth1&&depth1.values,depth0&&depth0.uri,options):helperMissing.call(depth0,"includes",depth1&&depth1.values,depth0&&depth0.uri,options))||0===stack1)&&(buffer+=stack1),buffer+='>\n                    <span class="icon-checkbox"></span>\n                    '+escapeExpression(typeof(stack1=depth0&&depth0.label)===functionType?stack1.apply(depth0):stack1)+"\n                </label>\n            </div>\n            "},data,depth0),data:data}))||0===stack1)&&(buffer+=stack1),buffer+="\n        </div>\n    </div>\n</div>\n"})}),define("tpl!ui/generis/widget/comboBox/comboBox",[
"handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){this.compilerInfo=[4,">= 1.0.0"],helpers=this.merge(helpers,Handlebars.helpers),partials=this.merge(partials,Handlebars.partials),data=data||{};var stack1,helper,options,buffer="",functionType="function",escapeExpression=this.escapeExpression,helperMissing=helpers.helperMissing;return buffer+='<div class="ui-generis-widget combo-box">\n    <div class="left">\n        ',((stack1=this.invokePartial(partials["ui-generis-widget-label"],"ui-generis-widget-label",depth0,helpers,partials,data))||0===stack1)&&(buffer+=stack1),
...
buffer="";return buffer+='\n            <option value="'+escapeExpression(typeof(stack1=depth0&&depth0.uri)===functionType?stack1.apply(depth0):stack1)+'">'+escapeExpression(typeof(stack1=depth0&&depth0.label)===functionType?stack1.apply(depth0):stack1)+"</option>\n            "},data),data:data}))||0===stack1)&&(buffer+=stack1),buffer+="\n        </select>\n    </div>\n</div>\n"})}),define("tpl!ui/generis/widget/hiddenBox/hiddenBox",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){this.compilerInfo=[4,">= 1.0.0"],helpers=this.merge(helpers,Handlebars.helpers),partials=this.merge(partials,Handlebars.partials),
data=data||{};var stack1,helper,buffer="",escapeExpression=this.escapeExpression;return buffer+='<div class="ui-generis-widget hidden-box">\n    <div class="left">\n        ',((stack1=this.invokePartial(partials["ui-generis-widget-label"],"ui-generis-widget-label",depth0,helpers,partials,data))||0===stack1)&&(buffer+=stack1),buffer+='\n    </div>\n    <div class="right">\n        <input name="',buffer+=escapeExpression(stack1=(helper=helpers.uri)?helper.call(depth0,{hash:{},data:data}):"function"==typeof(helper=depth0&&depth0.uri)?helper.call(depth0,{hash:{},data:data}):helper
)+'" type="password">\n    </div>\n</div>\n\n<div class="ui-generis-widget hidden-box confirmation">\n    <div class="left">\n        ',((stack1=this.invokePartial(partials["ui-generis-widget-label"],"ui-generis-widget-label",depth0&&depth0.confirmation,helpers,partials,data))||0===stack1)&&(buffer+=stack1),buffer+='\n    </div>\n    <div class="right">\n        <input name="'+escapeExpression("function"==typeof(stack1=null==(stack1=depth0&&depth0.confirmation)||!1===stack1?stack1:stack1.uri)?stack1.apply(depth0):stack1)+'" type="password">\n    </div>\n</div>'})}),define("tpl!ui/generis/widget/textBox/textBox",["handlebars"],function(hb){return hb.template(
function(Handlebars,depth0,helpers,partials,data){this.compilerInfo=[4,">= 1.0.0"],helpers=this.merge(helpers,Handlebars.helpers),partials=this.merge(partials,Handlebars.partials),data=data||{};var stack1,helper,buffer="",escapeExpression=this.escapeExpression;return buffer+='<div class="ui-generis-widget text-box">\n    <div class="left">\n        ',((stack1=this.invokePartial(partials["ui-generis-widget-label"],"ui-generis-widget-label",depth0,helpers,partials,data))||0===stack1)&&(buffer+=stack1),buffer+='\n    </div>\n    <div class="right">\n        <input name="',buffer+=escapeExpression(stack1=(helper=helpers.uri)?helper.call(depth0,{hash:{},data:data
}):"function"==typeof(helper=depth0&&depth0.uri)?helper.call(depth0,{hash:{},data:data}):helper)+'" value="',buffer+=escapeExpression(stack1=(helper=helpers.value)?helper.call(depth0,{hash:{},data:data}):"function"==typeof(helper=depth0&&depth0.value)?helper.call(depth0,{hash:{},data:data}):helper)+'">\n    </div>\n</div>'})}),define("tpl!ui/generis/form/form",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){this.compilerInfo=[4,">= 1.0.0"],helpers=this.merge(helpers,Handlebars.helpers),data=data||{};var stack1,helper,buffer="",functionType="function",escapeExpression=this.escapeExpression
;return buffer+='<div class="ui-generis-form">\n    <h2>',stack1=(helper=helpers.title)?helper.call(depth0,{hash:{},data:data}):typeof(helper=depth0&&depth0.title)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+'</h2>\n    <form action="',stack1=(helper=helpers.formAction)?helper.call(depth0,{hash:{},data:data}):typeof(helper=depth0&&depth0.formAction)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+'" method="',stack1=(helper=helpers.formMethod)?helper.call(depth0,{hash:{},data:data}):typeof(helper=depth0&&depth0.formMethod)===functionType?helper.call(depth0,{
...
buffer+=escapeExpression(stack1)+' : </span><span class="selected-num">0</span>\n        </div>\n    </footer>\n    '},data),data:data}))||0===stack1)&&(buffer+=stack1),buffer+="\n</div>\n"})}),define("css!ui/resource/css/selector",[],function(){}),define("tpl!ui/loadingButton/tpl/button",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){this.compilerInfo=[4,">= 1.0.0"],helpers=this.merge(helpers,Handlebars.helpers),data=data||{};var helper,buffer="",escapeExpression=this.escapeExpression;return buffer+='<button class="loading-button btn-',buffer+=escapeExpression((helper=helpers.type)?helper.call(depth0,{
hash:{},data:data}):"function"==typeof(helper=depth0&&depth0.type)?helper.call(depth0,{hash:{},data:data}):helper)+' small" type="button" title="',buffer+=escapeExpression((helper=helpers.title)?helper.call(depth0,{hash:{},data:data}):"function"==typeof(helper=depth0&&depth0.title)?helper.call(depth0,{hash:{},data:data}):helper)+'">\n    <span class="spinner-icon icon-loop spinning"></span>\n    <span class="start-icon icon-',buffer+=escapeExpression((helper=helpers.icon)?helper.call(depth0,{hash:{},data:data}):"function"==typeof(helper=depth0&&depth0.icon)?helper.call(depth0,{hash:{},data:data}):helper)+'"></span>\n    <span class="action-label">',
buffer+=escapeExpression((helper=helpers.label)?helper.call(depth0,{hash:{},data:data}):"function"==typeof(helper=depth0&&depth0.label)?helper.call(depth0,{hash:{},data:data}):helper)+'</span>\n    <span class="terminated-label">',buffer+=escapeExpression((helper=helpers.terminatedLabel)?helper.call(depth0,{hash:{},data:data}):"function"==typeof(helper=depth0&&depth0.terminatedLabel)?helper.call(depth0,{hash:{},data:data}):helper)+"</span>\n</button>"})}),define("css!ui/loadingButton/css/button",[],function(){}),define("tpl!ui/report/layout",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){this.compilerInfo=[4,
">= 1.0.0"],data=data||{};var stack1,helper,buffer="",helperMissing=(helpers=this.merge(helpers,Handlebars.helpers)).helperMissing,escapeExpression=this.escapeExpression;return buffer+='<div class="component-report',((stack1=helpers.if.call(depth0,depth0&&depth0.noBorder,{hash:{},inverse:this.noop,fn:this.program(1,function(depth0,data){return" no-border"},data),data:data}))||0===stack1)&&(buffer+=stack1),buffer+='">\n    ',((stack1=helpers.if.call(depth0,depth0&&depth0.detailsButtonVisible,{hash:{},inverse:this.noop,fn:this.program(3,function(depth0,data){var helper,options,buffer=""
...
stack1)+"</button>\n        "},data),data:data}))||0===stack1)&&(buffer+=stack1),buffer+="\n    </div>\n</div>"})}),define("tpl!ui/taskQueueButton/tpl/report",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){this.compilerInfo=[4,">= 1.0.0"],helpers=this.merge(helpers,Handlebars.helpers),data=data||{};var helper,buffer="";return buffer+='<div class="task-report-container">\n    <div class="section-header flex-container-full">\n        <h2>',buffer+=(0,this.escapeExpression)((helper=helpers.title)?helper.call(depth0,{hash:{},data:data}):"function"==typeof(helper=depth0&&depth0.title)?helper.call(depth0,{hash:{},
data:data}):helper)+'</h2>\n    </div>\n    <div class="main-container flex-container-full report"></div>\n</div>'})}),define("css!ui/taskQueueButton/css/taskable",[],function(){}),define("tpl!ui/destination/tpl/selector",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){this.compilerInfo=[4,">= 1.0.0"],helpers=this.merge(helpers,Handlebars.helpers),data=data||{};var stack1,buffer="",functionType="function",escapeExpression=this.escapeExpression;return buffer+='<div class="destination-selector">\n    ',((stack1=helpers.if.call(depth0,depth0&&depth0.title,{hash:{},inverse:this.noop,fn:this.program(1,function(
depth0,data){var stack1,helper,buffer="";return buffer+="\n    <h2>",stack1=(helper=helpers.title)?helper.call(depth0,{hash:{},data:data}):typeof(helper=depth0&&depth0.title)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+"</h2>\n    "},data),data:data}))||0===stack1)&&(buffer+=stack1),buffer+="\n    <div>\n        ",((stack1=helpers.if.call(depth0,depth0&&depth0.description,{hash:{},inverse:this.noop,fn:this.program(3,function(depth0,data){var stack1,helper,buffer="";return buffer+="\n        <p>",stack1=(helper=helpers.description)?helper.call(depth0,{hash:{},data:data}):typeof(
helper=depth0&&depth0.description)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+"</p>\n        "},data),data:data}))||0===stack1)&&(buffer+=stack1),buffer+='\n        <div class="selector-container"></div>\n        <div class="actions">\n        </div>\n    </div>\n</div>\n'})}),define("css!ui/destination/css/selector",[],function(){}),define("layout/actions/common",["module","jquery","i18n","lodash","context","layout/section","layout/actions/binder","layout/permissions","provider/resources","ui/destination/selector","uri","ui/feedback","ui/dialog/confirm","util/httpErrorParser"],function(module,$,__,_,
appContext,section,binder,permissionsManager,resourceProviderFactory,destinationSelectorFactory,uri,feedback,confirmDialog,httpErrorParser){"use strict";return function(){binder.register("load",function(actionContext){section.current().loadContentBlock(this.url,_.pick(actionContext,["uri","classUri","id"]))}),binder.register("loadClass",function(actionContext){section.current().loadContentBlock(this.url,{classUri:actionContext.classUri,id:uri.decode(actionContext.classUri)})}),binder.register("subClass",function(actionContext){var classUri=uri.decode(actionContext.classUri),self=this;return new Promise(function(resolve,reject){$.ajax({url:self.url,
type:"POST",data:{classUri:actionContext.classUri,id:classUri,type:"class"},dataType:"json",success:function(response){return response.uri?(actionContext.tree&&$(actionContext.tree).trigger("addnode.taotree",[{uri:uri.decode(response.uri),label:response.label,parent:uri.decode(actionContext.classUri),cssClass:"node-class"}]),resolve({uri:uri.decode(response.uri),label:response.label,classUri:uri.decode(actionContext.classUri),type:"class"})):reject(new Error(__("Adding the new class has failed")))},error:function(xhr,options,err){reject(httpErrorParser.parse(xhr,options,err))}})})}),binder.register("instanciate",function(actionContext){var self=this,
classUri=uri.decode(actionContext.classUri);return new Promise(function(resolve,reject){$.ajax({url:self.url,type:"POST",data:{classUri:actionContext.classUri,id:classUri,type:"instance"},dataType:"json",success:function(response){return response.uri?(actionContext.tree&&$(actionContext.tree).trigger("addnode.taotree",[{uri:uri.decode(response.uri),label:response.label,parent:uri.decode(actionContext.classUri),cssClass:"node-instance"}]),resolve({uri:uri.decode(response.uri),label:response.label,classUri:uri.decode(actionContext.classUri),type:"instance"})):reject(new Error(__("Adding the new resource has failed")))},error:function(xhr,options,err){reject(
httpErrorParser.parse(xhr,options,err))}})})}),binder.register("duplicateNode",function(actionContext){var self=this;return new Promise(function(resolve,reject){$.ajax({url:self.url,type:"POST",data:{uri:actionContext.id,classUri:uri.decode(actionContext.classUri)},dataType:"json",success:function(response){return response.uri?(actionContext.tree&&$(actionContext.tree).trigger("addnode.taotree",[{uri:uri.decode(response.uri),label:response.label,parent:uri.decode(actionContext.classUri),cssClass:"node-instance"}]),resolve({uri:uri.decode(response.uri),label:response.label,classUri:uri.decode(actionContext.classUri),type:"instance"})):reject(new Error(__(
"Node duplication has failed")))},error:function(xhr,options,err){reject(httpErrorParser.parse(xhr,options,err))}})})}),binder.register("removeNode",function(actionContext){var self=this,data={},tokenName=module.config().xsrfTokenName;return data.uri=uri.decode(actionContext.uri),data.classUri=uri.decode(actionContext.classUri),data.id=actionContext.id,data[tokenName]=$.cookie(tokenName),new Promise(function(resolve,reject){confirmDialog(__("Please confirm deletion"),function(){$.ajax({url:self.url,type:"POST",data:data,dataType:"json",success:function(response){if(response.deleted)return actionContext.tree&&$(actionContext.tree).trigger("removenode.taotree"
,[{id:actionContext.uri||actionContext.classUri}]),resolve({uri:actionContext.uri||actionContext.classUri});reject(response.msg||__("Unable to delete the selected resource"))},error:function(xhr,options,err){reject(httpErrorParser.parse(xhr,options,err))}})},function(){reject({cancel:!0})})})}),binder.register("removeNodes",function(actionContexts){var classes,instances,self=this,tokenName=module.config().xsrfTokenName,confirmMessage="",data={};return _.isArray(actionContexts)||(actionContexts=[actionContexts]),classes=_.filter(actionContexts,{type:"class"}),instances=_.filter(actionContexts,{type:"instance"}),data[tokenName]=$.cookie(tokenName),
data.ids=_.pluck(actionContexts,"id"),1===actionContexts.length?confirmMessage=__("Please confirm deletion"):1<actionContexts.length&&(instances.length&&(confirmMessage=1===instances.length?__("an instance"):__("%s instances",instances.length)),classes.length&&(confirmMessage&&(confirmMessage+=__(" and ")),1===classes.length?confirmMessage=__("a class"):confirmMessage+=__("%s classes",classes.length)),confirmMessage=__("Please confirm deletion of %s.",confirmMessage)),new Promise(function(resolve,reject){confirmDialog(confirmMessage,function(){$.ajax({url:self.url,type:"POST",data:data,dataType:"json",success:function(response){
response.success&&response.deleted?resolve(response.deleted):reject(new Error(response.msg||__("Unable to delete the selected resources")))},error:function(xhr,options,err){reject(httpErrorParser.parse(xhr,options,err))}})},function(){reject({cancel:!0})})})}),binder.register("moveNode",function(actionContext){var data=_.pick(actionContext,["id","uri","destinationClassUri","confirmed"]);!function _moveNode(url){$.ajax({url:url,type:"POST",data:data,dataType:"json",success:function(response){var message,i;if(response&&"diff"===response.status){for(message=__(
"Moving this element will replace the properties of the previous class by those of the destination class :"),message+="\n",i=0;i<response.data.length;i++)response.data[i].label&&(message+="- "+response.data[i].label+"\n");if(message+=__("Please confirm this operation.")+"\n",window.confirm(message))return data.confirmed=!0,_moveNode(url)}else if(response&&!0===response.status)return void $(actionContext.tree).trigger("openbranch.taotree",[{id:actionContext.destinationClassUri}]);$(actionContext.tree).trigger("rollback.taotree")}})}(this.url)}),binder.register("launchEditor",function(actionContext){var data=_.pick(actionContext,["id"]);$.ajax({url:this.url,
type:"GET",data:data,dataType:"html",success:function(response){var $response=$(response);$response.is('[data-content-target="wide"]')||$response.find('[data-content-target="wide"]').length?section.create({id:"authoring",name:__("Authoring"),url:this.url,content:$response,visible:!1}).show():section.updateContentBlock($response)}})}),binder.register("copyTo",function(actionContext){var $container,resourceProvider=resourceProviderFactory({copyTo:{url:this.url}});return section.current().updateContentBlock('<div class="main-container flex-container-form-main"></div>'),$container=$(section.selected.panel).find(".main-container"),new Promise(function(resolve,
reject){destinationSelectorFactory($container,{classUri:actionContext.rootClassUri,preventSelection:function(nodeUri,node,$node){return!(!($node.length&&"partial"===$node.data("access")||"denied"===$node.data("access"))||permissionsManager.hasPermission(nodeUri,"WRITE")||(feedback().warning(__("You are not allowed to write in the class %s",node.label)),0))}}).on("query",function(params){var self=this;params.classOnly=!0,resourceProvider.getResources(params,!0).then(function(resources){self.update(resources,params)}).catch(function(err){self.trigger("error",err)})}).on("select",function(destinationClassUri){var self=this;_.isEmpty(destinationClassUri)||(
this.disable(),resourceProvider.copyTo(actionContext.id,destinationClassUri).then(function(result){return result&&result.uri?(feedback().success(__("Resource copied")),actionContext.tree&&$(actionContext.tree).trigger("refresh.taotree",[result]),resolve(result)):reject(new Error(__("Unable to copy the resource")))}).catch(function(err){self.trigger("error",err)}))}).on("error",reject)})})}}),define("layout/actions",["jquery","lodash","core/eventifier","core/promise","lib/uuid","layout/actions/binder","layout/actions/common","layout/permissions"],function($,_,eventifier,Promise,uuid,binder,commonActions,permissionsManager){"use strict";var actions={},
resourceContext={};return eventifier({init:function($scope){$scope&&$scope.length?this.$scope=$scope:this.$scope=$(document),commonActions(),this._lookup(),this.updateContext(),this._listenUpdates(),this._bind()},_lookup:function(){var self=this;$(".action-bar .action",this.$scope).each(function(){var id,$this=$(this);if($this.data("action")){if($this.attr("id"))id=$this.attr("id");else{for(;id="action-"+uuid(8,16),self._actions[id];);$this.attr("id",id)}actions[id]={id:id,name:$this.attr("title"),binding:$this.data("action"),url:$("a",$this).attr("href"),context:$this.data("context"),multiple:$this.data("multiple"),rights:$this.data("rights"),state:{
disabled:$this.hasClass("disabled"),hidden:$this.hasClass("hidden"),active:$this.hasClass("active")}}}})},_bind:function(){var self=this,actionSelector=this.$scope.selector+" .action-bar .action";$(document).off("click",actionSelector).on("click",actionSelector,function(e){var selected;e.preventDefault(),(selected=actions[$(this).attr("id")])&&!1===selected.state.disabled&&!1===selected.state.hidden&&self.exec(selected)})},_listenUpdates:function(){var self=this,treeSelector=this.$scope.selector+" .tree";$(document).off("change.taotree.actions",treeSelector).on("change.taotree.actions",treeSelector,function(e,context){(context=context||{}).tree=this,
self.updateContext(context)})},updateContext:function(context){var current;context=context||{},_.isArray(context)?_.forEach(actions,function(action){var hasClasses=_.some(context,{type:"class"}),hasInstances=_.some(context,{type:"instance"}),hasPermissionDenied=_.some(context,function(resource){return permissionsManager.isContextAllowed(action.rights,resource)});action.multiple&&!hasPermissionDenied&&"none"!==action.context&&("*"===action.context||"resource"===action.context||"instance"===action.context&&hasInstances&&!hasClasses||"class"===action.context&&hasClasses&&!hasInstances)?action.state.hidden=!1:action.state.hidden=!0}):(
current=context.type?context.type:context.uri?"instance":context.classUri?"class":"none",_.forEach(actions,function(action){var allowed=permissionsManager.isContextAllowed(action.rights,context);action.multiple||!1===allowed||"none"===current&&"*"!==action.context||"*"!==action.context&&"resource"!==action.context&&current!==action.context?action.state.hidden=!0:action.state.hidden=!1})),resourceContext=context,this.updateState()},updateState:function(){_.forEach(actions,function(action,id){var $elt=$("#"+id);_.forEach(["hidden","disabled","active"],function(state){!0===action.state[state]?$elt.addClass(state):$elt.removeClass(state)})})},exec:function(
action,context){var self=this;if(_.isString(action)&&(action=_.isPlainObject(actions[action])?actions[action]:_.find(actions,{name:action})),_.isPlainObject(action))return _.forEach(actions,function(otherAction){otherAction.state.active=!1}),action.state.active=!0,this.updateState(),Promise.resolve(binder.exec(action,context||resourceContext)).then(function(actionData){var events=[action.id,action.binding];self.trigger(events.join(" "),context||resourceContext,actionData)}).catch(function(err){if(err&&err.cancel)return self.trigger("cancel",action.id);self.trigger("error",err)})},getBy:function(actionName){return _.isPlainObject(actions[actionName]
...
data:data}))||0===stack1)&&(buffer+=stack1),buffer+="\n                    </tr>\n                "},data,depth0),data:data}))||0===stack1)&&(buffer+=stack1),buffer+='\n            </tbody>\n        </table>\n    </div>\n    <div class="datatable-pagination-bottom"></div>\n</div>\n'})}),define("tpl!ui/datatable/tpl/button",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){this.compilerInfo=[4,">= 1.0.0"],helpers=this.merge(helpers,Handlebars.helpers),data=data||{};var stack1,helper,buffer="",functionType="function",escapeExpression=this.escapeExpression;return buffer+='<button class="btn-info small ',stack1=(
helper=helpers.id)?helper.call(depth0,{hash:{},data:data}):typeof(helper=depth0&&depth0.id)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+'"',((stack1=helpers.if.call(depth0,depth0&&depth0.title,{hash:{},inverse:this.noop,fn:this.program(1,function(depth0,data){var stack1,helper,buffer="";return buffer+=' title="',stack1=(helper=helpers.title)?helper.call(depth0,{hash:{},data:data}):typeof(helper=depth0&&depth0.title)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+'"'},data),data:data}))||0===stack1)&&(buffer+=stack1),buffer+=">",((stack1=helpers.if.call(depth0,
depth0&&depth0.icon,{hash:{},inverse:this.noop,fn:this.program(3,function(depth0,data){var stack1,helper,buffer="";return buffer+='<span class="icon-',stack1=(helper=helpers.icon)?helper.call(depth0,{hash:{},data:data}):typeof(helper=depth0&&depth0.icon)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+'"></span> '},data),data:data}))||0===stack1)&&(buffer+=stack1),((stack1=helpers.if.call(depth0,depth0&&depth0.label,{hash:{},inverse:this.noop,fn:this.program(5,function(depth0,data){var stack1,helper;return stack1=(helper=helpers.label)?helper.call(depth0,{hash:{},data:data}):typeof(helper=depth0&&depth0.label
)===functionType?helper.call(depth0,{hash:{},data:data}):helper,escapeExpression(stack1)},data),data:data}))||0===stack1)&&(buffer+=stack1),buffer+="</button>\n"})}),define("tpl!ui/pagination/providers/tpl/pages",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){this.compilerInfo=[4,">= 1.0.0"],data=data||{};var helper,options,buffer="",helperMissing=(helpers=this.merge(helpers,Handlebars.helpers)).helperMissing,escapeExpression=this.escapeExpression
...
"layout/tree/provider/jstree",["jquery","lodash","i18n","context","core/store","core/promise","util/url","layout/generisRouter","layout/actions","layout/section","layout/permissions","ui/feedback","uri","jquery.tree","lib/jsTree/plugins/jquery.tree.contextmenu"],function($,_,__,context,store,Promise,urlUtil,generisRouter,actionManager,sectionManager,permissionsManager,feedback,uri){"use strict";return{name:"jstree",init:function($container,options){var lastOpened,lastSelected,moreNode={data:__("More"),type:"more",attributes:{class:"more"}},serverParams=_.defaults(options.serverParameters||{},{extension:context.shownExtension,
perspective:context.shownStructure,section:context.section,classUri:options.rootClassUri?options.rootClassUri:void 0,hideInstances:options.hideInstances||0,filter:"*",offset:0,limit:30}),events={refresh:function(data){var treeState,node,tree=$.tree.reference($container);if(tree){if(data&&data.loadNode&&(node=$container.find('[data-uri="'+data.loadNode+'"]')).length)return void tree.select_branch(node);treeState=_.merge($container.data("tree-state")||{},data),treeState=_.omit(treeState,"selectNode"),data&&data.loadNode?(tree.deselect_branch(tree.selected),tree.settings.selected=!1,treeState.selectNode=data.loadNode):data&&data.selectNode&&(
tree.deselect_branch(tree.selected),tree.settings.selected=!1),setTreeState(treeState),tree.refresh()}},rollback:function(){var treeState,tree=$.tree.reference($container);tree&&((treeState=$container.data("tree-state")).rollback?(tree.rollback(treeState.rollback),setTreeState(_.omit(treeState,"rollback"))):$container.trigger("refresh.taotree"))},addnode:function(data){var tree=$.tree.reference($container),parentNode=tree.get_node($("#"+uri.encode(data.parent),$container).get(0)),params=_.clone(serverParams);params.classUri=data.parent,"node-class"===data.cssClass?params.hideInstances=1:params.loadNode=data.uri,$.ajax(tree.settings.data.opts.url,{
type:tree.settings.data.opts.method,dataType:tree.settings.data.type,async:tree.settings.data.async,data:params,success:function(response){var treeData=getTreeData(response),items=treeData.children||treeData,node=_.filter(items,function(child){return child.attributes&&child.attributes["data-uri"]===data.uri});node.length&&tree.select_branch(tree.create(node[0],parentNode))}})},removenode:function(data){var tree=$.tree.reference($container),node=tree.get_node($("#"+data.id,$container).get(0));tree.remove(node)},selectnode:function(data){var tree=$.tree.reference($container),node=tree.get_node($("#"+data.id,$container).get(0));$("li a",$container).removeClass(
"clicked"),tree.select_branch(node)},openbranch:function(data){var tree=$.tree.reference($container),node=tree.get_node($("#"+data.id,$container).get(0));$("li a",$container).removeClass("clicked"),tree.open_branch(node)}},treeOptions={data:{type:"json",async:!0,opts:{method:"GET",url:options.url}},ui:{theme_name:"css",theme_path:context.taobase_www+"js/lib/jsTree/themes/css/style.css"},types:{default:{renameable:!1,deletable:!0,creatable:!0,draggable:function($node){return $node.hasClass("node-instance")&&!$node.hasClass("node-undraggable")&&options.actions&&options.actions.moveInstance}}},callback:{ondelete:function(){$container.trigger("delete.taotree",
Array.prototype.slice.call(arguments))},beforedata:function($node){var treeData=$container.data("tree-state"),params=_.clone(serverParams);return $node&&$node.length&&(params.classUri=$node.data("uri")),lastSelected&&(params.selected=lastSelected),treeData&&(_.isString(treeData.filter)&&treeData.filter.length&&(params.filter=treeData.filter,treeData=_.omit(treeData,"filter")),_.isString(treeData.loadNode)&&treeData.loadNode.length&&(params.selected=treeData.loadNode,treeData.selectNode=uri.encode(treeData.loadNode),treeData=_.omit(treeData,"loadNode")),setTreeState(treeData)),params},ondata:function(data){var treeData;return data.error?(feedback().error(
data.error),[]):((treeData=getTreeData(data)).children&&(treeData.state="open"),computeSelectionAccess(treeData),needMore(treeData),addTitle(treeData),treeData)},onload:function(tree){var $lastSelected,$selectNode,$firstClass=$(".node-class:not(.private):first",$container),$firstInstance=$(".node-instance:not(.private):first",$container),selectNode=($container.data("tree-state")||{}).selectNode||options.selectNode,nodeSelection=function(){if(selectNode){if(($selectNode=$("#"+selectNode,$container)).length&&!$selectNode.hasClass("private"))return tree.select_branch($selectNode)}else if(void 0!==tree.selected)return tree.selected;return lastSelected&&(
$lastSelected=$("#"+lastSelected,$container)).length&&!$lastSelected.hasClass("private")?(lastSelected=null,tree.select_branch($lastSelected)):$firstInstance.length?tree.select_branch($firstInstance):tree.select_branch($(".node-class,.node-instance",$container).get(0))};$firstClass.hasClass("leaf")?tree.select_branch($firstClass):tree.open_branch($firstClass,!1,function(){_.delay(nodeSelection,10)}),$container.trigger("ready.taotree")},oninit:function(){options.actions&&options.actions.init&&actionManager.exec(options.actions.init,{uri:$container.data("rootnode")})},beforeopen:function(node){lastOpened=$(node)},onselect:function(node,tree){var $node=$(node),
...
actionManager,versionWarning,loadingBar,nav,search,treeLoader,sectionHeight){"use strict";var logger=loggerFactory("controller/main");return{start:function(){var config=module.config(),$doc=$(document);versionWarning.init(),generisRouter.init(),$doc.ajaxSend(function(){loadingBar.start()}),$doc.ajaxComplete(function(){loadingBar.stop()}),nav.init(),actionManager.on("error",function(err){logger.error(err),feedback().error(err)}),sections.on("activate",function(section){if(window.scrollTo(0,0),section&&section.id)switch(context.section=section.id,actionManager.init(section.panel),search.init(),section.type){case"tree":section.panel.addClass("content-panel"),
sectionHeight.init(section.panel),$(".taotree",section.panel).each(function(){var $treeElt=$(this),$actionBar=$(".tree-action-bar-box",section.panel);(function($container,section){var treeProvider,treeActions=_.reduce($container.data("actions"),function(acc,id,key){var action=actionManager.getBy(id);return action&&(acc[key]=action),acc},{}),treeUrl=urlUtil.build([context.root_url,$container.data("url")]),treeType=$container.data("type");return treeProvider=treeLoader(treeType),treeType||$container.data("type",treeProvider.name),treeProvider.init($container,{id:$container.attr("id"),url:treeUrl,rootClassUri:$container.data("rootnode"),icon:$container.data(
"icon"),actions:treeActions,sectionId:section.id,loadNode:section.defaultUri})})($treeElt,section).then(function(){$actionBar.addClass("active"),sectionHeight.setHeights(section.panel)}).catch(function(err){logger.error(err)})}),$(".navi-container",section.panel).show();break;case"content":this.loadContentBlock()}}).init(),helpers.init(),uiForm.init(),config&&_.isArray(config.extraRoutes)&&config.extraRoutes.length&&router.dispatch(config.extraRoutes)}}}),define("controller/passwordRecovery",["jquery","i18n","module","ui/feedback","layout/version-warning"],function($,__,module,feedback,versionWarning){"use strict";var feedbackType,conf=module.config();if(
versionWarning.init(),conf.message)for(feedbackType in conf.message)conf.message[feedbackType]&&feedback()[feedbackType](conf.message[feedbackType])}),define("controller/routes",[],function(){"use strict";return{Main:{actions:{index:"controller/main",entry:"controller/entry",getSectionActions:"controller/main/actions",getSectionTrees:"controller/main/trees",login:"controller/login"}},PasswordRecovery:{actions:{index:"controller/passwordRecovery"}},Lock:{actions:{locked:"controller/Lock/locked"}},ExtensionsManager:{actions:{index:"controller/settings/extensionManager"}},Users:{deps:"controller/users/disable-edit",actions:{index:"controller/users/index",
add:"controller/users/add"}}}}),define("controller/settings/extensionManager",["jquery","i18n","context","helpers","ui/feedback"],function($,__,context,helpers,feedback){var ext_installed=[],toInstall=[],indexCurrentToInstall=-1,percentByExt=0,installError=0;function progressConsole(msg){$("#installProgress .console").append("<p>"+msg+"</p>"),$("#installProgress .console").prop({scrollTop:$("#installProgress .console").prop("scrollHeight")})}function installNextExtension(){var ext=toInstall[indexCurrentToInstall];$("#installProgress p.status").text(__("Installing extension %s...").replace("%s",ext)),progressConsole(__("Installing extension %s...").replace(
"%s",ext)),$.ajax({type:"POST",url:helpers._url("install","ExtensionsManager","tao"),data:"id="+ext,dataType:"json",success:function(data){helpers.loaded(),data.success?(progressConsole(__("> Extension %s succesfully installed.").replace("%s",ext)),$("li.ext-id.ext-"+ext).addClass("installed"),$("tr#"+ext).slideUp("normal",function(){var $tr=$("<tr></tr>").appendTo($("#extensions-manager-container tbody")).hide(),$orig=$("tr#"+ext+" td");$tr.append('<td class="ext-id bordered">'+$($orig[0]).text()+"</td>"),$tr.append('<td class="author">'+$($orig[1]).text()+"</td>"),$tr.append('<td class="version">'+$($orig[2]).text()+"</td>"),$tr.slideDown("normal",
function(){var $noAvailableExtElement;$("tr#"+ext).remove(),styleTables(),0==$("#available-extensions-container table tbody tr").length&&(($noAvailableExtElement=$("<div/>")).attr("id","noExtensions").addClass("ui-state-highlight").text(__("No extensions available.")),$("#available-extensions-container").empty().append($noAvailableExtElement)),$("#installProgress .bar").animate({width:"+="+percentByExt+"%"},1e3,function(){++indexCurrentToInstall>=toInstall.length?(toInstall=[],$("#installProgress .bar").animate({backgroundColor:"#bb6",width:"100%"},1e3),(progressConsole(__("Post install processing")),$.ajax({type:"GET",url:helpers._url("postInstall",
"ExtensionsManager","tao")})).done(function(data){helpers.loaded(),$("#installProgress .bar").animate({backgroundColor:"#6b6"},1e3),$("#installProgress p.status").text(__("Installation done.")),progressConsole(__("> Installation done.")),progressConsole(__("... reloading page.")),setTimeout(function(){window.location.reload(!0)},1e3)})):installNextExtension()})})})):(installError=1,progressConsole("Installation of "+ext+" failed")),feedback().info(data.message)}}),installError&&progressConsole(__("A fatal error occured during the installation process."))}function styleTables(){$("#Extensions_manager table tr").removeClass("extensionOdd").removeClass(
"extensionEven"),$("#Extensions_manager table tr:nth-child(even)").addClass("extensionEven"),$("#Extensions_manager table tr:nth-child(odd)").addClass("extensionOdd")}return{start:function(){styleTables(),$("#installProgress").hide(),$("#extensions-manager-container .ext-id").each(function(){var ext=$(this).text();ext_installed.push(ext),$(".ext-id.ext-"+ext).addClass("installed")}),$("#available-extensions-container tr input").click(function(event){event.stopPropagation()}),$("#available-extensions-container tr input:checkbox").click(function(){var $installButton=$("#installButton");0<$(this).parent().parent().parent().find("input:checkbox:checked"
).length?$installButton.attr("disabled",!1):$installButton.attr("disabled",!0)}),$("#available-extensions-container #installButton").click(function(event){if(toInstall=[],$("#available-extensions-container input:checked").each(function(){var ext=$(this).prop("name").split("_")[1],deps=function getDependencies(extension){var dependencies=[];return $("#"+extension+" .dependencies li:not(.installed)").each(function(){var ext=$(this).attr("rel"),deps=getDependencies(ext);deps.push(ext),dependencies=dependencies.concat(deps)}),dependencies}(ext);deps.length&&(toInstall=toInstall.concat(deps)),toInstall.push(ext)}),!(toInstall=function(orig){for(var a=[],
i=0;i<orig.length;i++)$.inArray(orig[i],a)<0&&a.push(orig[i]);return a}(toInstall)).length)return window.alert(__("Nothing to install !")),!1;percentByExt=100/toInstall.length,$("#installProgress p.status").text(__("%s extension(s) to install.").replace("%s",toInstall.length)),$("#installProgress .bar").width(0),$("#installProgress .console").empty(),progressConsole(__("Do you wish to install the following extension(s):\n%s?").replace("%s",toInstall.join(", "))),$("#installProgress").dialog({modal:!0,width:400,height:300,buttons:[{text:__("No"),click:function(){$(this).dialog("close")}},{text:__("Yes"),click:function(){progressConsole(__(
"Preparing installation...")),$(".ui-dialog-buttonpane").remove(),indexCurrentToInstall=installError=0,installNextExtension()}}]}),event.preventDefault()})}}}),define("users",["jquery","i18n","context"],function($,__,context){return{checkLogin:function(id,url){var $login=$("input[id='"+id+"']");0<$login.length&&$login.blur(function(){var elt=$(this),trimmedValue=elt.val().replace(/^\s+/g,"").replace(/\s+$/g,""),value=elt.val();""===trimmedValue?$("span.login-info").remove():$.postJson(url,{login:value},function(data){$("span.login-info").remove(),data.available?elt.after("<span class='login-info'><img src='"+context.taobase_www+"img/tick.png' /> "+__(
"Login available")+"</span>"):elt.after("<span class='login-info ui-state-error'><img src='"+context.taobase_www+"img/exclamation.png' class='icon' /> "+__("This Login is already in use")+"</span>")})})}}}),define("controller/users/add",["jquery","module","helpers","users"],function($,module,helpers,users){"use strict";return{start:function(){var conf=module.config(),url=helpers._url("checkLogin","Users","tao");users.checkLogin(conf.loginId,url),!0===conf.exit&&setTimeout(function(){window.location=helpers._url("index","Main","tao",{structure:"users",ext:"tao",section:"list_users"})},1e3)}}}),define("controller/users/disable-edit",["layout/section"],
function(section){"use strict";return{start:function(){section.get("edit_user").disable()}}}),define("controller/users/index",["module","jquery","i18n","util/url","layout/section","ui/feedback","ui/dialog/confirm","ui/datatable"],function(module,$,__,urlHelper,section,feedback,dialogConfirm){"use strict";var runUserAction=function(uri,action,confirmMessage){var tokenName=module.config().xsrfTokenName,data={};data.uri=uri,data[tokenName]=$.cookie(tokenName),dialogConfirm(confirmMessage,function(){$.ajax({url:urlHelper.route(action,"Users","tao"),data:data,type:"POST"}).done(function(response){response.success?feedback().success(response.message):feedback(
).error(response.message),$("#user-list").datatable("refresh")})})},editUser=function(uri){section.get("edit_user").enable().loadContentBlock(urlHelper.route("edit","Users","tao"),{uri:uri}).show()},removeUser=function(uri,row){runUserAction(uri,"delete",__("Please confirm deletion of user %s",row.login))},lockUser=function(uri,row){runUserAction(uri,"lock",__("Please confirm locking of account %s",row.login))},unlockUser=function(uri,row){runUserAction(uri,"unlock",__("Please confirm unlocking of account %s",row.login))};return{start:function(){var $userList=$("#user-list");section.on("show",function(section){"list_users"===section.id&&$userList.datatable(
"refresh")});var actions={edit:editUser,remove:removeUser,lock:lockUser,unlock:unlockUser};$userList.on("load.datatable",function(e,dataset){_.forEach(dataset.data,function(row){var lockBtn='[data-item-identifier="'+row.id+'"] button.lock',unlockBtn='[data-item-identifier="'+row.id+'"] button.unlock';row.lockable?$(row.locked?lockBtn:unlockBtn,$userList).hide():_.forEach([lockBtn,unlockBtn],function(btn){$(btn,$userList).hide()})})}).datatable({url:urlHelper.route("data","Users","tao"),paginationStrategyBottom:"pages",filter:!0,actions:actions,model:[{id:"login",label:__("Login"),sortable:!0},{id:"firstname",label:__("First Name"),sortable:!0},{
id:"lastname",label:__("Last Name"),sortable:!0},{id:"email",label:__("Email"),sortable:!0},{id:"roles",label:__("Roles"),sortable:!1},{id:"dataLg",label:__("Data Language"),sortable:!0,visible:$userList.data("user-data-lang-enabled")},{id:"guiLg",label:__("Interface Language"),sortable:!0},{id:"status",label:__("Account status"),sortable:!0,transform:function(value){return'<span class="icon-'+("enabled"===value?"result-ok":"lock")+'"></span> '+value}}]})}}}),function(){"use strict";var reqFeedback=document.getElementById("browser-check"),tests=[{name:"ES5 Global JSON",test:function(){
return"JSON"in window&&"function"==typeof JSON.parse&&"function"==typeof JSON.stringify}},{name:"ES5 Extension",test:function(){return"function"==typeof Function.prototype.bind&&"function"==typeof String.prototype.trim}},{name:"localstorage",test:function(){return"localStorage"in window}},{name:"querySelector",test:function(){return"querySelector"in window.document&&"querySelectorAll"in window.document}},{name:"file reader",test:function(){return"File"in window&&"FileReader"in window}}],testCounter=0;if(document.documentElement.className=document.documentElement.className.replace("no-js",""),reqFeedback)for(;testCounter<tests.length;){if(
"function"==typeof tests[testCounter].test&&!tests[testCounter].test()){reqFeedback.style.display="block",reqFeedback.className=reqFeedback.className.replace("hidden",""),document.documentElement.className=document.documentElement.className+" no-js";break}testCounter++}}(),define("layout/requirement-check",function(){}),define("report",["jquery","context","i18n"],function($,context,__){"use strict";return{fold:function(){var $content=$(".report > .feedback-nesting-0 > div"),$top=$(".report > .feedback-nesting-0");"none"===$content.css("display")?($content.css("display","block"),$top.css("background-color","transparent"),$top.css("border-color","transparent")
,$("#fold > span.check-txt").text(__("Hide detailed report"))):($content.css("display","none"),$top.hasClass("feedback-success")?($top.css("border-color","#3ea76f"),$top.css("background-color","#e6f4ed")):$top.hasClass("feedback-warning")?($top.css("border-color","#dfbe7b"),$top.css("background-color","#fbf6ee")):$top.hasClass("feedback-error")?($top.css("border-color","#c74155"),$top.css("background-color","#f8e7e9")):($top.css("border-color","#3e7da7"),$top.css("background-color","#e6eef4")),$("#fold > span.check-txt").text(__("Show detailed report")))}}}),define("serviceApi/PseudoStorage",[],function(){function PseudoStorage(){}
return PseudoStorage.prototype.get=function(callback){return"function"==typeof callback&&callback(null),null},PseudoStorage.prototype.set=function(state,callback){"function"==typeof callback&&callback()},PseudoStorage}),define("serviceApi/ServiceApi",["jquery","urlParser"],function($,UrlParser){"use strict";function ServiceApi(baseUrl,parameters,serviceCallId,stateStorage,userService,paused){this.baseUrl=baseUrl,this.parameters=parameters,this.connected=!1,this.serviceCallId=serviceCallId,this.state=stateStorage,this.userService=userService,this.hasBeenPaused=paused}return ServiceApi.SIG_SUCCESS=0,ServiceApi.SIG_ERROR=1,
