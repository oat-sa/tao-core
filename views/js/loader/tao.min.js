...
)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+'"></span> '}return((stack1=helpers.each.call(depth0,depth0&&depth0.buttons,{hash:{},inverse:self.noop,fn:self.program(1,function(depth0,data){var stack1,helper,buffer="";return buffer+='\r\n    <button class="btn-',stack1=(helper=helpers.type)?helper.call(depth0,{hash:{},data:data}):typeof(helper=depth0&&depth0.type)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+" small ",stack1=(helper=helpers.id)?helper.call(depth0,{hash:{},data:data}):typeof(helper=depth0&&depth0.id)===functionType?helper.call(depth0,{hash:{},
data:data}):helper,buffer+=escapeExpression(stack1)+'" data-control="',stack1=(helper=helpers.id)?helper.call(depth0,{hash:{},data:data}):typeof(helper=depth0&&depth0.id)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+'" type="button">\r\n        ',((stack1=helpers.if.call(depth0,depth0&&depth0.icon,{hash:{},inverse:self.noop,fn:self.program(2,program2,data),data:data}))||0===stack1)&&(buffer+=stack1),buffer+='\r\n        <span class="label">',stack1=(helper=helpers.label)?helper.call(depth0,{hash:{},data:data}):typeof(helper=depth0&&depth0.label)===functionType?helper.call(depth0,{hash:{},data:data}):helper,
...
"layout/logout-event"],function(_,$,historyRouterFactory,loggerFactory,eventifier,statifier,urlUtil,feedback,logoutEvent){"use strict";var historyRouter,redirectUrl,appLogger=loggerFactory("controller/app"),appController=eventifier(statifier({start:function(options){var currentRoute;appController.apply(),currentRoute=options&&options.forwardTo?options.forwardTo:window.location+"",options&&options.redirectUrl&&(redirectUrl=options.redirectUrl||{}),historyRouter.forward(currentRoute)},apply:function(selector,target){return selector=selector||".router",target=target||document,$(target).off("click.appController").on("click.appController",selector,function(e){
var $elt,href;e.preventDefault(),(href=($elt=$(this)).attr("href"))||(href=$("[href]:first-child",$elt).attr("href")),href&&historyRouter.redirect(href)}),this},getRouter:function(){return historyRouter},getLogger:function(){return appLogger},onError:function(err){var message=err&&err.message||err,options={message:message};return appLogger.error(err),403===err.code?(options=_.defaults(options,redirectUrl||{}),logoutEvent(options)):feedback().error(message),this}}));return historyRouter=historyRouterFactory().on("dispatching",function(url){appController.setState("dispatching"),appController.trigger("change",url)}).on("dispatched",function(url){
appController.setState("dispatching",!1),appController.trigger("started",url)}),appController}),define("layout/loading-bar",["jquery"],function($){"use strict";var $loadingBar=$(".loading-bar"),originalHeight=$loadingBar.height(),$win=$(window),$doc=$(document),$contentWrap=$(".content-wrap"),headerElements={$versionWarning:$contentWrap.find(".version-warning"),$header:$contentWrap.find("header:first()")},headerHeight=getHeaderHeight(headerElements);function getHeaderHeight(headerElements){var $element;for($element in headerHeight=0,headerElements)headerElements[$element].length&&headerElements[$element].is(":visible")&&(
headerHeight+=headerElements[$element].outerHeight());return headerHeight}function updateHeight(){$loadingBar.hasClass("loading")&&((headerHeight=getHeaderHeight(headerElements))<=$win.scrollTop()?$loadingBar.addClass("fixed"):$loadingBar.removeClass("fixed"),$loadingBar.hasClass("loadingbar-covered")?$loadingBar.height($doc.height()):$loadingBar.height(""))}return $win.on("scroll.loadingbar",function(){updateHeight()}),{start:function(covered){void 0===covered&&(covered=!0),$loadingBar.hasClass("loading")&&$loadingBar.stop(),$loadingBar.addClass("loading"),$loadingBar.toggleClass("loadingbar-covered",covered),updateHeight()},stop:function(){
$loadingBar.removeClass("loading fixed").height(originalHeight)}}}),define("helpers",["lodash","jquery","context","layout/loading-bar","jqueryui"],function(_,$,context,loadingBar){"use strict";return{init:function(){$.postJson=function(url,data,callback){$.post(url,data,callback,"json")}},getMainContainer:function(){var sectionIndex;return console.warn("deprecated, use section instead"),context.section||(sectionIndex=$(".section-container").tabs("options","selected"),$(".content-panel").eq(sectionIndex).find(".content-block")),$("#panel-"+context.section+" .content-block")},getMainContainerSelector:function($tabs){console.warn(
"deprecated, use section instead");var $container=this.getMainContainer();return!!($container&&0<$container.length)&&$container.selector},selectTabByName:function(name){console.warn("deprecated, use section instead"),$("#"+name).click()},getTabIndexByName:function(name){console.warn("deprecated, use section instead");for(var elts=$("div#tabs ul.ui-tabs-nav li a"),i=0;i<elts.length;){var elt=elts[i];if(elt&&elt.id&&elt.id===name)return i;i++}return-1},openTab:function(title,url,open){console.warn("deprecated, use section instead"),open=open||!0;var idx=this.getTabIndexByUrl(url),$tabs=$("#tabs");-1==idx&&($tabs.tabs("add",url,title),idx=$tabs.tabs("length")-1
),open&&$tabs.tabs("select",idx)},getTabIndexByUrl:function(url){console.warn("deprecated, use section instead");var elts=$("#tabs ul.ui-tabs-nav li a"),i=0,ret=-1;return elts.each(function(){var href=$.data(this,"href.tabs");url!==href?i++:ret=i}),ret},closeTab:function(index){console.warn("deprecated, use section instead"),-1<index&&$("#tabs").tabs("remove",index)},updateTabUrl:function(tabObj,tabName,url){console.warn("deprecated, use section instead");var index=this.getTabIndexByName(tabName);tabObj.tabs("url",index,url),tabObj.tabs("enable",index)},loading:function(){console.warn("deprecated, this should be automated"),$(window).on("click",function(e){
return e.stopPropagation(),e.preventDefault(),!1}),loadingBar.start()},loaded:function(){console.warn("deprecated, this should be automated"),$(window).off("click"),loadingBar.stop()},_load:function(selector,url,data){url=url||"",data?data.nc=(new Date).getTime():data={nc:(new Date).getTime()},$(selector).hide().empty().show(),-1===url.indexOf("?")?$(selector).load(url,data):(url+="&"+$.param(data),$(selector).load(url))},_href:function(ref){return-1<ref.indexOf("?")?ref+"&nc="+(new Date).getTime():ref+"?nc="+(new Date).getTime()},_autoFx:function(){console.warn("deprecated"),setTimeout(function(){$(".auto-highlight").effect("highlight",{color:"#9FC9FF"},
2500)},1e3),setTimeout(function(){$(".auto-hide").fadeOut("slow")},3e3),setTimeout(function(){$(".auto-slide").slideUp(1500)},11e3)},textCutter:function(selector,maxLength){console.warn("deprecated, use css instead"),maxLength||(maxLength=100),$(selector).each(function(){$(this).text().length>maxLength&&!$(this).hasClass("text-cutted")&&($(this).prop("title",$(this).text()),$(this).css("cursor","pointer"),$(this).html($(this).text().substring(0,maxLength)+"[...<img src='"+context.taobase_www+"img/bullet_add.png' />]"),$(this).addClass("text-cutted"))})},createMessage:function(message){console.warn("deprecated, use feedback instead"),$("#info-box").length?$(
"#info-box").html(message).show():$("body").append("<div id='info-box' class='ui-widget-header ui-corner-all auto-slide' >"+message+"</div>"),this._autoFx()},createErrorMessage:function(message){this.createMessage(message),$("#info-box").addClass("ui-state-error")},createInfoMessage:function(message){this.createMessage(message),$("#info-box").removeClass("ui-state-error")},isFlashPluginEnabled:function(){return void 0!==navigator.plugins&&"object"==typeof navigator.plugins["Shockwave Flash"]||window.ActiveXObject&&!1!==new window.ActiveXObject("ShockwaveFlash.ShockwaveFlash")},loadCss:function(url){console.warn("deprecated");var link=document.createElement(
"link");link.type="text/css",link.rel="stylesheet",link.href=url,document.getElementsByTagName("head")[0].appendChild(link)},_url:function(action,controller,extension,params){var url;if("string"!=typeof action||"string"!=typeof controller||"string"!=typeof extension)throw new TypeError("All parts are required to build an URL");return url=context.root_url+extension+"/"+controller+"/"+action,_.isString(params)?url+="?"+params:_.isPlainObject(params)&&(url+="?"+$.param(params)),url}}}),define("tpl!ui/deleter/undo",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){this.compilerInfo=[4,">= 1.0.0"],helpers=this.merge(
helpers,Handlebars.helpers),data=data||{};var helper,options,buffer="",escapeExpression=this.escapeExpression,helperMissing=helpers.helperMissing;return buffer+='<div class="undobox feedback-info">\r\n    <span class="icon-info"></span>\r\n        ',buffer+=escapeExpression((helper=helpers.undoMessage)?helper.call(depth0,{hash:{},data:data}):"function"==typeof(helper=depth0&&depth0.undoMessage)?helper.call(depth0,{hash:{},data:data}):helper)+'\r\n        <a class="undo" href="#">'+escapeExpression((options={hash:{},data:data},(helper=helpers.__||depth0&&depth0.__)?helper.call(depth0,"Undo",options):helperMissing.call(depth0,"__","Undo",options))
)+'</a>\r\n    <span title="'+escapeExpression((options={hash:{},data:data},(helper=helpers.__||depth0&&depth0.__)?helper.call(depth0,"Remove Message",options):helperMissing.call(depth0,"__","Remove Message",options)))+'" class="icon-close" data-close=":parent .undobox"></span>\r\n</div>\r\n'})}),define("lib/gamp/gamp",[],function(){"use strict";function gamp(){for(var val,digits,point,i=arguments.length-1,factor=-1/0;0<=i;)factor=Math.max(factor,(val=arguments[i--],digits=void 0,digits=String(val),(point=digits.indexOf("."))<0?1:Math.pow(10,digits.length-point-1)));return Math.abs(factor)}return gamp.normalize=function(val,factor){return Math.round(
factor*Number(val))},gamp.round=function(val,digits){return Number(Number(val).toPrecision(void 0===digits?16:digits))},gamp.add=function(a,b){var factor=gamp(a,b);return gamp.round((gamp.normalize(a,factor)+gamp.normalize(b,factor))/factor)},gamp.sub=function(a,b){var factor=gamp(a,b);return gamp.round((gamp.normalize(a,factor)-gamp.normalize(b,factor))/factor)},gamp.mul=function(a,b){var factor=gamp(a,b);return gamp.round(gamp.normalize(a,factor)*gamp.normalize(b,factor)/(factor*factor),15)},gamp.div=function(a,b){var factor=gamp(a,b);return gamp.round(gamp.normalize(a,factor)/gamp.normalize(b,factor))},gamp.pow=function(a,b){var factor=gamp(a),
ta=gamp.normalize(a,factor),ib=Math.floor(b),fb=b-ib,res=ib?Math.pow(ta,ib)/Math.pow(factor,ib):1;return fb&&(res=gamp.div(gamp.mul(res,Math.pow(ta,fb)),Math.pow(factor,fb))),gamp.round(res,15)},gamp}),function(root,factory){"function"==typeof define&&define.amd?define("lib/polyfill/svg4everybody/svg4everybody",[],function(){return root.svg4everybody=factory()}):"object"==typeof exports?module.exports=factory():root.svg4everybody=factory()}(this,function(){function embed(svg,target){if(target){var fragment=document.createDocumentFragment(),viewBox=!svg.getAttribute("viewBox")&&target.getAttribute("viewBox");viewBox&&svg.setAttribute("viewBox",viewBox);for(
var clone=target.cloneNode(!0);clone.childNodes.length;)fragment.appendChild(clone.firstChild);var group=document.createElementNS("http://www.w3.org/2000/svg","g");group.setAttribute("class","use"),group.appendChild(fragment),svg.appendChild(group)}}function loadreadystatechange(xhr){xhr.onreadystatechange=function(){if(4===xhr.readyState){var cachedDocument=xhr._cachedDocument;cachedDocument||((cachedDocument=xhr._cachedDocument=document.implementation.createHTMLDocument("")).body.innerHTML=xhr.responseText,xhr._cachedTarget={}),xhr._embeds.splice(0).map(function(item){var target=xhr._cachedTarget[item.id];target||(
target=xhr._cachedTarget[item.id]=cachedDocument.getElementById(item.id)),embed(item.svg,target)})}},xhr.onreadystatechange()}return function(rawopts){var polyfill,opts=Object(rawopts);polyfill="polyfill"in opts?opts.polyfill:/\bTrident\/[567]\b|\bMSIE (?:9|10)\.0\b/.test(navigator.userAgent)||(navigator.userAgent.match(/\bEdge\/12\.(\d+)\b/)||[])[1]<10547||(navigator.userAgent.match(/\bAppleWebKit\/(\d+)\b/)||[])[1]<537;var requests={},requestAnimationFrame=window.requestAnimationFrame||setTimeout,uses=document.getElementsByTagName("use");polyfill&&function oninterval(){for(var index=0;index<uses.length;){var use=uses[index],svg=use.parentNode;if(
svg&&/svg/i.test(svg.nodeName)){var src=use.getAttribute("xlink:href");if(polyfill&&(!opts.validate||opts.validate(src,svg,use))){svg.removeChild(use);var srcSplit=src.split("#"),url=srcSplit.shift(),id=srcSplit.join("#");if(url.length){var xhr=requests[url];xhr||((xhr=requests[url]=new XMLHttpRequest).open("GET",url),xhr.send(),xhr._embeds=[]),xhr._embeds.push({svg:svg,id:id}),loadreadystatechange(xhr)}else embed(svg,document.getElementById(id))}}else++index}requestAnimationFrame(oninterval,67)}()}}),define("ui",["ui/toggler","ui/disabler","ui/adder","ui/deleter","ui/incrementer","ui/inplacer","ui/btngrouper","ui/durationer","ui/selecter","ui/modal",
"ui/tooltip","ui/form","ui/validator","ui/groupvalidator"],function(toggler,disabler,adder,deleter,incrementer,inplacer,btngrouper,durationer,selecter,modal,tooltip,form){"use strict";return{startEventComponents:function($container){adder($container),btngrouper($container),deleter($container),disabler($container),toggler($container),inplacer($container),modal($container),form($container),this.startDomComponent($container)},startDomComponent:function($container){incrementer($container),durationer($container),selecter($container),(/\bTrident\/[567]\b|\bMSIE (?:9|10)\.0\b/.test(navigator.userAgent)||(navigator.userAgent.match(/\bEdge\/12\.(\d+)\b/)||[]
)[1]<10547||(navigator.userAgent.match(/\bAppleWebKit\/(\d+)\b/)||[])[1]<537)&&require(["lib/polyfill/svg4everybody/svg4everybody"],function(svg4everybody){svg4everybody()}),tooltip($container)}}}),define("controller/backoffice",["jquery","lodash","i18n","context","helpers","core/router","ui","core/history","ui/feedback","layout/logout-event"],function($,_,__,context,helpers,router,ui,history,feedback,logoutEvent){"use strict";return{start:function(){var $doc=$(document),$container=$("body > .content-wrap");history.fixBrokenBrowsers(),$doc.ajaxComplete(function(event,request,settings){var urls,forward;_.contains(settings.dataTypes,"html")&&(urls=[
settings.url],(forward=request.getResponseHeader("X-Tao-Forward"))&&urls.push(forward),router.dispatch(urls,function(){ui.startDomComponent($container)}))}),router.dispatchUrl(helpers._url(context.action,context.module,context.extension)),$doc.ajaxError(function(event,request,settings){var ajaxResponse,errorMessage=__("Unknown Error");if(404!==request.status||"HEAD"!==settings.type){if(404===request.status||500===request.status)try{errorMessage=null!==(ajaxResponse=$.parseJSON(request.responseText)
)&&void 0!==ajaxResponse.success&&void 0!==ajaxResponse.type&&void 0!==ajaxResponse.message&&void 0!==ajaxResponse.data?request.status+": "+ajaxResponse.message:request.status+": "+request.responseText}catch(err){errorMessage=request.status+": "+request.responseText}403===request.status?logoutEvent():feedback().error(errorMessage)}}),ui.startEventComponents($container)}}}),define("controller/entry",["jquery","lodash","i18n","ui/feedback"],function($,_,__,feedback){"use strict";return{start:function(){var errorMessage=$("#entry-point-box").data("errormessage");errorMessage&&feedback().error(errorMessage)}}}),define("lock",["jquery","helpers"],function($,
helpers){function Lock(resourceUri){this.uri=resourceUri}return Lock.prototype.release=function(cb,err){var releaseUrl=helpers._url("release","Lock","tao"),options={data:{uri:this.uri},type:"POST",dataType:"json"};$.ajax(releaseUrl,options).success(cb).fail(err)},Lock}),define("layout/generisRouter",["jquery","lodash","core/eventifier","util/url"],function($,_,eventifier,urlUtil){"use strict";var topState,generisRouter=eventifier({pushSectionState:function(baseUrl,sectionId,restoreWith){var stateUrl,parsedUrl=urlUtil.parse(baseUrl),currentQuery=_.mapValues(parsedUrl.query,function(value,key){return"uri"===key?decodeURIComponent(value):value}),
newQuery=_.clone(currentQuery),baseUrlHasSection=currentQuery.section,newState={sectionId:sectionId,restoreWith:restoreWith||"activate",nodeUri:currentQuery.uri};baseUrlHasSection?sectionId!==currentQuery.section&&(newQuery.section=sectionId,delete newQuery.uri,delete newState.nodeUri):newQuery.section=sectionId,sectionId&&!_.isEqual(currentQuery,newQuery)&&(stateUrl=urlUtil.build(parsedUrl.path,newQuery),baseUrlHasSection?(window.history.pushState(newState,null,stateUrl),this.trigger("pushsectionstate",stateUrl)):(window.history.replaceState(newState,null,stateUrl),this.trigger("replacesectionstate",stateUrl)),topState=newState)},pushNodeState:function(
baseUrl,nodeUri){var stateUrl,parsedUrl=urlUtil.parse(baseUrl),currentQuery=_.mapValues(parsedUrl.query,function(value,key){return"uri"===key?decodeURIComponent(value):value}),newQuery=_.clone(currentQuery),baseUrlHasUri=currentQuery.uri,currentState=window.history.state||{},newState={sectionId:currentState.sectionId||currentQuery.section||"",restoreWith:currentState.restoreWith||"activate",nodeUri:nodeUri};nodeUri!==currentQuery.uri&&(newQuery.uri=nodeUri),nodeUri&&!_.isEqual(currentQuery,newQuery)&&(stateUrl=urlUtil.build(parsedUrl.path,newQuery),baseUrlHasUri?(window.history.pushState(newState,null,stateUrl),this.trigger("pushnodestate",stateUrl)):(
window.history.replaceState(newState,null,stateUrl),this.trigger("replacenodestate",stateUrl)),topState=newState)},restoreState:function(fromPopState){var state=window.history.state||{};this.hasRestorableState()&&(fromPopState?(topState=topState||{}).sectionId!==state.sectionId?this.trigger("section"+state.restoreWith,state.sectionId):state.nodeUri&&this.trigger("urichange",state.nodeUri,state.sectionId):this.trigger("section"+state.restoreWith,state.sectionId),topState=state)},hasRestorableState:function(){var state=window.history.state;return state&&state.restoreWith&&state.sectionId},init:function(){$(window).on("popstate.generisRouter",function(){
generisRouter.restoreState(!0)})},destroy:function(){$(window).off(".generisRouter")}});return generisRouter}),define("layout/section",["jquery","lodash","context","util/url","layout/generisRouter"],function($,_,context,url,generisRouter){"use strict";return{scope:$(".section-container"),sections:{},selected:null,init:function($scope,options){var $openersContainer,self=this,restore=!0,parsedUrl=url.parse(location.href),defaultSection=parsedUrl.query.section,defaultUri=decodeURIComponent(parsedUrl.query.uri);if(this.options=options||{},this.scope=$scope||this.scope||$(".section-container"),$openersContainer=$(".tab-container",this.scope),this.selected=null,$(
"li",$openersContainer).each(function(index){var $sectionOpener=$(this),$link=$sectionOpener.children("a"),id=$link.attr("href").replace("#panel-",""),$panel=$("#panel-"+id),isActive=defaultSection?defaultSection===id:0===index;$panel.removeClass("hidden"),self.sections[id]={id:id,url:$link.data("url"),name:$link.text(),panel:$panel,opener:$sectionOpener,type:$panel.find(".section-trees").children().length?"tree":"content",active:isActive,activated:!1,disabled:$sectionOpener.hasClass("disabled"),defaultUri:isActive&&defaultUri?defaultUri:""}}),0===_(this.sections).where({active:!0}).size())for(var id in this.sections){restore=!(this.sections[id].active=!0)
;break}if(this._bindOpener($openersContainer),this.scope.trigger("init.section"),generisRouter.off(".sectionManager").on("sectionactivate.sectionManager",function(sectionId){self.get(sectionId)._activate()}).on("sectionshow.sectionManager",function(sectionId){self.get(sectionId)._show()}),!1===this.options.history||!restore||!generisRouter.hasRestorableState())return this.activate();generisRouter.restoreState()},_bindOpener:function($openersContainer){var self=this;return $openersContainer.off("click.section","li").on("click.section","li",function(e){e.preventDefault();var id=$(this).children("a").attr("href").replace("#panel-","")
;self.sections[id].disabled||self.get(id).activate()}),$("li:not(.hidden)",$openersContainer).length<2?$openersContainer.hide():$openersContainer.show(),this},activate:function(){return this.selected||this.current(),!1!==this.options.history&&generisRouter.pushSectionState(location.href,this.selected.id,"activate"),this._activate()},_activate:function(){return this._show(),!1===this.selected.activated&&(this.selected.activated=!0,this.scope.trigger("activate.section",[this.selected])),this},show:function(){return this.selected||this.current(),!1!==this.options.history&&generisRouter.pushSectionState(location.href,this.selected.id,"show"),this._show()},
_show:function(){var self=this,active=_(this.sections).where({active:!0}).first();return this.selected&&this.selected.id!==active.id?(_.forEach(this.sections,function(section){section.active=!1}),this.sections[this.selected.id].active=!0):this.current(),_.where(this.sections,{active:!1}).forEach(function(section){section.opener.removeClass("active"),section.panel.hide(),self.scope.trigger("hide.section",[section])}),_.where(this.sections,{active:!0}).forEach(function(section){section.opener.addClass("active"),section.panel.show(),self.scope.trigger("show.section",[section])}),this},refresh:function(){return this.sections={},this.init()},enable:function(){
return this.selected||this.current(),!0===this.selected.disabled&&(this.selected.disabled=!1,this.selected.opener.removeClass("disabled"),this.scope.trigger("enable.section",[this.selected])),this},disable:function(){return this.selected||this.current(),!1===this.selected.disabled&&(this.selected.disabled=!0,this.selected.opener.addClass("disabled"),this.scope.trigger("disable.section",[this.selected])),this},current:function(){return this.selected=_(this.sections).where({active:!0}).first(),this},create:function(data){var $sectionOpener,$sectionPanel,section,$openersContainer=this.scope.find(".tab-container");if(!_.isObject(data))throw new TypeError(
"The create() method requires an object with section data as parameter.");if(!_.isString(data.id)||!_.isString(data.url)||!_.isString(data.name))throw new TypeError("The create() method requires data with id, url and name to create a new section.");return void 0===data.visible&&(data.visible=!0),this.get(data.id),(section=this.selected&&this.selected.id===data.id?this.selected:void 0)||($sectionPanel=$('<div id="panel-'+data.id+'" class="clear"></div>'),!0===data.contentBlock&&$sectionPanel.append('<section class="content-container"><ul class="plain action-bar content-action-bar horizontal-action-bar"></ul><div class="content-block"></div></section>'),
$sectionOpener=$('<li class="small '+(data.visible?"":"hidden")+'"><a title="'+data.name+'" data-url="'+data.url+'" href="#panel-'+data.id+'">'+data.name+"</a></li>"),$openersContainer.append($sectionOpener),this.scope.append($sectionPanel),section={id:data.id,url:data.url,name:data.name,panel:$sectionPanel,opener:$sectionOpener,type:"content",active:!1},this.sections[data.id]=section),section.url=section.url===data.url||void 0===data.url?section.url:data.url,this.selected=section,data.content?!0===data.contentBlock?this.updateContentBlock(data.content):section.panel.html(data.content):!0===data.contentBlock?this.loadContentBlock():this.load(),
this._bindOpener($openersContainer),this},get:function(value){var section;if(!_.isString(value))throw new TypeError("The get() method requires a string parameter, the section id or url.");return(section=this.sections[value]||this.sections[value.replace("panel-","")]||_(this.sections).where({url:value}).first()||_(this.sections).where({url:context.root_url+value}).first())?this.selected=section:this.current(),this},load:function(url,data,loaded){var self=this;return this.selected||this.current(),url=url||this.selected.url,"tree"===this.selected.type?this.selected.panel.addClass("content-panel"):this.selected.panel.removeClass("content-panel"),
this.selected.panel.empty().load(url,data,function(response){self.scope.trigger("load.section",[self.selected,response]),_.isFunction(loaded)&&loaded()}),this},loadContentBlock:function(url,data,loaded){var $contentblock;return this.selected||this.current(),url=url||this.selected.url,"tree"===this.selected.type?this.selected.panel.addClass("content-panel"):this.selected.panel.removeClass("content-panel"),($contentblock=$(".content-block",this.selected.panel)).length?($contentblock.empty().load(url,data,loaded),this):this.load(url,data,loaded)},updateContentBlock:function(html){var $contentblock=$(".content-block",this.selected.panel)
;return $contentblock.length?$contentblock.empty().html(html):this.selected.panel.empty().html(html),this},on:function(eventName,cb){var self=this;return this.scope.on(eventName+".section",function(e){cb.apply(self,Array.prototype.slice.call(arguments,1))}),this},off:function(eventName){return this.scope.off(eventName+".section"),this}}}),define("controller/Lock/locked",["jquery","i18n","helpers","lock","layout/section","ui/feedback"],function($,__,helpers,Lock,sectionApi,feedback){"use strict";return{start:function(){$(".forcerelease").click(function(e){e.preventDefault(),$.ajax({url:helpers._url("forceRelease","Lock","tao"),type:"POST",data:{uri:$(this
).data("id")},dataType:"json",success:function(response){response.success?(feedback().success(__("The lock has been released")),$(".tree").trigger("refresh.taotree")):feedback().error(__("Unable to release the lock"))},error:function(){feedback().error(__("Unable to release the lock"))}})})}}}),define("layout/version-warning",["jquery","jquery.cookie"],function($){"use strict";var versionWarning=$(".version-warning");function hideWarning(slide){var callback=function(){document.documentElement.className+=" no-version-warning",versionWarning.trigger("hiding.versionwarning")};slide?versionWarning.slideUp("slow",function(){versionWarning.slideUp("slow",callback)
}):(versionWarning.hide(),callback())}return{init:function(){$.cookie("versionWarning")?hideWarning(!1):versionWarning.find(".close-trigger").on("click",function(){$.cookie("versionWarning",!0,{path:"/"}),hideWarning(!0)})}}}),define("controller/login",["jquery","lodash","i18n","module","ui/feedback","layout/loading-bar","layout/version-warning"],function($,_,__,module,feedback,loadingBar,versionWarning){"use strict";return{start:function(){var $fields,messages=module.config().message||{},$context=$(".entry-point-container"),$loginForm=$context.find("#loginForm"),$fakeForm=$context.find(".fakeForm"),$loginBtn=$context.find("[name=connect]")
;function submitForm(){$fakeForm.find(":input").each(function(){var $field=$(this);$loginForm.find('input[name="'+$field.attr("name")+'"]').val($field.val())}),loadingBar.start(),$loginForm.submit()}versionWarning.init(),!messages.error&&$context.find(".form-error").length&&(messages.error=__("All fields are required")),$fields=$context.find(":input"),_.forEach(messages,function(message,level){message&&(feedback().message(level,message).open(),$fields.addClass(level))}),$fakeForm.find('input[type="submit"], button[type="submit"]').off("click").on("click",function(e){e.preventDefault(),submitForm()}),$fakeForm.on("keypress",function(e){13===e.which&&(
e.preventDefault(),submitForm())}),$loginBtn.removeAttr("disabled").removeClass("disabled"),loadingBar.stop()}}}),define("form/post-render-props",["jquery","i18n","ui/feedback"],function($,__,feedback){function _toggleModeBtn(newMode){var $modeToggle=$(".property-mode");"disabled"===newMode?$modeToggle.addClass("disabled"):$modeToggle.removeClass("disabled")}function _upgradeButtons($container,type){"radio"!==type&&"checkbox"!==type&&(type="radio");var selector=".form_checklst",notSelector="";"radio"===type&&(selector=".form_radlst",notSelector=".form_checklst, "),$container.find(selector).not(notSelector+".property-"+type+"-list").each(function(){
var $radioList=$(this);$radioList.addClass("property-"+type+"-list"),$radioList.parent().addClass("property-"+type+"-list-box"),$radioList.each(function(){var $block=$(this),$inputs=$block.find("input");$inputs.length<=2&&$block.find("br").remove(),$inputs.each(function(){var $input=$(this),$label=$block.find('label[for="'+this.id+'"]'),$icon=$("<span>",{class:"icon-"+type});$label.prepend($icon),$label.prepend($input)})})})}function getPropertyContainer(){var $propertyContainer=$(".content-block .property-container");return $propertyContainer.length||($propertyContainer=$("<div>",{class:"property-container"}),$(".content-block .form-group").first().before(
$propertyContainer)),$propertyContainer}function _hideProperties($container){$(".property",$container).each(function(){for(var $currentTarget=$(this);!_.isEqual($currentTarget.parent()[0],$container[0]);)$currentTarget=$currentTarget.parent();$currentTarget.hide()}),_toggleModeBtn("disabled")}function _showProperties($container){$(".property",$container).each(function(){for(var $currentTarget=$(this);!_.isEqual($currentTarget.parent()[0],$container[0]);)$currentTarget=$currentTarget.parent();$currentTarget.show()});var elt=$('[class*="property-type"]',$container).parent("div").next("div");new RegExp(["list","tree"].join("$|").concat("$")).test($(
'[class*="property-type"]',$container).val())?"none"===elt.css("display")&&(elt.show(),elt.find("select").removeAttr("disabled")):"none"!==elt.css("display")&&(elt.css("display","none"),elt.find("select").prop("disabled","disabled")),_toggleModeBtn("enabled")}function _hideIndexes($container){$(".index",$container).each(function(){for(var $currentTarget=$(this);!_.isEqual($currentTarget.parent()[0],$container[0]);)$currentTarget=$currentTarget.parent();$currentTarget.hide()}),$(".index-remover",$container).each(function(){$(this).parent().hide()})}function _showIndexes($container){$(".index",$container).each(function(){for(var $currentTarget=$(this
);!_.isEqual($currentTarget.parent()[0],$container[0]);)$currentTarget=$currentTarget.parent();$currentTarget.show()}),$(".index-remover",$container).each(function(){$(this).parent().show()})}return{init:function($properties){var $container=$(".content-block .xhtml_form:first form");$container.length&&(function($container){var $copyField,isInstanceForm=document.getElementById("tao.forms.instance"),$idField=$container.find("#id"),$label=$("<span>",{class:"form_desc",text:__("Resource Identifier")}),$button=$("<span>",{class:"icon-clipboard clipboard-command",title:__("Copy to clipboard")}).on("click",function(){var success;try{$copyField.select(),
success=document.execCommand("copy"),$copyField.blur(),success?feedback().success(__("Resource Identifier has been copied to the clipboard")):feedback().error(__("Resource Identifier could not be copied to the clipboard"))}catch(err){feedback().error(__("Your browser does not support copying to the clipboard"))}}),$fieldBox=$("<span>",{class:"uri-container"});$(".uri-container").length||isInstanceForm&&$idField.length&&($copyField=$idField.clone().attr({readonly:!0,type:"text"}),$idField.remove(),$fieldBox.append([$copyField,$button]),$container.find("div").first().after($("<div>").append([$label,$fieldBox])),$fieldBox.height($copyField.outerHeight()),
$copyField.addClass("final"))}($container),$properties&&$properties.length||($properties=$container.children('div[id*="property_"]').not(".property-block")),$properties.length&&(function($properties){var $propertyContainer=getPropertyContainer(),hasAlreadyProperties=!!$propertyContainer.find(".property-block").length;$properties.each(function(){var $property=$(this);if(void 0!==$property.attr){var type=function(){var $propertyMode=$(".property-mode");switch($property.attr("id").replace(/_?property_[\d]+/,"")){case"ro":return"readonly-property";case"parent":return"parent-property";default:var $editIcon=$property.find(".icon-edit"),
$editContainer=$property.children("div:first"),$indexIcon=$property.find(".icon-find");return $editContainer.addClass("property-edit-container"),_hideProperties($editContainer),_hideIndexes($editContainer),$propertyMode.hasClass("property-mode-simple")?$indexIcon.hide():$propertyMode.hasClass("property-mode-advanced")&&$indexIcon.show(),$editIcon.on("click",function(){$editContainer.parent().hasClass("property-edit-container-open")?$($(".property",$editContainer)[0]).is(":visible")?$editContainer.slideToggle(function(){$editContainer.parent().toggleClass("property-edit-container-open"),_hideProperties($editContainer)}):(_hideIndexes($editContainer),
_showProperties($editContainer)):(_hideIndexes($editContainer),_showProperties($editContainer),$editContainer.slideToggle(function(){$editContainer.parent().toggleClass("property-edit-container-open")}))}),$indexIcon.on("click",function(){$(".property-mode").hasClass("property-mode-advanced")&&($editContainer.parent().hasClass("property-edit-container-open")?$($(".index",$editContainer)[0]).is(":visible")?$editContainer.slideToggle(function(){$editContainer.parent().toggleClass("property-edit-container-open"),_hideIndexes($editContainer)}):(_hideProperties($editContainer),_showIndexes($editContainer)):(_hideProperties($editContainer),_showIndexes(
$editContainer),$editContainer.slideToggle(function(){$editContainer.parent().toggleClass("property-edit-container-open")})))}),"regular-property"}}();$property.addClass(hasAlreadyProperties?"property-block "+type:"property-block-first property-block "+type),$propertyContainer.append($property),hasAlreadyProperties=!0}})}($properties),_upgradeButtons($container,"radio"),_upgradeButtons($container,"checkbox"),_toggleModeBtn("disabled"),function($container){var $editContainer,$error=$container.find(".error");$error.length&&($editContainer=$error.closest(".property-edit-container")).length&&(_hideIndexes($editContainer),_showProperties($editContainer),
...
;1<$response.length&&$response.last().appendTo(property);postRenderProps.init(property)}})},remove:function(uri,classUri,url,successCallback){$.ajax({url:url,type:"POST",data:{uri:uri,classUri:classUri},dataType:"html",success:function(){_.isFunction(successCallback)&&successCallback()}})}}}),define("jwysiwyg",["jquery"],function($){var Wysiwyg=function(element,options){this.init(element,options)},innerDocument=function(elts){var element=$(elts).get(0);if("iframe"!==element.nodeName.toLowerCase())return element;if(element.contentDocument)return element.contentDocument;if(element.contentWindow)return element.contentWindow.document
;throw"Unexpected error in innerDocument"},documentSelection=function(){var element=this.get(0);return element.contentWindow.document.selection?element.contentWindow.document.selection.createRange().text:element.contentWindow.getSelection().toString()};$.fn.wysiwyg=function(options){if(0<arguments.length&&options.constructor==String){var action=options.toString(),params=[];if("enabled"==action)return null!==this.data("wysiwyg");for(var i=1;i<arguments.length;i++)params[i-1]=arguments[i];var retValue=null;return this.each(function(){$.data(this,"wysiwyg").designMode(),retValue=Wysiwyg[action].apply(this,params)}),retValue}if(this.data("wysiwyg"))return this
;var controls={};for(var control in options&&options.controls&&(controls=options.controls,delete options.controls),(options=$.extend({},$.fn.wysiwyg.defaults,options)).controls=$.extend(!0,options.controls,$.fn.wysiwyg.controls),controls)control in options.controls?$.extend(options.controls[control],controls[control]):options.controls[control]=controls[control];return this.each(function(){new Wysiwyg(this,options)})},$.fn.wysiwyg.defaults={
...
;this.hidePaginate(NODE,TREE_OBJ),this.getMeta(nodeId,"displayed")<this.getMeta(nodeId,"count")&&this.showPaginate(NODE,TREE_OBJ)},getClassUri:function(NODE){var parents=$(NODE).parents("li");return 0==parents.length?$(NODE).prop("id"):$(parents[0]).prop("id")},callGetSectionActions:function(NODE,TREE_OBJ){null!=NODE&&($(NODE).hasClass("node-class")?$(NODE).prop("id"):($(NODE).prop("id"),this.getClassUri(NODE)))}})}),define("lib/jsTree/plugins/jquery.tree.contextmenu",["jquery","jquery.tree"],function($){$.extend($.tree.plugins,{contextmenu:{object:$("<ul id='jstree-contextmenu' class='tree-context' />"),data:{t:!1,a:!1,r:!1},defaults:{class_name:"hover",
items:{create:{label:"Create",icon:"create",visible:function(NODE,TREE_OBJ){return 1!=NODE.length?0:TREE_OBJ.check("creatable",NODE)},action:function(NODE,TREE_OBJ){TREE_OBJ.create(!1,TREE_OBJ.get_node(NODE[0]))},separator_after:!0},rename:{label:"Rename",icon:"rename",visible:function(NODE,TREE_OBJ){return 1==NODE.length&&TREE_OBJ.check("renameable",NODE)},action:function(NODE,TREE_OBJ){TREE_OBJ.rename(NODE)}},remove:{label:"Delete",icon:"remove",visible:function(NODE,TREE_OBJ){var ok=!0;return $.each(NODE,function(){return 0==TREE_OBJ.check("deletable",this)&&(ok=!1),!1}),ok},action:function(NODE,TREE_OBJ){$.each(NODE,function(){TREE_OBJ.remove(this)})}}}
},show:function(obj,t){var opts=$.extend(!0,{},$.tree.plugins.contextmenu.defaults,t.settings.plugins.contextmenu);obj=$(obj),$.tree.plugins.contextmenu.object.empty();var str="";for(var i in opts.items)if(opts.items.hasOwnProperty(i)&&!1!==opts.items[i]){var r=1;"function"==typeof opts.items[i].visible&&(r=opts.items[i].visible.call(null,$.tree.plugins.contextmenu.data.a,t)),-1!=r&&(0,!0===opts.items[i].separator_before&&(str+="<li class='separator'><span>&nbsp;</span></li>"),str+='<li><a href="#" rel="'+i+'" class="'+i+" "+(0==r?"disabled":"")+'">',opts.items[i].icon?str+="<ins "+(-1==opts.items[i].icon.indexOf("/"
)?" class='"+opts.items[i].icon+"' ":" style='background-image:url(\""+(0==r?opts.items[i].icon.replace(".png","_disabled.png"):opts.items[i].icon)+"\");' ")+">&nbsp;</ins>":str+="<ins>&nbsp;</ins>",str+="<span>"+opts.items[i].label+"</span></a></li>",!0===opts.items[i].separator_after&&(str+="<li class='separator'><span>&nbsp;</span></li>"))}var tmp=obj.children("a:visible").offset();$.tree.plugins.contextmenu.object.attr("class","tree-context tree-"+t.settings.ui.theme_name.toString()+"-context").html(str);var h=$.tree.plugins.contextmenu.object.height(),w=$.tree.plugins.contextmenu.object.width(),x=tmp.left,y=tmp.top+parseInt(obj.children("a:visible"
).height())+2,max_y=$(window).height()+$(window).scrollTop(),max_x=$(window).width()+$(window).scrollLeft();max_y<y+h&&(y=Math.max(max_y-h-2,0)),max_x<x+w&&(x=Math.max(max_x-w-2,0)),$.tree.plugins.contextmenu.object.css({left:x,top:y}).fadeIn("fast")},hide:function(){if($.tree.plugins.contextmenu.data.t){var opts=$.extend(!0,{},$.tree.plugins.contextmenu.defaults,$.tree.plugins.contextmenu.data.t.settings.plugins.contextmenu);$.tree.plugins.contextmenu.data.r&&$.tree.plugins.contextmenu.data.a&&$.tree.plugins.contextmenu.data.a.children("a, span").removeClass(opts.class_name),$.tree.plugins.contextmenu.data={a:!1,r:!1,t:!1},
$.tree.plugins.contextmenu.object.fadeOut("fast")}},exec:function(cmd){if(0!=$.tree.plugins.contextmenu.data.t){var opts=$.extend(!0,{},$.tree.plugins.contextmenu.defaults,$.tree.plugins.contextmenu.data.t.settings.plugins.contextmenu);try{opts.items[cmd].action.apply(null,[$.tree.plugins.contextmenu.data.a,$.tree.plugins.contextmenu.data.t])}catch(e){}}},callbacks:{oninit:function(){if(!$.tree.plugins.contextmenu.css){$.tree.plugins.contextmenu.css=this.add_sheet({
...
)+'\r\n        <span class="selector clickable" tabindex="0"></span>\r\n    </a>\r\n    <ul>\r\n    ',((stack1=helpers.if.call(depth0,depth0&&depth0.childList,{hash:{},inverse:self.noop,fn:self.program(6,program6,data),data:data}))||0===stack1)&&(buffer+=stack1),buffer+='\r\n    </ul>\r\n    <div class="more hidden">\r\n        <a href="#" class="btn-info small"><span class="icon-download"></span> '+escapeExpression((options={hash:{},data:data},(helper=helpers.__||depth0&&depth0.__)?helper.call(depth0,"Load more",options):helperMissing.call(depth0,"__","Load more",options)))+"</a>\r\n    </div>\r\n</li>\r\n"},data),data:data},((stack1=helper?helper.call(
depth0,depth0&&depth0.type,"class",options):helperMissing.call(depth0,"equal",depth0&&depth0.type,"class",options))||0===stack1)&&(buffer+=stack1),buffer+="\r\n\r\n",helper=helpers.equal||depth0&&depth0.equal,options={hash:{},inverse:self.noop,fn:self.program(8,function(depth0,data){var stack1,helper,buffer="";return buffer+='\r\n<li data-uri="',stack1=(helper=helpers.uri)?helper.call(depth0,{hash:{},data:data}):typeof(helper=depth0&&depth0.uri)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+'" class="instance',((stack1=helpers.if.call(depth0,depth0&&depth0.selectable,{hash:{},inverse:self.noop,fn:self.program(
2,program2,data),data:data}))||0===stack1)&&(buffer+=stack1),buffer+=" ",stack1=(helper=helpers.state)?helper.call(depth0,{hash:{},data:data}):typeof(helper=depth0&&depth0.state)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+'"  ',((stack1=helpers.if.call(depth0,depth0&&depth0.accessMode,{hash:{},inverse:self.noop,fn:self.program(4,program4,data),data:data}))||0===stack1)&&(buffer+=stack1),buffer+='>\r\n    <a href="#" title="',stack1=(helper=helpers.label)?helper.call(depth0,{hash:{},data:data}):typeof(helper=depth0&&depth0.label)===functionType?helper.call(depth0,{hash:{},data:data}):helper,
buffer+=escapeExpression(stack1)+'">\r\n        <span class="icon-',stack1=(helper=helpers.icon)?helper.call(depth0,{hash:{},data:data}):typeof(helper=depth0&&depth0.icon)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+'"></span>\r\n        ',stack1=(helper=helpers.label)?helper.call(depth0,{hash:{},data:data}):typeof(helper=depth0&&depth0.label)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+'\r\n        <span class="selector clickable" tabindex="0"></span>\r\n    </a>\r\n</li>\r\n'},data),data:data},((stack1=helper?helper.call(depth0,depth0&&depth0.type,
"instance",options):helperMissing.call(depth0,"equal",depth0&&depth0.type,"instance",options))||0===stack1)&&(buffer+=stack1),buffer+="\r\n\r\n\r\n"})}),define("tpl!ui/resource/tpl/list",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){this.compilerInfo=[4,">= 1.0.0"],helpers=this.merge(helpers,Handlebars.helpers),data=data||{};var stack1,helper,options,buffer="",helperMissing=helpers.helperMissing,escapeExpression=this.escapeExpression;return buffer+='<div class="resource-list ',((stack1=helpers.if.call(depth0,depth0&&depth0.multiple,{hash:{},inverse:this.noop,fn:this.program(1,function(depth0,data){
return"multiple"},data),data:data}))||0===stack1)&&(buffer+=stack1),buffer+='">\r\n    <ul></ul>\r\n    <div class="more hidden">\r\n        <a href="#" class="btn-info small"><span class="icon-download"></span> '+escapeExpression((options={hash:{},data:data},(helper=helpers.__||depth0&&depth0.__)?helper.call(depth0,"Load more",options):helperMissing.call(depth0,"__","Load more",options)))+"</a>\r\n    </div>\r\n</div>\r\n\r\n"})}),define("tpl!ui/resource/tpl/listNode",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){this.compilerInfo=[4,">= 1.0.0"],helpers=this.merge(helpers,Handlebars.helpers),data=data||{}
...
stack1=(helper=helpers.searchPlaceholder)?helper.call(depth0,{hash:{},data:data}):typeof(helper=depth0&&depth0.searchPlaceholder)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+'" />\r\n            ',((stack1=helpers.if.call(depth0,depth0&&depth0.filters,{hash:{},inverse:self.noop,fn:self.program(10,program10,data),data:data}))||0===stack1)&&(buffer+=stack1),buffer+='\r\n        </div>\r\n        <div class="selection-control">\r\n            <a href="#" class="selection-toggle ',((stack1=helpers.unless.call(depth0,depth0&&depth0.switchMode,{hash:{},inverse:self.noop,fn:self.program(12,program12,data),data:data
}))||0===stack1)&&(buffer+=stack1),buffer+='" title="'+escapeExpression((options={hash:{},data:data},(helper=helpers.__||depth0&&depth0.__)?helper.call(depth0,"Toggle multiple/single selection",options):helperMissing.call(depth0,"__","Toggle multiple/single selection",options)))+'">\r\n                <span class="icon-multi-select"></span>\r\n            </a>\r\n            <label class="selection-indicator ',((stack1=helpers.unless.call(depth0,depth0&&depth0.multiple,{hash:{},inverse:self.noop,fn:self.program(12,program12,data),data:data}))||0===stack1)&&(buffer+=stack1),
...
stack1=depth0&&depth0.options)||!1===stack1?stack1:stack1.model,{hash:{},inverse:self.noop,fn:self.program(40,function(depth0,data){var stack1,helper,buffer="";return buffer+="\r\n                    <th",((stack1=helpers.if.call(depth0,depth0&&depth0.type,{hash:{},inverse:self.noop,fn:self.program(41,program41,data),data:data}))||0===stack1)&&(buffer+=stack1),buffer+=">\r\n                        <div ",((stack1=helpers.if.call(depth0,depth0&&depth0.sortable,{hash:{},inverse:self.noop,fn:self.program(43,program43,data),data:data}))||0===stack1)&&(buffer+=stack1),buffer+=">",stack1=(helper=helpers.label)?helper.call(depth0,{hash:{},data:data}):typeof(
helper=depth0&&depth0.label)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+"</div>\r\n                        ",((stack1=helpers.if.call(depth0,depth0&&depth0.filterable,{hash:{},inverse:self.noop,fn:self.program(46,program46,data),data:data}))||0===stack1)&&(buffer+=stack1),buffer+="\r\n                    </th>\r\n                    "},data),data:data}))||0===stack1)&&(buffer+=stack1),buffer+="\r\n                    ",((stack1=helpers.if.call(depth0,null==(stack1=depth0&&depth0.options)||!1===stack1?stack1:stack1.actions,{hash:{},inverse:self.noop,fn:self.program(51,function(depth0,data){var stack1,
buffer="";return buffer+='\r\n                    <th class="actions">'+escapeExpression(typeof(stack1=null==(stack1=null==(stack1=depth0&&depth0.options)||!1===stack1?stack1:stack1.labels)||!1===stack1?stack1:stack1.actions)===functionType?stack1.apply(depth0):stack1)+"</th>\r\n                    "},data),data:data}))||0===stack1)&&(buffer+=stack1),buffer+="\r\n                </tr>\r\n            </thead>\r\n            <tbody>\r\n                ",((stack1=helpers.each.call(depth0,null==(stack1=depth0&&depth0.dataset)||!1===stack1?stack1:stack1.data,{hash:{},inverse:self.noop,fn:self.programWithDepth(53,function(depth0,data,depth1){var stack1,helper,
buffer="";return buffer+='\r\n                    <tr data-item-identifier="',stack1=(helper=helpers.id)?helper.call(depth0,{hash:{},data:data}):typeof(helper=depth0&&depth0.id)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+'">\r\n                        ',((stack1=helpers.if.call(depth0,null==(stack1=depth1&&depth1.options)||!1===stack1?stack1:stack1.selectable,{hash:{},inverse:self.noop,fn:self.program(54,program54,data),data:data}))||0===stack1)&&(buffer+=stack1),buffer+="\r\n\r\n                        ",((stack1=helpers.each.call(depth0,null==(stack1=depth1&&depth1.options
)||!1===stack1?stack1:stack1.model,{hash:{},inverse:self.noop,fn:self.programWithDepth(56,program56,data,depth0),data:data}))||0===stack1)&&(buffer+=stack1),buffer+="\r\n\r\n                        ",((stack1=helpers.if.call(depth0,null==(stack1=depth1&&depth1.options)||!1===stack1?stack1:stack1.actions,{hash:{},inverse:self.noop,fn:self.programWithDepth(75,program75,data,depth1),data:data}))||0===stack1)&&(buffer+=stack1),buffer+="\r\n                    </tr>\r\n                "},data,depth0),data:data}))||0===stack1)&&(buffer+=stack1),buffer+="\r\n            </tbody>\r\n        </table>\r\n        ",((stack1=helpers.unless.call(depth0,null==(
stack1=depth0&&depth0.dataset)||!1===stack1?stack1:stack1.data,{hash:{},inverse:self.noop,fn:self.program(88,function(depth0,data){var stack1,buffer="";return buffer+="\r\n            ",((stack1=helpers.if.call(depth0,null==(stack1=depth0&&depth0.options)||!1===stack1?stack1:stack1.emptyText,{hash:{},inverse:self.noop,fn:self.program(89,program89,data),data:data}))||0===stack1)&&(buffer+=stack1),buffer+="\r\n        "},data),data:data}))||0===stack1)&&(buffer+=stack1),buffer+='\r\n    </div>\r\n    <div class="datatable-pagination-bottom"></div>\r\n</div>\r\n'})}),define("tpl!ui/datatable/tpl/button",["handlebars"],function(hb){return hb.template(function(
Handlebars,depth0,helpers,partials,data){this.compilerInfo=[4,">= 1.0.0"],helpers=this.merge(helpers,Handlebars.helpers),data=data||{};var stack1,helper,buffer="",functionType="function",escapeExpression=this.escapeExpression;return buffer+='<button class="btn-info small ',stack1=(helper=helpers.id)?helper.call(depth0,{hash:{},data:data}):typeof(helper=depth0&&depth0.id)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+'"',((stack1=helpers.if.call(depth0,depth0&&depth0.title,{hash:{},inverse:this.noop,fn:this.program(1,function(depth0,data){var stack1,helper,buffer="";return buffer+=' title="',stack1=(
helper=helpers.title)?helper.call(depth0,{hash:{},data:data}):typeof(helper=depth0&&depth0.title)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+'"'},data),data:data}))||0===stack1)&&(buffer+=stack1),buffer+=">",((stack1=helpers.if.call(depth0,depth0&&depth0.icon,{hash:{},inverse:this.noop,fn:this.program(3,function(depth0,data){var stack1,helper,buffer="";return buffer+='<span class="icon-',stack1=(helper=helpers.icon)?helper.call(depth0,{hash:{},data:data}):typeof(helper=depth0&&depth0.icon)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+'"></span> '},data),
data:data}))||0===stack1)&&(buffer+=stack1),((stack1=helpers.if.call(depth0,depth0&&depth0.label,{hash:{},inverse:this.noop,fn:this.program(5,function(depth0,data){var stack1,helper;return stack1=(helper=helpers.label)?helper.call(depth0,{hash:{},data:data}):typeof(helper=depth0&&depth0.label)===functionType?helper.call(depth0,{hash:{},data:data}):helper,escapeExpression(stack1)},data),data:data}))||0===stack1)&&(buffer+=stack1),buffer+="</button>\r\n"})}),define("tpl!ui/pagination/providers/tpl/pages",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){this.compilerInfo=[4,">= 1.0.0"],data=data||{};var helper,
options,buffer="",helperMissing=(helpers=this.merge(helpers,Handlebars.helpers)).helperMissing,escapeExpression=this.escapeExpression;return buffer+='<div class="grid-row clearfix pagination">\r\n    <ul class="pages">\r\n        <li class="first-page"><span class="icon-fast-backward" title="'+escapeExpression((options={hash:{},data:data},(helper=helpers.__||depth0&&depth0.__)?helper.call(depth0,"First page",options):helperMissing.call(depth0,"__","First page",options)))+'"></span></li>\r\n        <li class="previous"><span class="icon-backward" title="'+escapeExpression((options={hash:{},data:data},(helper=helpers.__||depth0&&depth0.__)?helper.call(depth0,
"Previous",options):helperMissing.call(depth0,"__","Previous",options)))+'"></span></li>\r\n        <li class="next"><span class="icon-forward" title="'+escapeExpression((options={hash:{},data:data},(helper=helpers.__||depth0&&depth0.__)?helper.call(depth0,"Next",options):helperMissing.call(depth0,"__","Next",options)))+'"></span></li>\r\n        <li class="last-page"><span class="icon-fast-forward" title="'+escapeExpression((options={hash:{},data:data},(helper=helpers.__||depth0&&depth0.__)?helper.call(depth0,"Last page",options):helperMissing.call(depth0,"__","Last page",options)))+'"></span></li>\r\n    </ul>\r\n</div>\r\n'})}),define(
"tpl!ui/pagination/providers/tpl/pages/page",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){this.compilerInfo=[4,">= 1.0.0"],helpers=this.merge(helpers,Handlebars.helpers),data=data||{};var helper,buffer="";return buffer+='<li class="page"><span>',buffer+=(0,this.escapeExpression)((helper=helpers.page)?helper.call(depth0,{hash:{},data:data}):"function"==typeof(helper=depth0&&depth0.page)?helper.call(depth0,{hash:{},data:data}):helper)+"</span></li>\r\n"})}),define("tpl!ui/pagination/providers/tpl/simple",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){
this.compilerInfo=[4,">= 1.0.0"],data=data||{};var helper,options,buffer="",helperMissing=(helpers=this.merge(helpers,Handlebars.helpers)).helperMissing,escapeExpression=this.escapeExpression;return buffer+='<div class="grid-row clearfix pagination">\r\n    <div class="col-6">'+escapeExpression((options={hash:{},data:data},(helper=helpers.__||depth0&&depth0.__)?helper.call(depth0,"Page",options):helperMissing.call(depth0,"__","Page",options)))+' <strong class="page">',buffer+=escapeExpression((helper=helpers.activePage)?helper.call(depth0,{hash:{},data:data}):"function"==typeof(helper=depth0&&depth0.activePage)?helper.call(depth0,{hash:{},data:data}):helper
)+"</strong> "+escapeExpression((options={hash:{},data:data},(helper=helpers.__||depth0&&depth0.__)?helper.call(depth0,"of",options):helperMissing.call(depth0,"__","of",options)))+' <span class="total">',buffer+=escapeExpression((helper=helpers.totalPages)?helper.call(depth0,{hash:{},data:data}):"function"==typeof(helper=depth0&&depth0.totalPages)?helper.call(depth0,{hash:{},data:data}):helper)+'</span></div>\r\n    <div class="col-6 txt-rgt">\r\n        <button class="btn-info small"><span class="icon-backward"></span>'+escapeExpression((options={hash:{},data:data},(helper=helpers.__||depth0&&depth0.__)?helper.call(depth0,"Previous",options
):helperMissing.call(depth0,"__","Previous",options)))+'</button>\r\n        <button class="btn-info small">'+escapeExpression((options={hash:{},data:data},(helper=helpers.__||depth0&&depth0.__)?helper.call(depth0,"Next",options):helperMissing.call(depth0,"__","Next",options)))+'<span class="icon-forward r"></span></button>\r\n    </div>\r\n</div>\r\n'})}),define("layout/search",["jquery","lodash","i18n","layout/section","layout/actions","ui/feedback","ui/datatable"],function($,_,__,section,actionManager,feedback){"use strict";return{init:function(){var searchHandler,running=!1,$container=$(".action-bar .search-area"),$searchInput=$("input",$container),
$searchBtn=$("button",$container);$container&&$container.length&&(searchHandler=_.throttle(function(query){!1===running&&(running=!0,$.ajax({url:$container.data("url"),type:"POST",data:{query:query},dataType:"json"}).done(function(response){var data,$tableContainer;response&&response.result&&!0===response.result?(data=response,$tableContainer=$('<div class="flex-container-full"></div>'),section.updateContentBlock($tableContainer),$tableContainer.datatable({url:data.url,model:_.values(data.model),actions:{open:function(id){actionManager.trigger("refresh",{uri:id})}},params:{params:data.params,filters:data.filters,rows:20}})):feedback().warning(__(
"No results found"))}).complete(function(){running=!1}))},100),$searchBtn.off("click").on("click",function(e){e.preventDefault(),searchHandler($searchInput.val())}),$searchInput.off("keypress").on("keypress",function(e){var query=$searchInput.val();13===e.which&&(e.preventDefault(),searchHandler(query))}))}}}),function(name,definition,global){"use strict";"function"==typeof define?define("lib/store/idbstore",definition):"undefined"!=typeof module&&module.exports?module.exports=definition():global.IDBStore=definition()}(0,function(){"use strict";var defaultErrorHandler=function(error){throw error},defaultSuccessHandler=function(){},defaults={
storeName:"Store",storePrefix:"IDBWrapper-",dbVersion:1,keyPath:"id",autoIncrement:!0,onStoreReady:function(){},onError:defaultErrorHandler,indexes:[],implementationPreference:["indexedDB","webkitIndexedDB","mozIndexedDB","shimIndexedDB"]},IDBStore=function(kwArgs,onStoreReady){for(var key in void 0===onStoreReady&&"function"==typeof kwArgs&&(onStoreReady=kwArgs),"[object Object]"!=Object.prototype.toString.call(kwArgs)&&(kwArgs={}),defaults)this[key]=void 0!==kwArgs[key]?kwArgs[key]:defaults[key];this.dbName=this.storePrefix+this.storeName,this.dbVersion=parseInt(this.dbVersion,10)||1,onStoreReady&&(this.onStoreReady=onStoreReady)
;var env="object"==typeof window?window:self,availableImplementations=this.implementationPreference.filter(function(implName){return implName in env});this.implementation=availableImplementations[0],this.idb=env[this.implementation],this.keyRange=env.IDBKeyRange||env.webkitIDBKeyRange||env.mozIDBKeyRange,this.consts={READ_ONLY:"readonly",READ_WRITE:"readwrite",VERSION_CHANGE:"versionchange",NEXT:"next",NEXT_NO_DUPLICATE:"nextunique",PREV:"prev",PREV_NO_DUPLICATE:"prevunique"},this.openDB()},proto={constructor:IDBStore,version:"1.7.0",db:null,dbName:null,dbVersion:null,store:null,storeName:null,storePrefix:null,keyPath:null,autoIncrement:null,indexes:null,
implementationPreference:null,implementation:"",onStoreReady:null,onError:null,_insertIdCount:0,openDB:function(){var openRequest=this.idb.open(this.dbName,this.dbVersion),preventSuccessCallback=!1;openRequest.onerror=function(error){var gotVersionErr=!1;"error"in error.target?gotVersionErr="VersionError"==error.target.error.name:"errorCode"in error.target&&(gotVersionErr=12==error.target.errorCode),gotVersionErr?this.onError(new Error("The version number provided is lower than the existing one.")):this.onError(error)}.bind(this),openRequest.onsuccess=function(event){if(!preventSuccessCallback)if(this.db)this.onStoreReady();else if(
this.db=event.target.result,"string"!=typeof this.db.version)if(this.db.objectStoreNames.contains(this.storeName)){var emptyTransaction=this.db.transaction([this.storeName],this.consts.READ_ONLY);this.store=emptyTransaction.objectStore(this.storeName);var existingIndexes=Array.prototype.slice.call(this.getIndexList());this.indexes.forEach(function(indexData){var indexName=indexData.name;if(!indexName)return preventSuccessCallback=!0,void this.onError(new Error("Cannot create index: No index name given."));if(this.normalizeIndexData(indexData),this.hasIndex(indexName)){var actualIndex=this.store.index(indexName);this.indexComplies(actualIndex,indexData)||(
preventSuccessCallback=!0,this.onError(new Error('Cannot modify index "'+indexName+'" for current version. Please bump version number to '+(this.dbVersion+1)+"."))),existingIndexes.splice(existingIndexes.indexOf(indexName),1)}else preventSuccessCallback=!0,this.onError(new Error('Cannot create new index "'+indexName+'" for current version. Please bump version number to '+(this.dbVersion+1)+"."))},this),existingIndexes.length&&(preventSuccessCallback=!0,this.onError(new Error('Cannot delete index(es) "'+existingIndexes.toString()+'" for current version. Please bump version number to '+(this.dbVersion+1)+"."))),preventSuccessCallback||this.onStoreReady()
}else this.onError(new Error("Object store couldn't be created."));else this.onError(new Error("The IndexedDB implementation in this browser is outdated. Please upgrade your browser."))}.bind(this),openRequest.onupgradeneeded=function(event){if(this.db=event.target.result,this.db.objectStoreNames.contains(this.storeName))this.store=event.target.transaction.objectStore(this.storeName);else{var optionalParameters={autoIncrement:this.autoIncrement};null!==this.keyPath&&(optionalParameters.keyPath=this.keyPath),this.store=this.db.createObjectStore(this.storeName,optionalParameters)}var existingIndexes=Array.prototype.slice.call(this.getIndexList())
;this.indexes.forEach(function(indexData){var indexName=indexData.name;if(indexName||(preventSuccessCallback=!0,this.onError(new Error("Cannot create index: No index name given."))),this.normalizeIndexData(indexData),this.hasIndex(indexName)){var actualIndex=this.store.index(indexName);this.indexComplies(actualIndex,indexData)||(this.store.deleteIndex(indexName),this.store.createIndex(indexName,indexData.keyPath,{unique:indexData.unique,multiEntry:indexData.multiEntry})),existingIndexes.splice(existingIndexes.indexOf(indexName),1)}else this.store.createIndex(indexName,indexData.keyPath,{unique:indexData.unique,multiEntry:indexData.multiEntry})},this),
existingIndexes.length&&existingIndexes.forEach(function(_indexName){this.store.deleteIndex(_indexName)},this)}.bind(this)},deleteDatabase:function(onSuccess,onError){if(this.idb.deleteDatabase){this.db.close();var deleteRequest=this.idb.deleteDatabase(this.dbName);deleteRequest.onsuccess=onSuccess,deleteRequest.onerror=onError}else onError(new Error("Browser does not support IndexedDB deleteDatabase!"))},put:function(key,value,onSuccess,onError){null!==this.keyPath&&(onError=onSuccess,onSuccess=value,value=key),onError||(onError=defaultErrorHandler),onSuccess||(onSuccess=defaultSuccessHandler);var putRequest,hasSuccess=!1,result=null,
putTransaction=this.db.transaction([this.storeName],this.consts.READ_WRITE);return putTransaction.oncomplete=function(){(hasSuccess?onSuccess:onError)(result)},putTransaction.onabort=onError,putTransaction.onerror=onError,(putRequest=null!==this.keyPath?(this._addIdPropertyIfNeeded(value),putTransaction.objectStore(this.storeName).put(value)):putTransaction.objectStore(this.storeName).put(value,key)).onsuccess=function(event){hasSuccess=!0,result=event.target.result},putRequest.onerror=onError,putTransaction},get:function(key,onSuccess,onError){onError||(onError=defaultErrorHandler),onSuccess||(onSuccess=defaultSuccessHandler);var hasSuccess=!1,result=null,
getTransaction=this.db.transaction([this.storeName],this.consts.READ_ONLY);getTransaction.oncomplete=function(){(hasSuccess?onSuccess:onError)(result)},getTransaction.onabort=onError,getTransaction.onerror=onError;var getRequest=getTransaction.objectStore(this.storeName).get(key);return getRequest.onsuccess=function(event){hasSuccess=!0,result=event.target.result},getRequest.onerror=onError,getTransaction},remove:function(key,onSuccess,onError){onError||(onError=defaultErrorHandler),onSuccess||(onSuccess=defaultSuccessHandler);var hasSuccess=!1,result=null,removeTransaction=this.db.transaction([this.storeName],this.consts.READ_WRITE)
;removeTransaction.oncomplete=function(){(hasSuccess?onSuccess:onError)(result)},removeTransaction.onabort=onError,removeTransaction.onerror=onError;var deleteRequest=removeTransaction.objectStore(this.storeName).delete(key);return deleteRequest.onsuccess=function(event){hasSuccess=!0,result=event.target.result},deleteRequest.onerror=onError,removeTransaction},batch:function(dataArray,onSuccess,onError){if(onError||(onError=defaultErrorHandler),onSuccess||(onSuccess=defaultSuccessHandler),"[object Array]"!=Object.prototype.toString.call(dataArray))onError(new Error("dataArray argument must be of type Array."));else if(0===dataArray.length)return onSuccess(!0
...
arrayType){if(onError||(onError=defaultErrorHandler),onSuccess||(onSuccess=defaultSuccessHandler),arrayType||(arrayType="sparse"),"[object Array]"!=Object.prototype.toString.call(keyArray))onError(new Error("keyArray argument must be of type Array."));else if(0===keyArray.length)return onSuccess([]);var data=[],count=keyArray.length,hasSuccess=!1,result=null,batchTransaction=this.db.transaction([this.storeName],this.consts.READ_ONLY);batchTransaction.oncomplete=function(){(hasSuccess?onSuccess:onError)(result)},batchTransaction.onabort=onError,batchTransaction.onerror=onError;var onItemSuccess=function(event){
event.target.result||"dense"==arrayType?data.push(event.target.result):"sparse"==arrayType&&data.length++,0===--count&&(hasSuccess=!0,result=data)};return keyArray.forEach(function(key){var getRequest=batchTransaction.objectStore(this.storeName).get(key);getRequest.onsuccess=onItemSuccess,getRequest.onerror=function(err){!0,onError(result=err),batchTransaction.abort()}},this),batchTransaction},getAll:function(onSuccess,onError){onError||(onError=defaultErrorHandler),onSuccess||(onSuccess=defaultSuccessHandler);var getAllTransaction=this.db.transaction([this.storeName],this.consts.READ_ONLY),store=getAllTransaction.objectStore(this.storeName)
;return store.getAll?this._getAllNative(getAllTransaction,store,onSuccess,onError):this._getAllCursor(getAllTransaction,store,onSuccess,onError),getAllTransaction},_getAllNative:function(getAllTransaction,store,onSuccess,onError){var hasSuccess=!1,result=null;getAllTransaction.oncomplete=function(){(hasSuccess?onSuccess:onError)(result)},getAllTransaction.onabort=onError,getAllTransaction.onerror=onError;var getAllRequest=store.getAll();getAllRequest.onsuccess=function(event){hasSuccess=!0,result=event.target.result},getAllRequest.onerror=onError},_getAllCursor:function(getAllTransaction,store,onSuccess,onError){var all=[],hasSuccess=!1,result=null
;getAllTransaction.oncomplete=function(){(hasSuccess?onSuccess:onError)(result)},getAllTransaction.onabort=onError,getAllTransaction.onerror=onError;var cursorRequest=store.openCursor();cursorRequest.onsuccess=function(event){var cursor=event.target.result;cursor?(all.push(cursor.value),cursor.continue()):(hasSuccess=!0,result=all)},cursorRequest.onError=onError},clear:function(onSuccess,onError){onError||(onError=defaultErrorHandler),onSuccess||(onSuccess=defaultSuccessHandler);var hasSuccess=!1,result=null,clearTransaction=this.db.transaction([this.storeName],this.consts.READ_WRITE);clearTransaction.oncomplete=function(){(hasSuccess?onSuccess:onError)(
result)},clearTransaction.onabort=onError,clearTransaction.onerror=onError;var clearRequest=clearTransaction.objectStore(this.storeName).clear();return clearRequest.onsuccess=function(event){hasSuccess=!0,result=event.target.result},clearRequest.onerror=onError,clearTransaction},_addIdPropertyIfNeeded:function(dataObj){void 0===dataObj[this.keyPath]&&(dataObj[this.keyPath]=this._insertIdCount+++Date.now())},getIndexList:function(){return this.store.indexNames},hasIndex:function(indexName){return this.store.indexNames.contains(indexName)},normalizeIndexData:function(indexData){indexData.keyPath=indexData.keyPath||indexData.name,
indexData.unique=!!indexData.unique,indexData.multiEntry=!!indexData.multiEntry},indexComplies:function(actual,expected){return["keyPath","unique","multiEntry"].every(function(key){if("multiEntry"==key&&void 0===actual[key]&&!1===expected[key])return!0;if("keyPath"!=key||"[object Array]"!=Object.prototype.toString.call(expected[key]))return expected[key]==actual[key];var exp=expected.keyPath,act=actual.keyPath;if("string"==typeof act)return exp.toString()==act;if("function"!=typeof act.contains&&"function"!=typeof act.indexOf)return!1;if(act.length!==exp.length)return!1;for(var i=0,m=exp.length;i<m;i++)if(!(act.contains&&act.contains(exp[i])||act.indexOf(
...
UserInfoService}),define("generis.tree.select",["jquery","lodash","i18n","context","generis.tree","helpers","ui/feedback","jquery.tree","lib/jsTree/plugins/jquery.tree.checkbox"],function($,_,__,context,GenerisTreeClass,helpers,feedback){return GenerisTreeClass.extend({init:function(selector,dataUrl,options){this.checkedNodes=void 0!==options.checkedNodes?options.checkedNodes.slice(0):[],this.hiddenNodes=void 0!==options.hiddenNodes?options.hiddenNodes.slice(0):[],options.callback&&options.callback.checkPaginate&&(this.checkPaginate=options.callback.checkPaginate);var instance=this,treeOptions={types:{default:{draggable:!(this.DISPLAY_SELECTED=1)}},ui:{
...
){var returnValue=instance.defaultServerParameters;for(var key in NODE&&(returnValue.classUri=$(NODE).prop("id")),instance.serverParameters)null!==instance.serverParameters[key]&&(returnValue[key]=instance.serverParameters[key]);return returnValue},onopen:function(NODE,TREE_OBJ){instance.checkedNodes&&instance.check(instance.checkedNodes)},onload:function(TREE_OBJ){instance.check(instance.checkedNodes),instance.options.loadCallback&&instance.options.loadCallback(),instance.isRefreshing=!1},onchange:function(NODE,TREE_OBJ){instance.options.onChangeCallback&&!instance.isRefreshing&&instance.options.onChangeCallback(NODE,TREE_OBJ)},onselect:function(NODE,
TREE_OBJ){if($(NODE).hasClass("paginate-more"))instance.paginateInstances($(NODE).parent().parent(),TREE_OBJ);else{if(!$(NODE).hasClass("paginate-all"))return!0;var parentNodeId=$(NODE).parent().parent().prop("id"),limit=instance.getMeta(parentNodeId,"count")-instance.getMeta(parentNodeId,"displayed");instance.paginateInstances($(NODE).parent().parent(),TREE_OBJ,{limit:limit})}},ondata:function(DATA,TREE_OBJ){return DATA.children&&(DATA.state="open"),instance.extractMeta(DATA),instance.removeHiddenNodes(DATA.children||DATA),DATA}},plugins:{checkbox:{three_state:!0}}};for(var i in this.serverParameters)treeOptions.data.opts[i]=this.serverParameters[i]
;this._super(selector,dataUrl,options,treeOptions),$("#saver-action-"+this.options.actionId).click({instance:this},function(e){e.data.instance.saveData()})},removeHiddenNodes:function(nodes){var self=this,hiddenNodes=this.hiddenNodes;_.isArray(nodes)&&hiddenNodes&&_.isArray(hiddenNodes)&&_.remove(nodes,function(node){if("instance"===node.type)return 0<=_.indexOf(hiddenNodes,node.attributes["data-uri"]);"class"===node.type&&node.children&&self.removeHiddenNodes(node.children)})},trace:function(){},paginateInstances:function(NODE,TREE_OBJ,pOptions,callback){var instance,nodeId=NODE[0].id,instancesLeft=this.getMeta(nodeId,"count")-this.getMeta(nodeId,
"displayed"),options={classUri:nodeId,subclasses:0,offset:this.getMeta(nodeId,"position"),limit:instancesLeft<this.paginate?instancesLeft:this.paginate};options=$.extend(options,pOptions),$.post(this.dataUrl,options,(instance=this,function(DATA){instance.hidePaginate(NODE,TREE_OBJ);for(var i=0;i<DATA.length;i++)DATA[i].attributes.class=instance.options.instanceClass+" node-instance node-draggable",$("#"+DATA[i].attributes.id,$(TREE_OBJ.container)).length||TREE_OBJ.create(DATA[i],TREE_OBJ.get_node(NODE[0])),"*"==options.checkedNodes&&instance.checkedNodes.push(DATA[i].attributes.id);instance.setMeta(nodeId,"displayed",instance.getMeta(nodeId,"displayed"
)+DATA.length),instance.setMeta(nodeId,"position",instance.getMeta(nodeId,"position")+DATA.length),instance.refreshPaginate(NODE,TREE_OBJ),options.checkedNodes&&("*"==options.checkedNodes?$(NODE).find("ul:first").children().each(function(){$(this).hasClass("node-instance")&&$(this).find("a:not(.checked, .undetermined)").each(function(){instance.checkedNodes.push($(this).parent().prop("id"))})}):instance.checkedNodes=options.checkedNodes),instance.check(instance.checkedNodes),callback&&callback(NODE,TREE_OBJ),instance.checkPaginate&&instance.checkPaginate(NODE,TREE_OBJ)}),"json")},check:function(elements){var self=this;$.each(elements,function(i,elt){if(
null!=elt){var NODE=$(self.selector).find("li[id='"+elt+"']");0<NODE.length&&$(NODE).hasClass("node-instance")&&$.tree.plugins.checkbox.check(NODE)}})},getChecked:function(){var unchecked=[];$.each($.tree.plugins.checkbox.get_unchecked(this.getTree()),function(i,NODE){$(NODE).hasClass("node-instance")&&unchecked.push($(NODE).prop("id"))});var returnValue=$.grep(this.checkedNodes,function(value){return-1==unchecked.indexOf(value)});return $.each($.tree.plugins.checkbox.get_checked(this.getTree()),function(i,NODE){if($(NODE).hasClass("node-instance")){var value=$(NODE).prop("id");-1==returnValue.indexOf(value)&&returnValue.push(value)}}),returnValue},
saveData:function(){var instance=this,toSend={};if("object"==typeof this.options.saveData)for(var key in this.options.saveData)toSend[key]=this.options.saveData[key];helpers.loading();var nodes=this.getChecked();toSend.instances=JSON.stringify(nodes);var uriField,classUriField=null;if(this.options.relatedFormId){var uriEltSelector="#"+this.options.relatedFormId+" :input[name=uri]";$(uriEltSelector).length&&(uriField=$(uriEltSelector));var classUriEltSelector="#"+this.options.relatedFormId+" :input[name=classUri]";$(classUriEltSelector).length&&(classUriField=$(classUriEltSelector))}uriField||(uriField=$("input[name=uri]")),classUriField||(classUriField=$(
"input[name=classUri]")),uriField&&(toSend.uri=uriField.val()),classUriField&&(toSend.classUri=classUriField.val()),$.ajax({url:this.options.saveUrl,type:"POST",data:toSend,dataType:"json",success:function(response){response.saved&&(instance.options.saveCallback&&instance.options.saveCallback(toSend),feedback().info(__("Selection saved successfully")))},complete:function(){helpers.loaded()}})}})}),function(c){var d=document,a="appendChild",i="styleSheet",s=d.createElement("style");s.type="text/css",d.getElementsByTagName("head")[0][a](s),s[i]?s[i].cssText=c:s[a](d.createTextNode(c))}(
...
),define("loader\tao.bundle",function(){});
