...
depth0&&depth0.icon,{hash:{},inverse:self.program(30,program30,data),fn:self.program(28,program28,data),data:data}))||0===stack1)&&(buffer+=stack1),buffer+='"></span> ',((stack1=helpers.if.call(depth0,depth0&&depth0.label,{hash:{},inverse:self.program(34,program34,data),fn:self.program(32,program32,data),data:data}))||0===stack1)&&(buffer+=stack1),buffer+="\n            </button>\n        "}function program20(depth0,data){var stack1,helper;return stack1=(helper=helpers.id)?helper.call(depth0,{hash:{},data:data}):typeof(helper=depth0&&depth0.id)===functionType?helper.call(depth0,{hash:{},data:data}):helper,escapeExpression(stack1)}function program22(depth0,
...
depth0&&depth0.label,{hash:{},inverse:self.noop,fn:self.program(68,program68,data),data:data}))||0===stack1)&&(buffer+=stack1),buffer+="</button>\n                                                    "}function program66(depth0,data){var stack1,helper,buffer="";return buffer+='<span class="icon-',stack1=(helper=helpers.icon)?helper.call(depth0,{hash:{},data:data}):typeof(helper=depth0&&depth0.icon)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+'"></span> '}function program68(depth0,data){var stack1,helper,buffer="";return buffer+=" ",stack1=(helper=helpers.label)?helper.call(depth0,{hash:{},data:data}):typeof(
helper=depth0&&depth0.label)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)}function program70(depth0,data,depth3){var stack1,buffer="";return buffer+="\n                                                    ",((stack1=helpers.with.call(depth0,depth3,{hash:{},inverse:self.noop,fn:self.program(71,program71,data),data:data}))||0===stack1)&&(buffer+=stack1),buffer+="\n                                                "}function program71(depth0,data){var stack1,helper,buffer="";return buffer+='\n                                <button class="btn-info small ',stack1=(helper=helpers.id)?helper.call(depth0,{hash:{},
