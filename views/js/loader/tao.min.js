...
var conf=_.defaults({},module.config(),_defaults);loginComponent($("#login-box-inner-container"),conf).on("init",function(){loadingBar.start()}).after("render",function(){versionWarning.init(),loadingBar.stop()}).on("submit.login",function(){loadingBar.start()})}}}),define("form/post-render-props",["jquery","i18n","ui/feedback"],function($,__,feedback){function _toggleModeBtn(newMode){var $modeToggle=$(".property-mode");"disabled"===newMode?$modeToggle.addClass("disabled"):$modeToggle.removeClass("disabled")}function _upgradeButtons($container,type){"radio"!==type&&"checkbox"!==type&&(type="radio");var selector=".form_checklst",notSelector=""
