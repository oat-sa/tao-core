...
displayMessages(messages),$fakeForm.find('input[type="submit"], button[type="submit"]').off("click").on("click",function(e){e.preventDefault(),submitForm()}),$fakeForm.on("keypress",function(e){13===e.which&&(e.preventDefault(),submitForm())})}}}),function(){"use strict";var loaderScript=document.getElementById("amd-loader"),configUrl=loaderScript.getAttribute("data-config"),bundle=loaderScript.getAttribute("data-bundle"),loadController=function(){var controllerOptions={},controllerPath=loaderScript.getAttribute("data-controller"),params=loaderScript.getAttribute("data-params");try{controllerOptions=JSON.parse(params)}catch(e){}require([controllerPath],function(controller){
controller.start(controllerOptions)})};require([configUrl],function(){bundle?require([bundle],loadController):loadController()})}(),define("loader/bootstrap",function(){});
