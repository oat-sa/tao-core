...
loaderData.config],function(){window.combinedBundles&&window.combinedBundles.length&&(bundles=window.combinedBundles),bundles&&bundles.length?require(bundles,loadController):loadController()})}(),define("loader/bootstrap",function(){}),define("i18n",["lodash","json!i18ntr/messages.json","context","core/format"],function(_,i18nTr,context,format){"use strict";var translations=i18nTr.translations;return function(message){var localized=translations[message]?translations[message]:message;return 1<arguments.length&&(message=localized,localized=format.apply(null,arguments)),localized}}),function(){"use strict";function lib$es6$promise$utils$$isFunction(x){
