...
helper=helpers.__||depth0&&depth0.__)?helper.call(depth0,"Close message",options):helperMissing.call(depth0,"__","Close message",options)))+'" class="icon-close" data-close=":parent .feedback"></span>\n</div>\n'})}),define("tpl!ui/login/tpl/login",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){this.compilerInfo=[4,">= 1.0.0"],helpers=this.merge(helpers,Handlebars.helpers),data=data||{};var stack1,helper,options,buffer="",functionType="function",escapeExpression=this.escapeExpression,helperMissing=helpers.helperMissing;function program3(depth0,data){return' autocomplete="off"'}function program5(depth0,data){
var stack1,buffer="";return buffer+='\n                <div class="form-error">\n                    '+escapeExpression(typeof(stack1=null==(stack1=depth0&&depth0.fieldMessages)||!1===stack1?stack1:stack1.login)===functionType?stack1.apply(depth0):stack1)+"\n                </div>\n            "}return buffer+='<div class="xhtml_form login-component">\n    <form action="',stack1=(helper=helpers.url)?helper.call(depth0,{hash:{},data:data}):typeof(helper=depth0&&depth0.url)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+'" method="post" id="',stack1=(helper=helpers.name)?helper.call(depth0,{hash:{},data:data}
...
)||!1===stack1?stack1:stack1.password,{hash:{},inverse:this.noop,fn:this.program(5,program5,data),data:data}))||0===stack1)&&(buffer+=stack1),buffer+='\n        </div>\n        <div class="form-toolbar"><input type="submit" id="connect" name="connect" disabled="disabled" class="disabled" value="Log in"></div>\n    </form>\n</div>'})}),define("tpl!ui/login/tpl/fakeForm",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){this.compilerInfo=[4,">= 1.0.0"],data=data||{};var stack1,helper,buffer="";return buffer+='<div class="form loginForm fakeForm">',((stack1=(helper=(helpers=this.merge(helpers,Handlebars.helpers)
).form)?helper.call(depth0,{hash:{},data:data}):"function"==typeof(helper=depth0&&depth0.form)?helper.call(depth0,{hash:{},data:data}):helper)||0===stack1)&&(buffer+=stack1),buffer+="</div>"})}),define("tpl!ui/login/tpl/passwordReveal",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){this.compilerInfo=[4,">= 1.0.0"],data=data||{};var stack1,helper,buffer="";return buffer+='<span class="viewable-hiddenbox">',((stack1=(helper=(helpers=this.merge(helpers,Handlebars.helpers)).elements)?helper.call(depth0,{hash:{},data:data}):"function"==typeof(helper=depth0&&depth0.elements)?helper.call(depth0,{hash:{},data:data}
):helper)||0===stack1)&&(buffer+=stack1),buffer+='<span class="viewable-hiddenbox-toggle" tabindex="0"><span class="icon-preview"></span><span class="icon-eye-slash" style="display: none;"></span></span></span>'})}),define("controller/login",["jquery","lodash","i18n","module","layout/loading-bar","layout/version-warning","ui/login/login"],function($,_,__,module,loadingBar,versionWarning,loginComponent){"use strict";var _defaults={disableAutocomplete:!1,enablePasswordReveal:!1,message:{error:""}};return{start:function(){var conf=_.defaults({},module.config(),_defaults);loginComponent($("#login-box-inner-container"),conf).on("init",function(){loadingBar.start(
)}).after("render",function(){versionWarning.init(),loadingBar.stop()}).on("submit.login",function(){loadingBar.start()})}}}),define("loader/login.bundle",function(){});
