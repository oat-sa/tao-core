...
define(['util/url', 'context'], function(urlUtil, context) {
    ...
    QUnit
        .cases.init(isAbsoluteDataProvider)
    ...
    QUnit
        .cases.init(attributesDataProvider)
