<div class="calcContainer">
    <form action="">
        ...
        <button type="button" value="C" data-key="C" class="calcClear calcFirst div-3">C</button>
        <button type="button" value="CE" data-key="CE" class="calcClear div-3">CE</button>
        <button type="button" value="DEL" data-key="DEL" class="calcClear div-3">DEL</button>
