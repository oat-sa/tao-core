...
define( [
    ...
    QUnit.test( 'folding', function( assert ) {
        var ready = assert.async();
    ...
    QUnit.test( 'selection', function( assert ) {
        ...
        .on( 'render', function() {
            ...
            assert.equal( $( 'a.selected', $element ).text(), 'Trainee',  'The nod\'s text is used by the selection element' );
            assert.equal( $( 'a.selected', $element ).attr( 'title' ), 'Trainee',  'The nod\'s title is correct' );
    ...
    QUnit.test( 'value change', function( assert ) {
        ...
        .on( 'change', function( newValue, newNode ) {
            ...
            assert.equal( $( 'a.selected', $container ).text(), 'Designer',  'The nod\'s text is used by the selection element' );
    ...
    QUnit.test( 'get class node', function( assert ) {
        var ready = assert.async();
    ...
    QUnit.test( 'default value not in the classes', function( assert ) {
        var ready = assert.async();
    ...
    QUnit.test( 'default value in the classes', function( assert ) {
        var ready = assert.async();
    ...
    QUnit.test( 'empty the component', function( assert ) {
        var ready = assert.async();
        var $container = $( '#qunit-fixture' );
    ...
    QUnit.test( 'remove a class', function( assert ) {
        var ready = assert.async();
        var node = {
    ...
    QUnit.test( 'add a new class', function( assert ) {
        var ready = assert.async();
        var node = {
    ...
    QUnit.test( 'update a node', function( assert ) {
        var ready = assert.async();
