...
define([
    ...
    QUnit.test('isDigit', function (assert) {
        ...
        assert.equal(tokensHelper.isDigit(registeredTerms.COMMA.type), false, 'Should not be a digit');
        ...
        assert.equal(tokensHelper.isDigit(registeredTerms.COMMA), false, 'Should not be a digit');
    ...
    QUnit.test('isOperator', function (assert) {
        ...
        assert.equal(tokensHelper.isOperator(registeredTerms.COMMA.type), false, 'Should not be an operator');
        ...
        assert.equal(tokensHelper.isOperator(registeredTerms.COMMA), false, 'Should not be an operator');
    ...
    QUnit.test('isAggregator', function (assert) {
        ...
        assert.equal(tokensHelper.isAggregator(registeredTerms.COMMA.type), false, 'Should not be an aggregator');
        ...
        assert.equal(tokensHelper.isAggregator(registeredTerms.COMMA), false, 'Should not be an aggregator');
    ...
    QUnit.test('isError', function (assert) {
        ...
        assert.equal(tokensHelper.isError(registeredTerms.COMMA.type), false, 'Should not be an error');
        ...
        assert.equal(tokensHelper.isError(registeredTerms.COMMA), false, 'Should not be an error');
    ...
    QUnit.test('isConstant', function (assert) {
        ...
        assert.equal(tokensHelper.isConstant(registeredTerms.COMMA.type), false, 'Should not be a constant');
        ...
        assert.equal(tokensHelper.isConstant(registeredTerms.COMMA), false, 'Should not be a constant');
    ...
    QUnit.test('isVariable', function (assert) {
        ...
        assert.equal(tokensHelper.isVariable(registeredTerms.COMMA.type), false, 'Should not be a variable');
        ...
        assert.equal(tokensHelper.isVariable(registeredTerms.COMMA), false, 'Should not be a variable');
    ...
    QUnit.test('isFunction', function (assert) {
        ...
        assert.equal(tokensHelper.isFunction(registeredTerms.COMMA.type), false, 'Should not be a function');
        ...
        assert.equal(tokensHelper.isFunction(registeredTerms.COMMA), false, 'Should not be a function');
    ...
    QUnit.test('isIdentifier', function (assert) {
        ...
        assert.equal(tokensHelper.isIdentifier(registeredTerms.COMMA.type), false, 'Should not be an identifier');
        ...
        assert.equal(tokensHelper.isIdentifier(registeredTerms.COMMA), false, 'Should not be an identifier');
    ...
    QUnit.test('isSeparator', function (assert) {
        ...
        assert.equal(tokensHelper.isSeparator(registeredTerms.COMMA.type), true, 'Should be a separator');
        ...
        assert.equal(tokensHelper.isSeparator(registeredTerms.COMMA), true, 'Should be a separator');
    ...
    QUnit.test('isModifier', function (assert) {
        ...
        assert.equal(tokensHelper.isModifier(registeredTerms.COMMA.type), false, 'Should not be a modifier');
        ...
        assert.equal(tokensHelper.isModifier(registeredTerms.COMMA), false, 'Should not be a modifier');
