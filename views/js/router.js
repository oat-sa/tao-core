...
define([
     ...
     */
    var loadRouteBundle = function loadRouteBundle(route){
     ...
     */
    var loadRoute = function loadRoute(route){
     ...
     */
    var dispatchUrl = function dispatchUrl(url){
        //parse the URL
        var route = parseMvcUrl(url);

        logger.debug('Dispatch URL ' + url);

        return loadRouteBundle(route)
            .then(function (){
