require.config({
    ...
    paths : {
        ...
        'taoQtiItemCreator' : '../../../taoQtiItem/views/js/qtiCreator',
        'taoQtiItem'        : '../../../taoQtiItem/views/js/qtiItem',
        'taoQtiRunner'      : '../../../taoQtiItem/views/js/qtiRunner',
        'taoQtiDefaultRenderer' : '../../../taoQtiItem/views/js/qtiDefaultRenderer',
        'taoQtiCommonRenderer' : '../../../taoQtiItem/views/js/qtiCommonRenderer',
