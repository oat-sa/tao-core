...
class lu.tao.utils.tao_calculator{
	...
	** Private attributes
	*/
	private var max_char:Number;
	private var p_binary_op:Array;
	private var p_unary_op:Array;
	private var p_object:Array;
	private var p_level:Array;
	private var v_indices:Array;
	private var v_value:Array;
	private var v_name:Array;
	private var delimiters:Array;
	private var do_unary:Number;
	private var level:Number;
	private var base_level:Number;
	private var accum_ind:Number;
	private var var_ind:Number;
	private var variable_index:Array;
	private var accum_pos;
	private var my_formatter:MyNumberFormatter;

	public function tao_calculator(){
		max_char = 512;
	...
	*/
	...
	public function cleanComma(vInitial){
...
/*
		var langCountryCode_str = _level0.locale;
...
*/
	...
	public function setupNumber(xpr){
		var localNum_num:Number;
		var localNum_str:String;
