...
class Updater extends \common_ext_ExtensionUpdater
{
    ...
    public function update($initialVersion)
    {
        ...
        if ($this->isVersion('5.6.2')) {
            if (!$this->getServiceManager()->has(UpdateLogger::SERVICE_ID)) {
                ...
                $this->getServiceManager()
                    ->register(UpdateLogger::SERVICE_ID, new UpdateLogger([UpdateLogger::OPTION_FILESYSTEM => 'log']));
            }
        ...
        if ($this->isVersion('7.68.0')) {
            ...
            AclProxy::applyRule(new AccessRule('grant', 'http://www.tao.lu/Ontologies/TAO.rdf#BaseUserRole',
                ['ext' => 'tao', 'mod' => 'Notification']));
        ...
        if ($this->isVersion('10.27.0')) {
            AclProxy::applyRule(new AccessRule('grant', 'http://www.tao.lu/Ontologies/TAO.rdf#BackOfficeRole',
                ['ext' => 'tao', 'mod' => 'TaskQueueData']));
        ...
        if ($this->isVersion('14.8.0')) {
            ...
            AclProxy::applyRule(new AccessRule('grant', 'http://www.tao.lu/Ontologies/TAO.rdf#SysAdminRole',
                ['ext' => 'tao', 'mod' => 'ExtensionsManager']));
            AclProxy::applyRule(new AccessRule('grant', 'http://www.tao.lu/Ontologies/TAO.rdf#TaoManagerRole',
                ['ext' => 'tao', 'mod' => 'Api']));
            AclProxy::applyRule(new AccessRule('grant', 'http://www.tao.lu/Ontologies/TAO.rdf#TaoManagerRole',
                ['ext' => 'tao', 'mod' => 'Breadcrumbs']));
            AclProxy::applyRule(new AccessRule('grant', 'http://www.tao.lu/Ontologies/TAO.rdf#TaoManagerRole',
                ['ext' => 'tao', 'mod' => 'Export']));
            AclProxy::applyRule(new AccessRule('grant', 'http://www.tao.lu/Ontologies/TAO.rdf#TaoManagerRole',
                ['ext' => 'tao', 'mod' => 'File']));
            ...
            AclProxy::applyRule(new AccessRule('grant', 'http://www.tao.lu/Ontologies/TAO.rdf#TaoManagerRole',
                ['ext' => 'tao', 'mod' => 'Main']));
            AclProxy::applyRule(new AccessRule('grant', 'http://www.tao.lu/Ontologies/TAO.rdf#TaoManagerRole',
                ['ext' => 'tao', 'mod' => 'PasswordRecovery']));
            AclProxy::applyRule(new AccessRule('grant', 'http://www.tao.lu/Ontologies/TAO.rdf#TaoManagerRole',
                ['ext' => 'tao', 'mod' => 'Permission']));
            AclProxy::applyRule(new AccessRule('grant', 'http://www.tao.lu/Ontologies/TAO.rdf#TaoManagerRole',
                ['ext' => 'tao', 'mod' => 'PropertiesAuthoring']));
            AclProxy::applyRule(new AccessRule('grant', 'http://www.tao.lu/Ontologies/TAO.rdf#TaoManagerRole',
                ['ext' => 'tao', 'mod' => 'QueueAction']));
            AclProxy::applyRule(new AccessRule('grant', 'http://www.tao.lu/Ontologies/TAO.rdf#TaoManagerRole',
                ['ext' => 'tao', 'mod' => 'RestResource']));
            AclProxy::applyRule(new AccessRule('grant', 'http://www.tao.lu/Ontologies/TAO.rdf#TaoManagerRole',
                ['ext' => 'tao', 'mod' => 'RestUser']));
            AclProxy::applyRule(new AccessRule('grant', 'http://www.tao.lu/Ontologies/TAO.rdf#TaoManagerRole',
                ['ext' => 'tao', 'mod' => 'Roles']));
            AclProxy::applyRule(new AccessRule('grant', 'http://www.tao.lu/Ontologies/TAO.rdf#TaoManagerRole',
                ['ext' => 'tao', 'mod' => 'TaskQueue']));
        ...
        if ($this->isVersion('15.4.0')) {
            $setClientLoggerConfig = new SetClientLoggerConfig();
            $setClientLoggerConfig([]);
            AclProxy::applyRule(new AccessRule('grant', TaoRoles::BASE_USER,
                ['ext' => 'tao', 'mod' => 'Log', 'act' => 'log']));
        ...
        if ($this->isVersion('17.13.1')) {
            $rdfLang = dirname(__FILE__) . DIRECTORY_SEPARATOR . str_replace('/', DIRECTORY_SEPARATOR,
                    '../../locales/fr-CA/lang.rdf');
        ...
        if ($this->isVersion('17.16.1')) {
            AclProxy::applyRule(new AccessRule('grant', TaoRoles::REST_PUBLISHER,
                ['ext' => 'tao', 'mod' => 'TaskQueue', 'act' => 'get']));
        ...
        if ($this->isVersion('18.4.1')) {
            AclProxy::applyRule(new AccessRule('grant', 'http://www.tao.lu/Ontologies/generis.rdf#AnonymousRole',
                ['ext' => 'tao', 'mod' => 'Health']));
        ...
        if ($this->isVersion('21.2.0')) {
            ...
            $this->getServiceManager()
                ->register(ResourceJsonMetadataCompiler::SERVICE_ID, $resourceJsonMetadataCompiler);
        ...
        if ($this->isVersion('27.3.0')) {
            AclProxy::applyRule(new AccessRule('grant', TaoRoles::ANONYMOUS,
                ['ext' => 'tao', 'mod' => 'RestVersion', 'act' => 'index']));
