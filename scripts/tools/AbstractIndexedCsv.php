...
abstract class AbstractIndexedCsv implements Action
{
     ...
     */
    protected function setIndexColumn($indexColumn): void
    {
     ...
     */
    protected function setDestination($destination): void
    {
     ...
     */
    protected function setSourceFp($sourceFp): void
    {
     ...
     */
    protected function setDestinationFp($destinationFp): void
    {
     ...
     * @param array $index
     */
    protected function setIndex(array $index): void
    {
        $this->index = $index;
    }
     ...
     */
    protected function setFirstRowColumnNames($firstRowColumnNames): void
    {
