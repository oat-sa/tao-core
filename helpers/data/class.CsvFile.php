...
class tao_helpers_data_CsvFile
{
    ...
    public function load($file)
    {
        if ($file instanceof File) {
            $rows = explode(PHP_EOL, $file->read());
        }
        /**
         * @deprecated
         */
            ...
            if (!is_file($file)) {
                throw new InvalidArgumentException('Expected CSV file \'' . $file . '\' could not be open.');
            }
            if (!is_readable($file)) {
                throw new InvalidArgumentException('CSV file \'' . $file . '\' is not readable.');
            }
