 ...
 * @package tao
 */
class tao_helpers_form_validators_Password extends tao_helpers_form_Validator
{
    // --- ASSOCIATIONS ---
    ...
    public function evaluate($values)
    {
        ...
        if (is_array($values) && count($values) === 2) {
            ...
            if ($secondElement === null || ! $secondElement instanceof tao_helpers_form_FormElement) {
