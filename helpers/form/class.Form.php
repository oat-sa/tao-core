...
abstract class tao_helpers_form_Form
{
     ...
     */
    public function addElement(tao_helpers_form_FormElement $element, $isSystem = false): void
    {
        $elementPosition = -1;
     ...
     * @throws Exception
     */
    public function setActions($actions, $context = 'bottom'): void
    {
     ...
     */
    public function setDecorator(tao_helpers_form_Decorator $decorator, $type = 'element'): void
    {
     ...
     */
    public function addToGroup($groupName, $elementName = ''): void
    {
        if (isset($this->groups[$groupName]['elements']) && ! in_array($elementName, $this->groups[$groupName]['elements'], true)) {
