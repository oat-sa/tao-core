...
class tao_helpers_Feedback
{
     ...
     * @return string
     */
    protected static function dispatch($type, $message, $settings = [])
    {
        $defaults = [
        'delayToClose' => 2000,
        'closer'       => true,
     ...
     * @return string
     */
    public static function error($message, $settings = [])
    {
     ...
     * @return string
     */
    public static function info($message, $settings = [])
    {
        return self::dispatch(__FUNCTION__, $message, $settings);
    }
     ...
     * @return string
     */
    public static function success($message, $settings = [])
    {
        return self::dispatch(__FUNCTION__, $message, $settings);
    }
     ...
     * @return string
     */
    public static function warning($message, $settings = [])
    {
        return self::dispatch(__FUNCTION__, $message, $settings);
    }
}
