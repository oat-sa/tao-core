...
class tao_helpers_Icon {
    ...
    const CLASS_BUBBLE2 = 'icon-bubble2';
    ...
    public static function iconBubble2($options=array()){
        return self::buildIcon(self::CLASS_BUBBLE2, $options);
    }
