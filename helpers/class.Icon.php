...
class tao_helpers_Icon {
     ...
     */
    const CLASS_MULTI_SELECT_ICON = 'icon-multi-select-icon';
    ...
    public static function iconMultiSelectIcon($options=array()){
        return self::buildIcon(self::CLASS_MULTI_SELECT_ICON, $options);
    }
