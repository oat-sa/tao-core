...
return array(
	...
	'install' => array(
		...
		'checks' => array(
				...
				array('type' => 'CheckPHPExtension', 'value' => array('id' => 'extension_json', 'name' => 'json')),
				array('type' => 'CheckPHPExtension', 'value' => array('id' => 'extension_spl', 'name' => 'spl')),
				array('type' => 'CheckPHPExtension', 'value' => array('id' => 'extension_dom', 'name' => 'dom')),
				...
				array('type' => 'CheckCustom', 'value' => array('id' => 'custom_mod_rewrite', 'name' => 'mod_rewrite', 'extension' => 'tao')),
				array('type' => 'CheckCustom', 'value' => array('id' => 'custom_database_drivers', 'name' => 'database_drivers', 'extension' => 'tao'))
		)
	),
