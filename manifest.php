...
return [
    ...
    'install' => [
        ...
        'checks' => [
                ...
                ['type' => 'CheckFileSystemComponent', 'value' => ['id' => 'fs_data', 'location' => 'data', 'rights' => 'rw', 'recursive' => true]],
        ...
        'php' => [
            ...
            __DIR__.'/scripts/install/setLocaleNumbersConfig.php',
            AddLogFs::class,
    ...
    'constants' => [
        #TAO version number
        'TAO_VERSION' => '3.3.0-sprint92',
        #TAO version label
        'TAO_VERSION_NAME' => '3.3.0-sprint92',
        #the name to display
        'PRODUCT_NAME' => 'TAO',
