...
(6, 'http://www.tao.lu/Ontologies/TAO.rdf#TaoManagerRole', 'http://www.w3.org/2000/01/rdf-schema#seeAlso', '', 'EN', 'generis', 'yyy[admin,administrators,authors]', 'yyy[admin,administrators,authors]', 'yyy[admin,administrators,authors]'),
(6, 'http://www.tao.lu/Ontologies/TAO.rdf#TaoManagerRole', 'http://www.w3.org/2000/01/rdf-schema#isDefinedBy', ' ', 'EN', 'generis', 'yyy[admin,administrators,authors]', 'yyy[admin,administrators,authors]', 'yyy[admin,administrators,authors]'),
...
(6, 'http://www.tao.lu/Ontologies/TAO.rdf#WorkflowUserRole', 'http://www.w3.org/2000/01/rdf-schema#comment', 'Workflow User Role: default role assigned to every backend user, not deletable', 'EN', 'generis', 'yyy[admin,administrators,authors]', 'yyy[admin,administrators,authors]', 'yyy[admin,administrators,authors]'),
(6, 'http://www.tao.lu/Ontologies/TAO.rdf#WorkflowUserRole', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#value', '', 'EN', 'generis', 'yyy[admin,administrators,authors]', 'yyy[admin,administrators,authors]', 'yyy[admin,administrators,authors]'),
(6, 'http://www.tao.lu/Ontologies/TAO.rdf#WorkflowUserRole', 'http://www.w3.org/2000/01/rdf-schema#label', 'Workflow User Role', 'EN', 'generis', 'yyy[admin,administrators,authors]', 'yyy[admin,administrators,authors]', 'yyy[admin,administrators,authors]'),
(6, 'http://www.tao.lu/Ontologies/TAO.rdf#WorkflowUserRole', 'http://www.w3.org/2000/01/rdf-schema#seeAlso', '', 'EN', 'generis', 'yyy[admin,administrators,authors]', 'yyy[admin,administrators,authors]', 'yyy[admin,administrators,authors]'),
(6, 'http://www.tao.lu/Ontologies/TAO.rdf#WorkflowUserRole', 'http://www.w3.org/2000/01/rdf-schema#isDefinedBy', ' ', 'EN', 'generis', 'yyy[admin,administrators,authors]', 'yyy[admin,administrators,authors]', 'yyy[admin,administrators,authors]'),
