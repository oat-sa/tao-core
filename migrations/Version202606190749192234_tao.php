 ...
 */
final class Version202606190749192234_tao extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Grant MetadataImport access to MetadataImportAdministrator role';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        // Ensure deterministic state when rerun via rollback/execute.
